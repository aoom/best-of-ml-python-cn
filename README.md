...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 3.9K · 🔀 86K · 📦 180K · 📋 34K - 7% open · ⏱️ 17.02.2022):
...
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 3M · ⏱️ 06.02.2022):
	...
	```
- [Docker Hub](https://hub.docker.com/r/tensorflow/tensorflow) (📥 65M · ⭐ 2K · ⏱️ 17.02.2022):
	```
...
- [GitHub](https://github.com/scikit-learn/scikit-learn) (👨‍💻 2.5K · 🔀 22K · 📥 770 · 📦 310K · 📋 10K - 24% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.1K · 🔀 15K · 📥 1.9K · 📋 28K - 39% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/torch) (📥 6.2M / month · 📦 6.8K · ⏱️ 27.01.2022):
	```
	pip install torch
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1K · 🔀 19K · 📋 11K - 2% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/keras-team/keras
	```
- [PyPi](https://pypi.org/project/keras) (📥 8.4M / month · 📦 220 · ⏱️ 31.01.2022):
	```
	pip install keras
	```
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 550 · 🔀 8.3K · 📥 3.7K · 📦 27K · 📋 4.3K - 6% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 8.4M / month · 📦 1.3K · ⏱️ 17.01.2022):
	```
	pip install xgboost
	```
- [Conda](https://anaconda.org/conda-forge/xgboost) (📥 2.3M · ⏱️ 15.02.2022):
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 360 · 🔀 2.4K · 📥 26 · 📦 58K · 📋 4.8K - 47% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/statsmodels/statsmodels
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 7.8M / month · 📦 4.5K · ⏱️ 08.02.2022):
	```
	pip install statsmodels
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 5.6M · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/apache/spark) (👨‍💻 2.6K · 🔀 25K · ⏱️ 17.02.2022):

	```
	git clone https://github.com/apache/spark
	```
- [PyPi](https://pypi.org/project/pyspark) (📥 18M / month · 📦 760 · ⏱️ 26.01.2022):
	```
	pip install pyspark
	```
...
- [GitHub](https://github.com/PyTorchLightning/pytorch-lightning) (👨‍💻 620 · 🔀 2.2K · 📥 5.4K · 📦 6.9K · 📋 4.7K - 10% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/microsoft/LightGBM) (👨‍💻 250 · 🔀 3.5K · 📥 140K · 📦 11K · 📋 2.6K - 6% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/microsoft/LightGBM
	```
- [PyPi](https://pypi.org/project/lightgbm) (📥 6M / month · 📦 580 · ⏱️ 07.01.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/Paddle) (👨‍💻 700 · 🔀 4.3K · 📥 15K · 📦 92 · 📋 15K - 18% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/PaddlePaddle/Paddle
	```
- [PyPi](https://pypi.org/project/paddlepaddle) (📥 110K / month · 📦 44 · ⏱️ 20.01.2022):
	```
	pip install paddlepaddle
	```
</details>
<details><summary><b><a href="https://github.com/google/jax">jax</a></b> (🥈41 ·  ⭐ 16K · 📈) - Composable transformations of Python+NumPy programs: differentiate,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google/jax) (👨‍💻 360 · 🔀 1.5K · 📦 3.5K · 📋 3.1K - 31% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/google/jax
	```
- [PyPi](https://pypi.org/project/jax) (📥 280K / month · 📦 260 · ⏱️ 10.02.2022):
	```
	pip install jax
	```
...
- [GitHub](https://github.com/catboost/catboost) (👨‍💻 960 · 🔀 950 · 📥 74K · 📋 1.7K - 20% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 970 · 🔀 6.9K · 📥 25K · 📋 9.7K - 20% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/jina-ai/jina) (👨‍💻 140 · 🔀 1.8K · 📦 220 · 📋 1.3K - 5% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/jina-ai/jina
	```
- [PyPi](https://pypi.org/project/jina) (📥 35K / month · ⏱️ 17.02.2022):
	```
	pip install jina
	```
- [Conda](https://anaconda.org/conda-forge/jina-core) (📥 2.3K · ⏱️ 01.11.2021):
	```
	conda install -c conda-forge jina-core
	```
- [Docker Hub](https://hub.docker.com/r/jinaai/jina) (📥 1M · ⭐ 6 · ⏱️ 17.02.2022):
	```
...
- [GitHub](https://github.com/fastai/fastai) (👨‍💻 600 · 🔀 7.1K · 📋 1.6K - 6% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/apache/flink) (👨‍💻 1.5K · 🔀 10K · ⏱️ 17.02.2022):

	```
	git clone https://github.com/apache/flink
	```
- [PyPi](https://pypi.org/project/apache-flink) (📥 9.3K / month · 📦 13 · ⏱️ 17.01.2022):
	```
...
- [GitHub](https://github.com/Theano/Theano) (👨‍💻 380 · 🔀 2.5K · 📦 12K · 📋 2.8K - 24% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/theano) (📥 290K / month · 📦 2.8K · ⏱️ 27.07.2020):
	```
	pip install theano
	```
...
- [GitHub](https://github.com/chainer/chainer) (👨‍💻 320 · 🔀 1.4K · 📦 2.5K · 📋 2K - 0% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/chainer) (📥 21K / month · 📦 400 · ⏱️ 05.01.2022):
	```
	pip install chainer
	```
- [Conda](https://anaconda.org/conda-forge/chainer) (📥 6.8K · ⏱️ 21.01.2022):
	```
...
- [GitHub](https://github.com/explosion/thinc) (👨‍💻 47 · 🔀 230 · 📦 19K · 📋 120 - 16% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/explosion/thinc
	```
- [PyPi](https://pypi.org/project/thinc) (📥 3.7M / month · 📦 610 · ⏱️ 17.12.2021):
	```
	pip install thinc
	```
...
- [GitHub](https://github.com/VowpalWabbit/vowpal_wabbit) (👨‍💻 310 · 🔀 1.8K · 📋 1.2K - 11% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/pytorch/ignite) (👨‍💻 160 · 🔀 520 · 📋 1K - 13% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/pytorch/ignite
	```
- [PyPi](https://pypi.org/project/pytorch-ignite) (📥 120K / month · 📦 77 · ⏱️ 17.02.2022):
	```
	pip install pytorch-ignite
	```
- [Conda](https://anaconda.org/pytorch/ignite) (📥 80K · ⏱️ 17.01.2022):
	```
	conda install -c pytorch ignite
	```
</details>
<details><summary><b><a href="https://github.com/google/flax">Flax</a></b> (🥈33 ·  ⭐ 2.7K) - Flax is a neural network library for JAX that is designed for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google/flax) (👨‍💻 130 · 🔀 290 · 📥 31 · 📦 680 · 📋 500 - 36% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/google/flax
	```
- [PyPi](https://pypi.org/project/flax) (📥 93K / month · 📦 57 · ⏱️ 27.01.2022):
	```
	pip install flax
	```
- [Conda](https://anaconda.org/conda-forge/flax) (📥 2.3K · ⏱️ 27.01.2022):
	```
...
- [GitHub](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) (👨‍💻 3.9K · 🔀 67 · 📥 17 · 📋 320 - 17% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/ROCmSoftwarePlatform/tensorflow-upstream
	```
- [PyPi](https://pypi.org/project/tensorflow-rocm) (📥 44K / month · 📦 5 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/ludwig-ai/ludwig) (👨‍💻 110 · 🔀 960 · 📦 99 · 📋 680 - 26% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/ludwig-ai/ludwig
	```
- [PyPi](https://pypi.org/project/ludwig) (📥 3.4K / month · 📦 8 · ⏱️ 10.02.2022):
	```
	pip install ludwig
	```
</details>
...
- [GitHub](https://github.com/tensorpack/tensorpack) (👨‍💻 58 · 🔀 1.8K · 📥 130 · 📦 940 · 📋 1.3K - 0% open · ⏱️ 27.11.2021):
...
- [PyPi](https://pypi.org/project/tensorpack) (📥 21K / month · 📦 46 · ⏱️ 22.01.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorpack) (📥 220 · ⏱️ 06.02.2022):
	```
...
<details><summary><b><a href="https://github.com/arogozhnikov/einops">einops</a></b> (🥉31 ·  ⭐ 4.5K) - Deep learning operations reinvented (for pytorch, tensorflow, jax and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/arogozhnikov/einops) (👨‍💻 14 · 🔀 180 · 📦 1.9K · 📋 100 - 33% open · ⏱️ 03.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/einops) (📥 720K / month · 📦 190 · ⏱️ 18.01.2022):
	```
	pip install einops
	```
- [Conda](https://anaconda.org/conda-forge/einops) (📥 11K · ⏱️ 18.01.2022):
	```
...
- [GitHub](https://github.com/mlpack/mlpack) (👨‍💻 280 · 🔀 1.4K · 📋 1.5K - 7% open · ⏱️ 30.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/mlpack) (📥 160 / month · 📦 1 · ⏱️ 28.10.2020):
	```
	pip install mlpack
	```
...
- [GitHub](https://github.com/deepmind/sonnet) (👨‍💻 53 · 🔀 1.3K · 📦 770 · 📋 170 - 13% open · ⏱️ 01.02.2022):

	```
	git clone https://github.com/deepmind/sonnet
	```
- [PyPi](https://pypi.org/project/dm-sonnet) (📥 20K / month · 📦 52 · ⏱️ 27.03.2020):
	```
...
- [GitHub](https://github.com/sony/nnabla) (👨‍💻 64 · 🔀 310 · 📥 530 · 📋 77 - 41% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/nnabla) (📥 4.2K / month · 📦 51 · ⏱️ 26.01.2022):
	```
	pip install nnabla
	```
</details>
<details><summary><b><a href="https://github.com/deepmind/dm-haiku">Haiku</a></b> (🥉30 ·  ⭐ 1.7K) - JAX-based neural network library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/deepmind/dm-haiku) (👨‍💻 57 · 🔀 130 · 📦 330 · 📋 130 - 26% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/deepmind/dm-haiku
	```
- [PyPi](https://pypi.org/project/dm-haiku) (📥 84K / month · 📦 30 · ⏱️ 14.02.2022):
	```
	pip install dm-haiku
	```
- [Conda](https://anaconda.org/conda-forge/dm-haiku) (📥 2K · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/skorch-dev/skorch) (👨‍💻 48 · 🔀 300 · 📦 440 · 📋 420 - 12% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/skorch-dev/skorch
	```
- [PyPi](https://pypi.org/project/skorch) (📥 46K / month · 📦 33 · ⏱️ 31.10.2021):
	```
	pip install skorch
	```
...
- [GitHub](https://github.com/amaiya/ktrain) (👨‍💻 13 · 🔀 230 · 📦 260 · 📋 390 - 0% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ktrain) (📥 36K / month · 📦 2 · ⏱️ 09.02.2022):
	```
	pip install ktrain
	```
</details>
...
- [GitHub](https://github.com/google/neural-tangents) (👨‍💻 22 · 🔀 190 · 📥 200 · 📦 29 · 📋 110 - 33% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/google/neural-tangents
	```
- [PyPi](https://pypi.org/project/neural-tangents) (📥 380 / month · 📦 1 · ⏱️ 17.02.2022):
	```
...
- [GitHub](https://github.com/google/objax) (👨‍💻 22 · 🔀 59 · 📦 18 · 📋 100 - 44% open · ⏱️ 01.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/objax) (📥 460 / month · 📦 2 · ⏱️ 31.01.2022):
	```
	pip install objax
	```
</details>
<details><summary><b><a href="https://github.com/Xtra-Computing/thundersvm">ThunderSVM</a></b> (🥉22 ·  ⭐ 1.4K · 💤) - ThunderSVM: A Fast SVM Library on GPUs and CPUs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/Xtra-Computing/thundersvm) (👨‍💻 33 · 🔀 180 · 📥 2.3K · 📋 200 - 28% open · ⏱️ 10.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/thundersvm) (📥 2.1K / month · ⏱️ 13.03.2020):
	```
...
- [GitHub](https://github.com/serengil/chefboost) (👨‍💻 5 · 🔀 79 · 📦 18 · 📋 17 - 11% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/neoml-lib/neoml) (👨‍💻 29 · 🔀 100 · 📋 70 - 40% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/neoml-lib/neoml
	```
- [PyPi](https://pypi.org/project/neoml) (📥 68 / month · ⏱️ 21.06.2021):
	```
	pip install neoml
	```
</details>
...
- [GitHub](https://github.com/poets-ai/elegy) (👨‍💻 14 · 🔀 21 · 📋 85 - 25% open · ⏱️ 14.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/elegy) (📥 150 / month · ⏱️ 14.12.2021):
	```
	pip install elegy
	```
</details>
...
- <b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉28 ·  ⭐ 5.7K) - In-Database Machine Learning. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/matplotlib/matplotlib">Matplotlib</a></b> (🥇48 ·  ⭐ 15K · 📉) - matplotlib: plotting with Python. <code><a href="http://bit.ly/35wkF7y">Python-2.0</a></code></summary>

- [GitHub](https://github.com/matplotlib/matplotlib) (👨‍💻 1.3K · 🔀 6.2K · 📦 500K · 📋 8.6K - 20% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/matplotlib/matplotlib
	```
- [PyPi](https://pypi.org/project/matplotlib) (📥 24M / month · 📦 52K · ⏱️ 11.12.2021):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 600 · 🔀 3.9K · 📦 45K · 📋 6.8K - 10% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/bokeh/bokeh
	```
- [PyPi](https://pypi.org/project/bokeh) (📥 3.4M / month · 📦 3.5K · ⏱️ 27.01.2022):
	```
	pip install bokeh
	```
...
- [GitHub](https://github.com/plotly/plotly.py) (👨‍💻 190 · 🔀 2.1K · 📦 9 · 📋 2.3K - 48% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/plotly) (📥 7.3M / month · 📦 3.8K · ⏱️ 09.02.2022):
	```
	pip install plotly
	```
- [Conda](https://anaconda.org/conda-forge/plotly) (📥 2.2M · ⏱️ 10.02.2022):
	```
	conda install -c conda-forge plotly
	```
- [npm](https://www.npmjs.com/package/plotlywidget) (📥 50K / month · 📦 4 · ⏱️ 12.01.2021):
	```
	npm install plotlywidget
	```
</details>
<details><summary><b><a href="https://github.com/mwaskom/seaborn">Seaborn</a></b> (🥇41 ·  ⭐ 9.2K) - Statistical data visualization in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 160 · 🔀 1.5K · 📥 210 · 📦 140K · 📋 2K - 5% open · ⏱️ 18.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 7.1M / month · 📦 8.8K · ⏱️ 16.08.2021):
	```
	pip install seaborn
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 140 · 🔀 630 · 📦 22K · 📋 1.6K - 15% open · ⏱️ 07.02.2022):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 4.9M / month · 📦 340 · ⏱️ 29.12.2021):
	```
	pip install altair
	```
...
- [GitHub](https://github.com/plotly/dash) (👨‍💻 100 · 🔀 1.6K · 📦 180 · 📋 1.2K - 47% open · ⏱️ 17.02.2022):
...
- [PyPi](https://pypi.org/project/dash) (📥 930K / month · 📦 1.1K · ⏱️ 28.01.2022):
	...
	pip install dash
	```
- [Conda](https://anaconda.org/conda-forge/dash) (📥 360K · ⏱️ 29.01.2022):
	```
...
- [GitHub](https://github.com/xflr6/graphviz) (👨‍💻 18 · 🔀 170 · 📦 28K · 📋 130 - 4% open · ⏱️ 20.01.2022):

	```
	git clone https://github.com/xflr6/graphviz
	```
- [PyPi](https://pypi.org/project/graphviz) (📥 9.3M / month · 📦 2.9K · ⏱️ 12.12.2021):
	```
...
- [GitHub](https://github.com/pandas-profiling/pandas-profiling) (👨‍💻 85 · 🔀 1.2K · 📦 6.7K · 📋 550 - 19% open · ⏱️ 26.01.2022):

	```
	git clone https://github.com/pandas-profiling/pandas-profiling
	```
- [PyPi](https://pypi.org/project/pandas-profiling) (📥 900K / month · 📦 140 · ⏱️ 27.09.2021):
	```
...
- [GitHub](https://github.com/lmcinnes/umap) (👨‍💻 98 · 🔀 610 · 📦 4.6K · 📋 600 - 52% open · ⏱️ 10.02.2022):
...
- [GitHub](https://github.com/pyecharts/pyecharts) (👨‍💻 30 · 🔀 2.6K · 📦 2K · 📋 1.5K - 1% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyecharts) (📥 40K / month · 📦 210 · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/pyqtgraph/pyqtgraph) (👨‍💻 220 · 🔀 900 · 📋 990 - 31% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/pyqtgraph/pyqtgraph
	```
- [PyPi](https://pypi.org/project/pyqtgraph) (📥 79K / month · 📦 760 · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/holoviz/holoviews) (👨‍💻 120 · 🔀 350 · 📋 2.7K - 30% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/holoviz/holoviews
	```
- [PyPi](https://pypi.org/project/holoviews) (📥 250K / month · 📦 200 · ⏱️ 16.02.2022):
	```
	pip install holoviews
	```
- [Conda](https://anaconda.org/conda-forge/holoviews) (📥 640K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/amueller/word_cloud) (👨‍💻 64 · 🔀 2.1K · 📋 470 - 23% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/wordcloud) (📥 620K / month · 📦 710 · ⏱️ 11.11.2020):
	```
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 56 · 🔀 460 · 📦 30 · 📋 580 - 39% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/bqplot/bqplot
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 67K / month · 📦 92 · ⏱️ 11.02.2022):
	```
	pip install bqplot
	```
- [Conda](https://anaconda.org/conda-forge/bqplot) (📥 920K · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 170 · 🔀 580 · 📦 680 · 📋 1.3K - 21% open · ⏱️ 08.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/vispy) (📥 40K / month · 📦 94 · ⏱️ 04.02.2022):
	```
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 200K · ⏱️ 05.02.2022):
	...
	```
- [npm](https://www.npmjs.com/package/vispy) (📥 13 / month · ⏱️ 15.03.2020):
	```
	npm install vispy
	```
</details>
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 70 · 🔀 210 · 📥 490 · 📦 600 · 📋 700 - 26% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/pyvista/pyvista
	```
- [PyPi](https://pypi.org/project/pyvista) (📥 43K / month · 📦 85 · ⏱️ 11.01.2022):
	```
	pip install pyvista
	```
...
<details><summary><b><a href="https://github.com/finos/perspective">Perspective</a></b> (🥈31 ·  ⭐ 4.2K · 📉) - A data visualization and analytics component,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/finos/perspective) (👨‍💻 66 · 🔀 440 · 📦 230 · 📋 500 - 14% open · ⏱️ 12.02.2022):

	```
	git clone https://github.com/finos/perspective
	```
- [PyPi](https://pypi.org/project/perspective-python) (📥 3.8K / month · 📦 9 · ⏱️ 02.02.2022):
	```
	pip install perspective-python
	```
- [Conda](https://anaconda.org/conda-forge/perspective) (📥 41K · ⏱️ 02.02.2022):
	```
	conda install -c conda-forge perspective
	```
- [npm](https://www.npmjs.com/package/@finos/perspective-jupyterlab) (📥 2.1K / month · ⏱️ 01.02.2022):
	```
	npm install @finos/perspective-jupyterlab
	```
</details>
<details><summary><b><a href="https://github.com/voxel51/fiftyone">FiftyOne</a></b> (🥈31 ·  ⭐ 1K) - Visualize, create, and debug image and video datasets.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 25 · 🔀 130 · 📦 81 · 📋 680 - 31% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/voxel51/fiftyone
	```
- [PyPi](https://pypi.org/project/fiftyone) (📥 24K / month · 📦 1 · ⏱️ 07.02.2022):
	```
	pip install fiftyone
	```
</details>
<details><summary><b><a href="https://github.com/ResidentMario/missingno">missingno</a></b> (🥈30 ·  ⭐ 3.1K · 💤) - Missing data visualization module for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ResidentMario/missingno) (👨‍💻 17 · 🔀 380 · 📦 6.3K · 📋 120 - 11% open · ⏱️ 04.07.2021):

	```
	git clone https://github.com/ResidentMario/missingno
	```
- [PyPi](https://pypi.org/project/missingno) (📥 840K / month · 📦 110 · ⏱️ 04.07.2021):
	```
...
- [GitHub](https://github.com/holoviz/datashader) (👨‍💻 45 · 🔀 330 · 📦 960 · 📋 490 - 26% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/holoviz/datashader
	```
- [PyPi](https://pypi.org/project/datashader) (📥 44K / month · 📦 74 · ⏱️ 09.06.2021):
	```
...
- [GitHub](https://github.com/santosjorge/cufflinks) (👨‍💻 38 · 🔀 580 · 📦 5.2K · 📋 220 - 42% open · ⏱️ 25.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/cufflinks) (📥 290K / month · 📦 160 · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 20 · 🔀 230 · 📦 290 · 📋 440 - 9% open · ⏱️ 08.02.2022):

	```
	git clone https://github.com/man-group/dtale
	```
- [PyPi](https://pypi.org/project/dtale) (📥 57K / month · 📦 11 · ⏱️ 18.11.2021):
	```
	pip install dtale
	```
- [Conda](https://anaconda.org/conda-forge/dtale) (📥 110K · ⏱️ 18.11.2021):
	```
	conda install -c conda-forge dtale
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/data-validation">data-validation</a></b> (🥉29 ·  ⭐ 600) - Library for exploring and validating machine learning.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/data-validation) (👨‍💻 23 · 🔀 110 · 📥 300 · 📦 380 · 📋 150 - 24% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/tensorflow/data-validation
	```
- [PyPi](https://pypi.org/project/tensorflow-data-validation) (📥 2.2M / month · 📦 26 · ⏱️ 21.01.2022):
	```
	pip install tensorflow-data-validation
	```
</details>
<details><summary><b><a href="https://github.com/holoviz/hvplot">hvPlot</a></b> (🥉29 ·  ⭐ 520) - A high-level plotting API for pandas, dask, xarray, and networkx built on.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/holoviz/hvplot) (👨‍💻 35 · 🔀 64 · 📦 1K · 📋 410 - 35% open · ⏱️ 08.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/hvplot) (📥 100K / month · 📦 55 · ⏱️ 09.12.2021):
	```
	pip install hvplot
	```
...
<details><summary><b><a href="https://github.com/ContextLab/hypertools">HyperTools</a></b> (🥉28 ·  ⭐ 1.7K · 📈) - A Python toolbox for gaining geometric insights into high-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ContextLab/hypertools) (👨‍💻 21 · 🔀 160 · 📥 8 · 📦 170 · 📋 190 - 35% open · ⏱️ 12.02.2022):

	```
	git clone https://github.com/ContextLab/hypertools
	```
- [PyPi](https://pypi.org/project/hypertools) (📥 1.5K / month · 📦 10 · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/PAIR-code/facets) (👨‍💻 28 · 🔀 830 · 📦 100 · 📋 150 - 50% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/facets-overview) (📥 140K / month · 📦 4 · ⏱️ 24.07.2019):
	```
...
- [GitHub](https://github.com/jupyter-widgets/pythreejs) (👨‍💻 29 · 🔀 160 · 📦 19 · 📋 210 - 31% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pythreejs) (📥 40K / month · 📦 34 · ⏱️ 26.02.2021):
	```
...
- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 16 · 🔀 32 · 📥 200 · 📦 13 · 📋 230 - 30% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/JetBrains/lets-plot
	```
- [PyPi](https://pypi.org/project/lets-plot) (📥 2.3K / month · 📦 1 · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/hiplot) (👨‍💻 7 · 🔀 110 · 📦 3 · 📋 73 - 15% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/facebookresearch/hiplot
	```
- [PyPi](https://pypi.org/project/hiplot) (📥 11K / month · 📦 10 · ⏱️ 13.02.2022):
	```
	pip install hiplot
	```
- [Conda](https://anaconda.org/conda-forge/hiplot) (📥 77K · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/pavlin-policar/openTSNE) (👨‍💻 10 · 🔀 110 · 📦 290 · 📋 100 - 5% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/pavlin-policar/openTSNE
	```
- [PyPi](https://pypi.org/project/opentsne) (📥 20K / month · 📦 8 · ⏱️ 25.10.2021):
	```
...
<details><summary><b><a href="https://github.com/AutoViML/AutoViz">AutoViz</a></b> (🥉24 ·  ⭐ 640) - Automatically Visualize any dataset, any size with a single line of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/AutoViML/AutoViz) (👨‍💻 11 · 🔀 98 · 📦 140 · 📋 50 - 12% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/AutoViML/AutoViz
	```
- [PyPi](https://pypi.org/project/autoviz) (📥 38K / month · 📦 5 · ⏱️ 13.02.2022):
	```
	pip install autoviz
	```
- [Conda](https://anaconda.org/conda-forge/autoviz) (📥 2.2K · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/PatrikHlobil/Pandas-Bokeh) (👨‍💻 13 · 🔀 95 · 📦 280 · 📋 96 - 31% open · ⏱️ 11.01.2022):

	```
	git clone https://github.com/PatrikHlobil/Pandas-Bokeh
	```
- [PyPi](https://pypi.org/project/pandas-bokeh) (📥 17K / month · 📦 11 · ⏱️ 11.04.2021):
	```
	pip install pandas-bokeh
	```
</details>
<details><summary><b><a href="https://github.com/marcharper/python-ternary">python-ternary</a></b> (🥉23 ·  ⭐ 520) - Ternary plotting library for python with matplotlib. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/leotac/joypy) (👨‍💻 6 · 🔀 46 · 📦 130 · 📋 48 - 22% open · ⏱️ 19.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/joypy) (📥 34K / month · 📦 5 · ⏱️ 19.12.2021):
	```
	pip install joypy
	```
...
- [GitHub](https://github.com/fbdesignpro/sweetviz) (👨‍💻 6 · 🔀 190 · 📋 97 - 27% open · ⏱️ 08.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/sweetviz) (📥 65K / month · 📦 5 · ⏱️ 08.07.2021):
	```
	pip install sweetviz
	```
- [Conda](https://anaconda.org/conda-forge/sweetviz) (📥 8.7K · ⏱️ 09.07.2021):
	```
...
- [GitHub](https://github.com/SauceCat/PDPbox) (👨‍💻 7 · 🔀 110 · 📦 480 · 📋 58 - 34% open · ⏱️ 14.03.2021):

	```
	git clone https://github.com/SauceCat/PDPbox
	```
- [PyPi](https://pypi.org/project/pdpbox) (📥 53K / month · 📦 25 · ⏱️ 14.03.2021):
	```
	pip install pdpbox
	```
...
- [GitHub](https://github.com/gyli/PyWaffle) (👨‍💻 6 · 🔀 82 · 📦 110 · 📋 16 - 25% open · ⏱️ 21.12.2021):
...
- <b><a href="https://github.com/adrotog/PandasGUI">PandasGUI</a></b> (🥉23 ·  ⭐ 2.6K) - A GUI for Pandas DataFrames. <code><a href="https://tldrlegal.com/search?q=MIT-0">❗️MIT-0</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/huggingface/transformers) (👨‍💻 1.2K · 🔀 14K · 📥 1.4K · 📦 22K · 📋 8.8K - 4% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/huggingface/transformers
	```
- [PyPi](https://pypi.org/project/transformers) (📥 3.7M / month · 📦 760 · ⏱️ 31.01.2022):
	```
	pip install transformers
	```
- [Conda](https://anaconda.org/conda-forge/transformers) (📥 96K · ⏱️ 31.01.2022):
	```
...
- [GitHub](https://github.com/explosion/spaCy) (👨‍💻 660 · 🔀 3.7K · 📥 3.1K · 📦 35K · 📋 5K - 1% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/explosion/spaCy
	```
- [PyPi](https://pypi.org/project/spacy) (📥 4.1M / month · 📦 2.2K · ⏱️ 11.02.2022):
	```
	pip install spacy
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 420 · 🔀 4.1K · 📥 3.5K · 📦 30K · 📋 1.7K - 21% open · ⏱️ 25.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/gensim) (📥 5.7M / month · 📦 2.8K · ⏱️ 17.09.2021):
	```
	pip install gensim
	```
...
- [GitHub](https://github.com/RasaHQ/rasa) (👨‍💻 530 · 🔀 3.9K · 📋 6.6K - 14% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/RasaHQ/rasa
	```
- [PyPi](https://pypi.org/project/rasa) (📥 240K / month · 📦 57 · ⏱️ 11.02.2022):
	```
	pip install rasa
	```
</details>
...
- [GitHub](https://github.com/flairNLP/flair) (👨‍💻 220 · 🔀 1.8K · 📦 1.2K · 📋 1.8K - 4% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/flairNLP/flair
	```
- [PyPi](https://pypi.org/project/flair) (📥 82K / month · 📦 66 · ⏱️ 18.11.2021):
	```
	pip install flair
	```
...
- [GitHub](https://github.com/allenai/allennlp) (👨‍💻 260 · 🔀 2.2K · 📥 44 · 📦 2.2K · 📋 2.5K - 4% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/pytorch/fairseq) (👨‍💻 370 · 🔀 4K · 📥 180 · 📦 660 · 📋 3.2K - 36% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/pytorch/fairseq
	```
- [PyPi](https://pypi.org/project/fairseq) (📥 38K / month · 📦 28 · ⏱️ 05.01.2021):
	```
	pip install fairseq
	```
...
- [GitHub](https://github.com/gunthercox/ChatterBot) (👨‍💻 100 · 🔀 3.9K · 📦 4.2K · 📋 1.5K - 19% open · ⏱️ 01.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/chatterbot) (📥 30K / month · 📦 350 · ⏱️ 22.08.2020):
	```
...
- [GitHub](https://github.com/facebookresearch/ParlAI) (👨‍💻 170 · 🔀 1.7K · 📦 61 · 📋 1.2K - 7% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/facebookresearch/ParlAI
	```
- [PyPi](https://pypi.org/project/parlai) (📥 6.7K / month · 📦 3 · ⏱️ 12.10.2021):
	```
	pip install parlai
	```
</details>
...
<details><summary><b><a href="https://github.com/UKPLab/sentence-transformers">sentence-transformers</a></b> (🥈34 ·  ⭐ 7.1K) - Multilingual Sentence & Image Embeddings with BERT. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/UKPLab/sentence-transformers) (👨‍💻 74 · 🔀 1.4K · 📦 2.4K · 📋 1.3K - 49% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/UKPLab/sentence-transformers
	```
- [PyPi](https://pypi.org/project/sentence-transformers) (📥 760K / month · 📦 80 · ⏱️ 01.10.2021):
	```
...
- [GitHub](https://github.com/JohnSnowLabs/spark-nlp) (👨‍💻 110 · 🔀 530 · 📋 640 - 13% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/JohnSnowLabs/spark-nlp
	```
- [PyPi](https://pypi.org/project/spark-nlp) (📥 1.6M / month · 📦 9 · ⏱️ 08.02.2022):
	```
	pip install spark-nlp
	```
</details>
<details><summary><b><a href="https://github.com/google/sentencepiece">sentencepiece</a></b> (🥈33 ·  ⭐ 5.7K) - Unsupervised text tokenizer for Neural Network-based text.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google/sentencepiece) (👨‍💻 62 · 🔀 790 · 📥 20K · 📦 13K · 📋 520 - 11% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/google/sentencepiece
	```
- [PyPi](https://pypi.org/project/sentencepiece) (📥 4.5M / month · 📦 350 · ⏱️ 18.06.2021):
	```
	pip install sentencepiece
	```
- [Conda](https://anaconda.org/conda-forge/sentencepiece) (📥 150K · ⏱️ 11.02.2022):
	```
	conda install -c conda-forge sentencepiece
	```
</details>
<details><summary><b><a href="https://github.com/OpenNMT/OpenNMT-py">OpenNMT</a></b> (🥈33 ·  ⭐ 5.5K) - Open Source Neural Machine Translation in PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/OpenNMT/OpenNMT-py) (👨‍💻 170 · 🔀 2K · 📦 120 · 📋 1.3K - 9% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/OpenNMT-py) (📥 18K / month · 📦 8 · ⏱️ 14.09.2021):
	```
	pip install OpenNMT-py
	```
</details>
<details><summary><b><a href="https://github.com/huggingface/tokenizers">Tokenizers</a></b> (🥈33 ·  ⭐ 5.3K) - Fast State-of-the-Art Tokenizers optimized for Research and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 51 · 🔀 440 · 📦 40 · 📋 580 - 29% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/huggingface/tokenizers
	```
- [PyPi](https://pypi.org/project/tokenizers) (📥 4.6M / month · 📦 96 · ⏱️ 16.02.2022):
	```
	pip install tokenizers
	```
- [Conda](https://anaconda.org/conda-forge/tokenizers) (📥 110K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/dedupeio/dedupe) (👨‍💻 63 · 🔀 460 · 📦 210 · 📋 690 - 3% open · ⏱️ 11.02.2022):
...
- [PyPi](https://pypi.org/project/dedupe) (📥 290K / month · 📦 47 · ⏱️ 03.02.2022):
	...
	pip install dedupe
	```
- [Conda](https://anaconda.org/conda-forge/dedupe) (📥 1.3K · ⏱️ 04.02.2022):
	```
...
- [GitHub](https://github.com/pytorch/text) (👨‍💻 120 · 🔀 680 · 📋 690 - 47% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/pytorch/text
	```
- [PyPi](https://pypi.org/project/torchtext) (📥 130K / month · 📦 430 · ⏱️ 27.01.2022):
	```
	pip install torchtext
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/text">TensorFlow Text</a></b> (🥈32 ·  ⭐ 900) - Making text a first-class citizen in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/text) (👨‍💻 75 · 🔀 180 · 📦 1.4K · 📋 190 - 35% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/tensorflow/text
	```
- [PyPi](https://pypi.org/project/tensorflow-text) (📥 2.1M / month · 📦 69 · ⏱️ 04.02.2022):
	```
	pip install tensorflow-text
	```
</details>
<details><summary><b><a href="https://github.com/stanfordnlp/stanza">stanza</a></b> (🥈31 ·  ⭐ 6K · 📉) - Official Stanford NLP Python Library for Many Human Languages. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 41 · 🔀 760 · 📦 860 · 📋 640 - 11% open · ⏱️ 26.01.2022):

	```
	git clone https://github.com/stanfordnlp/stanza
	```
- [PyPi](https://pypi.org/project/stanza) (📥 430K / month · 📦 49 · ⏱️ 05.10.2021):
	```
	pip install stanza
	```
- [Conda](https://anaconda.org/stanfordnlp/stanza) (📥 4.7K · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 4.9K · 📋 130 - 7% open · ⏱️ 09.02.2022):
...
- [GitHub](https://github.com/chartbeat-labs/textacy) (👨‍💻 31 · 🔀 230 · 📋 250 - 10% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/textacy) (📥 48K / month · 📦 100 · ⏱️ 06.12.2021):
	```
	pip install textacy
	```
...
<details><summary><b><a href="https://github.com/snowballstem/snowball">snowballstemmer</a></b> (🥈31 ·  ⭐ 540) - Snowball compiler and stemming algorithms. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/snowballstem/snowball) (👨‍💻 28 · 🔀 150 · 📦 4 · 📋 69 - 36% open · ⏱️ 17.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/snowballstemmer) (📥 6.4M / month · 📦 6.7K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/deepmipt/DeepPavlov) (👨‍💻 67 · 🔀 990 · 📦 250 · 📋 620 - 18% open · ⏱️ 16.12.2021):

	```
	git clone https://github.com/deepmipt/DeepPavlov
	```
- [PyPi](https://pypi.org/project/deeppavlov) (📥 9.3K / month · 📦 6 · ⏱️ 16.12.2021):
	```
...
- [GitHub](https://github.com/NVIDIA/NeMo) (👨‍💻 130 · 🔀 850 · 📥 5K · 📋 980 - 7% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/NVIDIA/NeMo
	```
- [PyPi](https://pypi.org/project/nemo-toolkit) (📥 13K / month · 📦 7 · ⏱️ 05.02.2022):
	```
...
- [GitHub](https://github.com/jamesturk/jellyfish) (👨‍💻 25 · 🔀 150 · 📦 3.3K · 📋 110 - 8% open · ⏱️ 07.01.2022):
...
<details><summary><b><a href="https://github.com/makcedward/nlpaug">nlpaug</a></b> (🥈29 ·  ⭐ 2.9K) - Data augmentation for NLP. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/makcedward/nlpaug) (👨‍💻 26 · 🔀 330 · 📦 250 · 📋 170 - 17% open · ⏱️ 04.01.2022):

	```
	git clone https://github.com/makcedward/nlpaug
	```
- [PyPi](https://pypi.org/project/nlpaug) (📥 45K / month · 📦 14 · ⏱️ 23.12.2021):
	```
	pip install nlpaug
	```
- [Conda](https://anaconda.org/conda-forge/nlpaug) (📥 1.3K · ⏱️ 25.12.2021):
	```
...
- [GitHub](https://github.com/dmlc/gluon-nlp) (👨‍💻 82 · 🔀 520 · 📦 710 · 📋 560 - 46% open · ⏱️ 24.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/gluonnlp) (📥 95K / month · 📦 22 · ⏱️ 13.08.2020):
	```
...
- [GitHub](https://github.com/cltk/cltk) (👨‍💻 110 · 🔀 310 · 📥 25 · 📦 190 · 📋 510 - 4% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/cltk/cltk
	```
- [PyPi](https://pypi.org/project/cltk) (📥 2.8K / month · 📦 42 · ⏱️ 11.02.2022):
	```
	pip install cltk
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 220 · 🔀 800 · 📥 290 · 📦 100 · 📋 220 - 66% open · ⏱️ 08.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytext-nlp) (📥 250 / month · 📦 1 · ⏱️ 08.06.2020):
	```
	pip install pytext-nlp
	```
</details>
<details><summary><b><a href="https://github.com/deepset-ai/haystack">haystack</a></b> (🥈28 ·  ⭐ 4.2K) - Haystack is an open source NLP framework that leverages Transformer.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 99 · 🔀 670 · 📥 6 · 📋 1.2K - 14% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/deepset-ai/haystack
	```
- [PyPi](https://pypi.org/project/haystack) (📥 820 / month · 📦 85 · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/google-research/text-to-text-transfer-transformer) (👨‍💻 44 · 🔀 540 · 📦 83 · 📋 400 - 16% open · ⏱️ 10.02.2022):

	```
	git clone https://github.com/google-research/text-to-text-transfer-transformer
	```
- [PyPi](https://pypi.org/project/t5) (📥 6K / month · 📦 2 · ⏱️ 18.10.2021):
	```
	pip install t5
	```
</details>
<details><summary><b><a href="https://github.com/cjhutto/vaderSentiment">vaderSentiment</a></b> (🥈28 ·  ⭐ 3.4K · 💤) - VADER Sentiment Analysis. VADER (Valence Aware Dictionary.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/cjhutto/vaderSentiment) (👨‍💻 10 · 🔀 830 · 📦 3.5K · 📋 110 - 30% open · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/vadersentiment) (📥 450K / month · 📦 170 · ⏱️ 22.05.2020):
	```
	pip install vadersentiment
	```
- [Conda](https://anaconda.org/conda-forge/vadersentiment) (📥 8.1K · ⏱️ 22.03.2021):
	```
...
- [PyPi](https://pypi.org/project/sumy) (📥 26K / month · 📦 100 · ⏱️ 21.10.2021):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 630 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 11 · 🔀 200 · 📥 470 · 📦 1.7K · ⏱️ 29.11.2021):
...
- [PyPi](https://pypi.org/project/textdistance) (📥 290K / month · 📦 39 · ⏱️ 27.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 75K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/DerwenAI/pytextrank) (👨‍💻 18 · 🔀 320 · 📦 230 · 📋 83 - 27% open · ⏱️ 04.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytextrank) (📥 22K / month · 📦 12 · ⏱️ 10.10.2021):
	```
	pip install pytextrank
	```
</details>
<details><summary><b><a href="https://github.com/Ciphey/Ciphey">Ciphey</a></b> (🥈27 ·  ⭐ 9.5K) - Automatically decrypt encryptions without knowing the key or cipher,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/huggingface/neuralcoref) (👨‍💻 21 · 🔀 430 · 📥 310 · 📦 450 · 📋 290 - 16% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/huggingface/neuralcoref
	```
- [PyPi](https://pypi.org/project/neuralcoref) (📥 51K / month · 📦 14 · ⏱️ 08.04.2019):
	```
...
<details><summary><b><a href="https://github.com/dwyl/english-words">english-words</a></b> (🥉26 ·  ⭐ 6.6K) - A text file containing 479k English words for all your.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>
...
<details><summary><b><a href="https://github.com/fastnlp/fastNLP">fastNLP</a></b> (🥉26 ·  ⭐ 2.5K) - fastNLP: A Modularized and Extensible NLP Framework. Currently still.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/fastnlp/fastNLP) (👨‍💻 54 · 🔀 410 · 📥 65 · 📦 58 · 📋 180 - 19% open · ⏱️ 06.12.2021):
...
<details><summary><b><a href="https://github.com/allenai/scispacy">SciSpacy</a></b> (🥉26 ·  ⭐ 1.1K) - A full spaCy pipeline and models for scientific/biomedical documents. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/allenai/scispacy) (👨‍💻 22 · 🔀 150 · 📦 400 · 📋 240 - 14% open · ⏱️ 03.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/scispacy) (📥 27K / month · 📦 11 · ⏱️ 12.02.2021):
	```
...
- [GitHub](https://github.com/explosion/spacy-transformers) (👨‍💻 18 · 🔀 140 · 📦 400 · ⏱️ 13.01.2022):

	```
	git clone https://github.com/explosion/spacy-transformers
	```
- [PyPi](https://pypi.org/project/spacy-transformers) (📥 89K / month · 📦 13 · ⏱️ 14.01.2022):
	```
	pip install spacy-transformers
	```
- [Conda](https://anaconda.org/conda-forge/spacy-transformers) (📥 430 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/snipsco/snips-nlu) (👨‍💻 22 · 🔀 500 · 📋 260 - 23% open · ⏱️ 03.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/snips-nlu) (📥 3.6K / month · 📦 11 · ⏱️ 15.01.2020):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 240 · 📦 330 · 📋 67 - 26% open · ⏱️ 10.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-nlp) (📥 7.4K / month · 📦 17 · ⏱️ 04.11.2019):
	```
...
- [GitHub](https://github.com/JasonKessler/scattertext) (👨‍💻 12 · 🔀 240 · 📦 260 · 📋 85 - 20% open · ⏱️ 15.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/scattertext) (📥 3.3K / month · 📦 10 · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/NTMC-Community/MatchZoo) (👨‍💻 36 · 🔀 910 · 📦 10 · 📋 460 - 6% open · ⏱️ 02.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/matchzoo) (📥 110 / month · ⏱️ 24.10.2019):
	```
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 17 · 🔀 220 · 📥 25K · 📦 120 · 📋 110 - 17% open · ⏱️ 16.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/sense2vec) (📥 9.7K / month · 📦 8 · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/awslabs/sockeye) (👨‍💻 55 · 🔀 300 · 📥 14 · 📋 270 - 3% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/awslabs/sockeye
	```
- [PyPi](https://pypi.org/project/sockeye) (📥 1.3K / month · 📦 2 · ⏱️ 11.02.2022):
	```
	pip install sockeye
	```
</details>
...
- [GitHub](https://github.com/BrikerMan/Kashgari) (👨‍💻 21 · 🔀 430 · 📦 50 · 📋 360 - 10% open · ⏱️ 09.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/kashgari-tf) (📥 87 / month · 📦 2 · ⏱️ 18.10.2019):
	```
...
- [GitHub](https://github.com/bytedance/lightseq) (👨‍💻 8 · 🔀 210 · 📥 580 · 📋 150 - 52% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/bytedance/lightseq
	```
- [PyPi](https://pypi.org/project/lightseq) (📥 1.5K / month · ⏱️ 26.01.2022):
	```
	pip install lightseq
	```
</details>
<details><summary><b><a href="https://github.com/recognai/rubrix">rubrix</a></b> (🥉23 ·  ⭐ 860) - Python framework for data-centric NLP. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/recognai/rubrix) (👨‍💻 18 · 🔀 74 · 📋 430 - 15% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/recognai/rubrix
	```
- [PyPi](https://pypi.org/project/rubrix) (📥 1.4K / month · ⏱️ 12.02.2022):
	```
	pip install rubrix
	```
- [Conda](https://anaconda.org/conda-forge/rubrix) (📥 220 · ⏱️ 12.02.2022):
	```
	conda install -c conda-forge rubrix
	```
</details>
<details><summary><b><a href="https://github.com/nipunsadvilkar/pySBD">pySBD</a></b> (🥉23 ·  ⭐ 420 · 💤) - pySBD (Python Sentence Boundary Disambiguation) is a rule-based sentence.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nipunsadvilkar/pySBD) (👨‍💻 6 · 🔀 49 · 📦 280 · 📋 62 - 22% open · ⏱️ 11.02.2021):

	```
	git clone https://github.com/nipunsadvilkar/pySBD
	```
- [PyPi](https://pypi.org/project/pysbd) (📥 47K / month · 📦 3 · ⏱️ 11.02.2021):
	```
	pip install pysbd
	```
- [Conda](https://anaconda.org/conda-forge/pysbd) (📥 220 · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/minimaxir/gpt-2-simple) (👨‍💻 18 · 🔀 590 · 📥 290 · 📋 240 - 61% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/gpt-2-simple) (📥 6.4K / month · 📦 5 · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/IntelLabs/nlp-architect) (👨‍💻 37 · 🔀 440 · 📦 8 · 📋 130 - 15% open · ⏱️ 12.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/nlp-architect) (📥 260 / month · ⏱️ 12.04.2020):
	```
...
- [GitHub](https://github.com/jbesomi/texthero) (👨‍💻 18 · 🔀 210 · 📥 87 · 📋 140 - 56% open · ⏱️ 19.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/texthero) (📥 34K / month · 📦 4 · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/utterworks/fast-bert) (👨‍💻 35 · 🔀 330 · 📋 250 - 61% open · ⏱️ 10.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/fast-bert) (📥 1.2K / month · 📦 2 · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/Hironsan/anago) (👨‍💻 11 · 🔀 360 · 📦 28 · 📋 110 - 33% open · ⏱️ 01.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/anago) (📥 540 / month · 📦 5 · ⏱️ 17.07.2018):
	```
	pip install anago
	```
</details>
...
- [GitHub](https://github.com/anhaidgroup/deepmatcher) (👨‍💻 7 · 🔀 1.5K · 📦 14 · 📋 77 - 71% open · ⏱️ 13.06.2021):

	```
	git clone https://github.com/anhaidgroup/deepmatcher
	```
- [PyPi](https://pypi.org/project/deepmatcher) (📥 370 / month · ⏱️ 13.06.2021):
	```
	pip install deepmatcher
	```
</details>
<details><summary><b><a href="https://github.com/deepset-ai/FARM">FARM</a></b> (🥉21 ·  ⭐ 1.5K) - Fast & easy transfer learning for NLP. Harvesting language models.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/deepset-ai/FARM) (👨‍💻 37 · 🔀 210 · 📋 430 - 8% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/farm) (📥 7.4K / month · 📦 2 · ⏱️ 10.06.2021):
	```
	pip install farm
	```
- [Conda](https://anaconda.org/conda-forge/farm) (📥 900 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/nyu-mll/jiant) (👨‍💻 56 · 🔀 260 · 📦 2 · 📋 550 - 11% open · ⏱️ 03.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/jiant) (📥 78 / month · ⏱️ 10.05.2021):
	```
	pip install jiant
	```
</details>
...
- [GitHub](https://github.com/thunlp/OpenPrompt) (👨‍💻 10 · 🔀 110 · 📦 7 · 📋 92 - 21% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/thunlp/OpenPrompt
	```
- [PyPi](https://pypi.org/project/openprompt) (📥 360 / month · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/unitaryai/detoxify) (👨‍💻 4 · 🔀 42 · 📥 32K · 📦 34 · 📋 23 - 43% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/unitaryai/detoxify
	```
- [PyPi](https://pypi.org/project/detoxify) (📥 5.6K / month · 📦 1 · ⏱️ 27.10.2021):
	```
	pip install detoxify
	```
</details>
<details><summary><b><a href="https://github.com/qdrant/qdrant">qdrant</a></b> (🥉20 ·  ⭐ 1.2K) - Qdrant - vector similarity search engine with extended filtering.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/qdrant/qdrant) (👨‍💻 22 · 🔀 72 · 📋 99 - 31% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/IndicoDataSolutions/finetune) (👨‍💻 19 · 🔀 71 · 📦 9 · 📋 140 - 15% open · ⏱️ 20.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/finetune) (📥 92 / month · 📦 2 · ⏱️ 20.12.2021):
	```
...
- [GitHub](https://github.com/RUCAIBox/TextBox) (👨‍💻 13 · 🔀 59 · 📦 5 · 📋 18 - 16% open · ⏱️ 08.02.2022):

	```
	git clone https://github.com/RUCAIBox/TextBox
	```
- [PyPi](https://pypi.org/project/textbox) (📥 49 / month · ⏱️ 15.04.2021):
	```
	pip install textbox
	```
</details>
...
<details><summary><b><a href="https://github.com/facebookresearch/vizseq">VizSeq</a></b> (🥉15 ·  ⭐ 380) - An Analysis Toolkit for Natural Language Generation (Translation,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/vizseq) (👨‍💻 3 · 🔀 45 · 📦 4 · 📋 16 - 43% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/facebookresearch/vizseq
	```
- [PyPi](https://pypi.org/project/vizseq) (📥 96 / month · ⏱️ 07.08.2020):
	```
	pip install vizseq
	```
</details>
<details><summary><b><a href="https://github.com/pytorch/translate">Translate</a></b> (🥉14 ·  ⭐ 720) - Translate - a PyTorch Language Library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/pytorch/translate) (👨‍💻 87 · 🔀 170 · 📋 93 - 70% open · ⏱️ 06.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-translate) (📥 2 / month · ⏱️ 01.05.2018):
	```
	pip install pytorch-translate
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/BLINK">BLINK</a></b> (🥉13 ·  ⭐ 820 · 💤) - Entity Linker solution. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/BLINK) (👨‍💻 16 · 🔀 150 · 📋 79 - 60% open · ⏱️ 02.04.2021):
...
- <b><a href="https://github.com/minimaxir/textgenrnn">textgenrnn</a></b> (🥉26 ·  ⭐ 4.6K · 💀) - Easily train your own text-generating neural network of any.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/mchaput/whoosh">whoosh</a></b> (🥉23 ·  ⭐ 200) - Pure-Python full-text search library. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
- <b><a href="https://github.com/Alir3z4/python-stop-words">stop-words</a></b> (🥉23 ·  ⭐ 140 · 💀) - Get list of common stop words in various languages in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/EricFillion/happy-transformer">happy-transformer</a></b> (🥉21 ·  ⭐ 260) - A package built on top of Hugging Faces transformers.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>huggingface</code>
...
- <b><a href="https://github.com/Ki6an/fastT5">fastT5</a></b> (🥉19 ·  ⭐ 260) - boost inference speed of T5 models by 5x & reduce the model size by 3x. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/MartinoMensio/spacy-dbpedia-spotlight">spacy-dbpedia-spotlight</a></b> (🥉9 ·  ⭐ 51) - A spaCy wrapper for DBpedia Spotlight. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>spacy</code>
</details>
<br>
...
<details><summary><b><a href="https://github.com/python-pillow/Pillow">Pillow</a></b> (🥇45 ·  ⭐ 9.5K) - The friendly PIL fork (Python Imaging Library). <code><a href="https://tldrlegal.com/search?q=PIL">❗️PIL</a></code></summary>

- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 380 · 🔀 1.8K · 📋 2.4K - 6% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/scikit-image/scikit-image) (👨‍💻 540 · 🔀 1.9K · 📦 93K · 📋 2.4K - 13% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/scikit-image/scikit-image
	```
- [PyPi](https://pypi.org/project/scikit-image) (📥 4.9M / month · 📦 9K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/pytorch/vision) (👨‍💻 460 · 🔀 5.6K · 📋 2.3K - 28% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/pytorch/vision
	```
- [PyPi](https://pypi.org/project/torchvision) (📥 3.1M / month · 📦 3.5K · ⏱️ 27.01.2022):
	```
...
- [GitHub](https://github.com/open-mmlab/mmdetection) (👨‍💻 300 · 🔀 6.6K · 📦 250 · 📋 5.2K - 9% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/open-mmlab/mmdetection
	```
- [PyPi](https://pypi.org/project/mmdet) (📥 36K / month · 📦 6 · ⏱️ 08.02.2022):
	```
	pip install mmdet
	```
</details>
...
- [GitHub](https://github.com/rwightman/pytorch-image-models) (👨‍💻 65 · 🔀 2.6K · 📥 910K · 📦 2K · 📋 470 - 14% open · ⏱️ 02.02.2022):

	```
	git clone https://github.com/rwightman/pytorch-image-models
	```
- [PyPi](https://pypi.org/project/timm) (📥 610K / month · 📦 67 · ⏱️ 17.01.2022):
	```
	pip install timm
	```
...
<details><summary><b><a href="https://github.com/imageio/imageio">imageio</a></b> (🥇37 ·  ⭐ 990) - Python library for reading and writing image data. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/imageio/imageio) (👨‍💻 85 · 🔀 200 · 📥 150 · 📦 56K · 📋 420 - 16% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/imageio/imageio
	```
- [PyPi](https://pypi.org/project/imageio) (📥 14M / month · 📦 2.6K · ⏱️ 14.02.2022):
	```
	pip install imageio
	```
- [Conda](https://anaconda.org/conda-forge/imageio) (📥 2.5M · ⏱️ 14.02.2022):
	```
	conda install -c conda-forge imageio
	```
</details>
<details><summary><b><a href="https://github.com/albumentations-team/albumentations">Albumentations</a></b> (🥈35 ·  ⭐ 9.7K) - Fast image augmentation library and an easy-to-use wrapper.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/albumentations-team/albumentations) (👨‍💻 100 · 🔀 1.2K · 📦 6.6K · 📋 580 - 41% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/albumentations-team/albumentations
	```
- [PyPi](https://pypi.org/project/albumentations) (📥 310K / month · 📦 180 · ⏱️ 04.10.2021):
	```
...
<details><summary><b><a href="https://github.com/Zulko/moviepy">MoviePy</a></b> (🥈35 ·  ⭐ 9K) - Video editing with Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Zulko/moviepy) (👨‍💻 140 · 🔀 1.2K · 📦 14K · 📋 1.2K - 28% open · ⏱️ 12.11.2021):

	```
	git clone https://github.com/Zulko/moviepy
	```
- [PyPi](https://pypi.org/project/moviepy) (📥 2.9M / month · 📦 720 · ⏱️ 15.12.2021):
	```
	pip install moviepy
	```
...
- [GitHub](https://github.com/kornia/kornia) (👨‍💻 150 · 🔀 580 · 📥 200 · 📦 980 · 📋 540 - 25% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/kornia/kornia
	```
- [PyPi](https://pypi.org/project/kornia) (📥 300K / month · 📦 44 · ⏱️ 31.01.2022):
	```
	pip install kornia
	```
...
- [GitHub](https://github.com/facebookresearch/detectron2) (👨‍💻 200 · 🔀 5.1K · 📦 500 · 📋 2.8K - 5% open · ⏱️ 07.02.2022):
...
- [GitHub](https://github.com/deepinsight/insightface) (👨‍💻 37 · 🔀 3.6K · 📦 130 · 📋 1.8K - 54% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/deepinsight/insightface
	```
- [PyPi](https://pypi.org/project/insightface) (📥 23K / month · 📦 5 · ⏱️ 29.01.2022):
	```
...
- [GitHub](https://github.com/opencv/opencv-python) (👨‍💻 36 · 🔀 500 · 📋 510 - 6% open · ⏱️ 25.01.2022):

	```
	git clone https://github.com/opencv/opencv-python
	```
- [PyPi](https://pypi.org/project/opencv-python) (📥 5.1M / month · 📦 8.7K · ⏱️ 29.12.2021):
	```
...
- [GitHub](https://github.com/dmlc/gluon-cv) (👨‍💻 120 · 🔀 1.1K · 📦 670 · 📋 810 - 7% open · ⏱️ 02.02.2022):

	```
	git clone https://github.com/dmlc/gluon-cv
	```
- [PyPi](https://pypi.org/project/gluoncv) (📥 570K / month · 📦 59 · ⏱️ 17.02.2022):
	```
	pip install gluoncv
	```
</details>
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 97 · 🔀 190 · 📥 6.1K · 📦 9.2K · 📋 360 - 4% open · ⏱️ 31.01.2022):

	```
	git clone https://github.com/emcconville/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 430K / month · 📦 680 · ⏱️ 17.08.2021):
	```
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 8.7K · ⏱️ 30.11.2020):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleSeg) (👨‍💻 74 · 🔀 830 · 📦 490 · 📋 880 - 49% open · ⏱️ 01.02.2022):

	```
	git clone https://github.com/PaddlePaddle/PaddleSeg
	```
- [PyPi](https://pypi.org/project/paddleseg) (📥 1.4K / month · 📦 2 · ⏱️ 20.01.2022):
	```
...
- [GitHub](https://github.com/serengil/deepface) (👨‍💻 21 · 🔀 730 · 📦 410 · 📋 400 - 0% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/serengil/deepface
	```
- [PyPi](https://pypi.org/project/deepface) (📥 33K / month · 📦 3 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/OlafenwaMoses/ImageAI) (👨‍💻 15 · 🔀 1.9K · 📥 710K · 📦 1K · 📋 680 - 36% open · ⏱️ 08.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/imageai) (📥 8.4K / month · 📦 16 · ⏱️ 05.01.2021):
	```
	pip install imageai
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleDetection) (👨‍💻 80 · 🔀 1.6K · 📦 9 · 📋 3K - 30% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/PaddlePaddle/PaddleDetection
	```
- [PyPi](https://pypi.org/project/paddledet) (📥 300 / month · ⏱️ 26.11.2021):
	```
...
- [GitHub](https://github.com/JohannesBuchner/imagehash) (👨‍💻 20 · 🔀 290 · 📦 4.3K · 📋 110 - 12% open · ⏱️ 07.09.2021):
...
<details><summary><b><a href="https://github.com/lucidrains/vit-pytorch">vit-pytorch</a></b> (🥈29 ·  ⭐ 8.6K) - Implementation of Vision Transformer, a simple way to achieve.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/lucidrains/vit-pytorch) (👨‍💻 14 · 🔀 1.4K · 📦 70 · 📋 170 - 48% open · ⏱️ 31.01.2022):
...
<details><summary><b><a href="https://github.com/PyImageSearch/imutils">imutils</a></b> (🥈29 ·  ⭐ 4K) - A series of convenience functions to make basic image processing operations.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥉28 ·  ⭐ 2.1K) - A High-performance cross-platform Video Processing Python framework.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 9 · 🔀 160 · 📥 530 · 📦 170 · 📋 200 - 1% open · ⏱️ 11.02.2022):
...
- [GitHub](https://github.com/1adrianb/face-alignment) (👨‍💻 23 · 🔀 1.1K · 📋 270 - 19% open · ⏱️ 04.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/face-alignment) (📥 7.5K / month · 📦 8 · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/mdbloice/Augmentor) (👨‍💻 22 · 🔀 830 · 📦 410 · 📋 190 - 63% open · ⏱️ 15.10.2021):

	```
	git clone https://github.com/mdbloice/Augmentor
	```
- [PyPi](https://pypi.org/project/Augmentor) (📥 9.9K / month · 📦 29 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/luispedro/mahotas) (👨‍💻 32 · 🔀 140 · 📦 760 · 📋 77 - 20% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/luispedro/mahotas
	```
- [PyPi](https://pypi.org/project/mahotas) (📥 9.1K / month · 📦 110 · ⏱️ 14.10.2021):
	```
	pip install mahotas
	```
...
- [GitHub](https://github.com/facebookresearch/mmf) (👨‍💻 91 · 🔀 800 · 📦 11 · 📋 610 - 31% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/facebookresearch/mmf
	```
- [PyPi](https://pypi.org/project/mmf) (📥 610 / month · 📦 1 · ⏱️ 12.06.2020):
	```
	pip install mmf
	```
</details>
...
- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 14 · 🔀 97 · 📦 30 · 📋 300 - 21% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/lightly-ai/lightly
	```
- [PyPi](https://pypi.org/project/lightly) (📥 3.3K / month · 📦 1 · ⏱️ 15.02.2022):
	```
	pip install lightly
	```
</details>
...
- [GitHub](https://github.com/CellProfiler/CellProfiler) (👨‍💻 120 · 🔀 300 · 📥 2.3K · 📦 7 · 📋 3K - 6% open · ⏱️ 01.02.2022):
...
- [GitHub](https://github.com/Layout-Parser/layout-parser) (👨‍💻 8 · 🔀 270 · 📦 45 · 📋 79 - 51% open · ⏱️ 02.02.2022):

	```
	git clone https://github.com/Layout-Parser/layout-parser
	```
- [PyPi](https://pypi.org/project/layoutparser) (📥 5K / month · 📦 1 · ⏱️ 23.09.2021):
	```
...
- [GitHub](https://github.com/timesler/facenet-pytorch) (👨‍💻 14 · 🔀 570 · 📥 200K · 📦 640 · 📋 150 - 38% open · ⏱️ 13.12.2021):

	```
	git clone https://github.com/timesler/facenet-pytorch
	```
- [PyPi](https://pypi.org/project/facenet-pytorch) (📥 14K / month · 📦 7 · ⏱️ 10.03.2021):
	```
...
- [GitHub](https://github.com/tensorflow/graphics) (👨‍💻 34 · 🔀 340 · 📋 220 - 59% open · ⏱️ 02.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-graphics) (📥 2.7K / month · 📦 4 · ⏱️ 03.12.2021):
	```
	pip install tensorflow-graphics
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/vissl">vissl</a></b> (🥉25 ·  ⭐ 2.4K) - VISSL is FAIRs library of extensible, modular and scalable components.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/vissl) (👨‍💻 30 · 🔀 230 · 📦 5 · 📋 130 - 33% open · ⏱️ 15.02.2022):
...
<details><summary><b><a href="https://github.com/facebookresearch/pytorchvideo">pytorchvideo</a></b> (🥉25 ·  ⭐ 2.3K) - A deep learning library for video understanding research. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/pytorchvideo) (👨‍💻 27 · 🔀 220 · 📋 130 - 41% open · ⏱️ 16.02.2022):
...
- [PyPi](https://pypi.org/project/mtcnn) (📥 27K / month · 📦 43 · ⏱️ 09.07.2021):
	...
	pip install mtcnn
	```
- [Conda](https://anaconda.org/conda-forge/mtcnn) (📥 4.3K · ⏱️ 17.08.2021):
	```
	conda install -c conda-forge mtcnn
	```
</details>
<details><summary><b><a href="https://github.com/obss/sahi">sahi</a></b> (🥉25 ·  ⭐ 660) - A lightweight vision library for performing large scale object detection/.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/obss/sahi) (👨‍💻 8 · 🔀 97 · 📦 19 · 📋 100 - 10% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/obss/sahi
	```
- [PyPi](https://pypi.org/project/sahi) (📥 12K / month · 📦 5 · ⏱️ 12.02.2022):
	```
	pip install sahi
	```
- [Conda](https://anaconda.org/conda-forge/sahi) (📥 1.4K · ⏱️ 12.02.2022):
	```
	conda install -c conda-forge sahi
	```
</details>
<details><summary><b><a href="https://github.com/airctic/icevision">icevision</a></b> (🥉25 ·  ⭐ 600) - An Agnostic Computer Vision Framework - Pluggable to any Training.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/airctic/icevision) (👨‍💻 36 · 🔀 86 · 📋 620 - 21% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/airctic/icevision
	```
- [PyPi](https://pypi.org/project/icevision) (📥 2.5K / month · 📦 5 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/lucidrains/deep-daze) (👨‍💻 13 · 🔀 290 · 📦 33 · 📋 160 - 54% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/deep-daze) (📥 11K / month · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/idealo/image-super-resolution) (👨‍💻 10 · 🔀 600 · 📦 72 · 📋 190 - 43% open · ⏱️ 02.06.2021):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 12 · 🔀 37 · 📦 270 · 📋 270 - 38% open · ⏱️ 15.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 18K / month · 📦 28 · ⏱️ 20.11.2021):
	```
	pip install pyvips
	```
...
- [GitHub](https://github.com/facebookresearch/ClassyVision) (👨‍💻 67 · 🔀 240 · 📋 110 - 46% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/classy_vision) (📥 1.2K / month · 📦 2 · ⏱️ 09.07.2021):
	```
...
<details><summary><b><a href="https://github.com/tryolabs/norfair">Norfair</a></b> (🥉22 ·  ⭐ 1.3K · 📈) - Lightweight Python library for adding real-time object tracking to.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 10 · 🔀 110 · 📥 8 · 📋 45 - 28% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/tryolabs/norfair
	```
- [PyPi](https://pypi.org/project/norfair) (📥 3.5K / month · 📦 1 · ⏱️ 15.02.2022):
	```
	pip install norfair
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/SlowFast) (👨‍💻 25 · 🔀 870 · 📦 6 · 📋 490 - 50% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/facebookresearch/SlowFast
	```
- [PyPi](https://pypi.org/project/pyslowfast) (📥 12 / month · ⏱️ 15.01.2020):
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/detr">DE⫶TR</a></b> (🥉18 ·  ⭐ 8.4K) - End-to-End Object Detection with Transformers. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/detr) (👨‍💻 24 · 🔀 1.4K · 📋 410 - 34% open · ⏱️ 18.10.2021):
...
- [GitHub](https://github.com/jasmcaus/caer) (👨‍💻 8 · 🔀 100 · 📥 19 · 📋 15 - 13% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/caer) (📥 3.8K / month · 📦 1 · ⏱️ 13.10.2021):
	```
	pip install caer
	```
</details>
<details><summary><b><a href="https://github.com/google-research/scenic">scenic</a></b> (🥉17 ·  ⭐ 730) - Scenic: A Jax Library for Computer Vision Research and Beyond. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google-research/scenic) (👨‍💻 24 · 🔀 74 · 📦 9 · 📋 19 - 21% open · ⏱️ 17.02.2022):
...
- <b><a href="https://github.com/glfw/glfw">glfw</a></b> (🥈35 ·  ⭐ 8.7K) - A multi-platform library for OpenGL, OpenGL ES, Vulkan, window and input. <code><a href="https://tldrlegal.com/search?q=Zlib">❗️Zlib</a></code>
...
- <b><a href="https://github.com/nicolas-chaulet/torch-points3d">Torch Points 3D</a></b> (🥉15 ·  ⭐ 14 · 🐣) - Pytorch framework for doing deep learning on point.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/networkx/networkx) (👨‍💻 570 · 🔀 2.5K · 📥 57 · 📦 98K · 📋 2.8K - 11% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/pyg-team/pytorch_geometric) (👨‍💻 240 · 🔀 2.4K · 📋 2.4K - 37% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/pyg-team/pytorch_geometric
	```
- [PyPi](https://pypi.org/project/torch-geometric) (📥 46K / month · 📦 33 · ⏱️ 22.12.2021):
	```
...
- [GitHub](https://github.com/dmlc/dgl) (👨‍💻 190 · 🔀 2K · 📋 1.4K - 24% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/dmlc/dgl
	```
- [PyPi](https://pypi.org/project/dgl) (📥 67K / month · 📦 39 · ⏱️ 27.05.2021):
	```
	pip install dgl
	```
</details>
...
- [GitHub](https://github.com/stellargraph/stellargraph) (👨‍💻 36 · 🔀 340 · 📦 120 · 📋 990 - 25% open · ⏱️ 29.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/stellargraph) (📥 23K / month · 📦 3 · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 19 · 🔀 260 · 📦 230 · 📋 190 - 1% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/snap-stanford/ogb
	```
- [PyPi](https://pypi.org/project/ogb) (📥 32K / month · 📦 13 · ⏱️ 29.09.2021):
	```
	pip install ogb
	```
- [Conda](https://anaconda.org/conda-forge/ogb) (📥 6.6K · ⏱️ 29.09.2021):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PGL) (👨‍💻 21 · 🔀 200 · 📦 24 · 📋 100 - 36% open · ⏱️ 29.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pgl) (📥 800 / month · 📦 2 · ⏱️ 20.12.2021):
	```
	pip install pgl
	```
</details>
...
- [GitHub](https://github.com/graphistry/pygraphistry) (👨‍💻 19 · 🔀 150 · 📦 58 · 📋 190 - 40% open · ⏱️ 22.12.2021):

	```
	git clone https://github.com/graphistry/pygraphistry
	```
- [PyPi](https://pypi.org/project/graphistry) (📥 2.1K / month · 📦 4 · ⏱️ 07.12.2021):
	```
...
- [GitHub](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) (👨‍💻 19 · 🔀 200 · 📋 81 - 1% open · ⏱️ 10.02.2022):

	```
	git clone https://github.com/benedekrozemberczki/pytorch_geometric_temporal
	```
- [PyPi](https://pypi.org/project/torch-geometric-temporal) (📥 1.7K / month · 📦 1 · ⏱️ 10.02.2022):
	```
	pip install torch-geometric-temporal
	```
</details>
<details><summary><b><a href="https://github.com/pykeen/pykeen">PyKEEN</a></b> (🥈25 ·  ⭐ 710) - A Python library for learning and evaluating knowledge graph embeddings. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pykeen/pykeen) (👨‍💻 24 · 🔀 100 · 📥 92 · 📋 350 - 32% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/pykeen/pykeen
	```
- [PyPi](https://pypi.org/project/pykeen) (📥 720 / month · 📦 3 · ⏱️ 11.01.2022):
	```
	pip install pykeen
	```
</details>
<details><summary><b><a href="https://github.com/danielegrattarola/spektral">Spektral</a></b> (🥈24 ·  ⭐ 2K) - Graph Neural Networks with Keras and Tensorflow 2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/danielegrattarola/spektral) (👨‍💻 19 · 🔀 270 · 📦 100 · 📋 210 - 18% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/danielegrattarola/spektral
	```
- [PyPi](https://pypi.org/project/spektral) (📥 4.2K / month · 📦 2 · ⏱️ 23.08.2021):
	```
...
- [GitHub](https://github.com/graph4ai/graph4nlp) (👨‍💻 23 · 🔀 140 · 📋 110 - 10% open · ⏱️ 20.01.2022):

	```
	git clone https://github.com/graph4ai/graph4nlp
	```
- [PyPi](https://pypi.org/project/graph4nlp) (📥 160 / month · ⏱️ 20.01.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/PyTorch-BigGraph) (👨‍💻 25 · 🔀 400 · 📥 120 · 📋 180 - 31% open · ⏱️ 07.02.2022):
...
- [GitHub](https://github.com/Accenture/AmpliGraph) (👨‍💻 19 · 🔀 200 · 📦 17 · 📋 200 - 9% open · ⏱️ 25.05.2021):

	```
	git clone https://github.com/Accenture/AmpliGraph
	```
- [PyPi](https://pypi.org/project/ampligraph) (📥 800 / month · ⏱️ 25.05.2021):
	```
...
<details><summary><b><a href="https://github.com/deepmind/jraph">jraph</a></b> (🥉19 ·  ⭐ 840) - A Graph Neural Network Library in Jax. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepmind/jraph) (👨‍💻 13 · 🔀 46 · 📦 12 · 📋 18 - 50% open · ⏱️ 07.02.2022):

	```
	git clone https://github.com/deepmind/jraph
	```
- [PyPi](https://pypi.org/project/jraph) (📥 1.3K / month · 📦 2 · ⏱️ 19.11.2021):
	```
	pip install jraph
	```
- [Conda](https://anaconda.org/conda-forge/jraph) (📥 290 · ⏱️ 31.10.2021):
	```
	conda install -c conda-forge jraph
	```
</details>
<details><summary><b><a href="https://github.com/THUMNLab/AutoGL">AutoGL</a></b> (🥉18 ·  ⭐ 770) - An autoML framework & toolkit for machine learning on graphs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/vaticle/kglib) (👨‍💻 7 · 🔀 86 · 📥 210 · 📋 61 - 19% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/grakn-kglib) (📥 79 / month · ⏱️ 19.08.2020):
	```
...
<details><summary><b><a href="https://github.com/microsoft/ptgnn">ptgnn</a></b> (🥉15 ·  ⭐ 300) - A PyTorch Graph Neural Network Library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/microsoft/ptgnn) (👨‍💻 7 · 🔀 36 · 📦 1 · 📋 7 - 28% open · ⏱️ 01.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ptgnn) (📥 94 / month · ⏱️ 21.10.2021):
	```
	pip install ptgnn
	```
</details>
<details><summary><b><a href="https://github.com/snap-stanford/GraphGym">GraphGym</a></b> (🥉14 ·  ⭐ 900) - Platform for designing and evaluating Graph Neural Networks (GNN). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/snap-stanford/GraphGym) (👨‍💻 5 · 🔀 100 · 📥 8 · 📦 2 · 📋 25 - 12% open · ⏱️ 11.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/graphgym) (📥 72 / month · ⏱️ 29.06.2021):
	```
...
- <b><a href="https://github.com/IBCNServices/pyRDF2Vec">pyRDF2Vec</a></b> (🥉17 ·  ⭐ 140) - Python Implementation and Extension of RDF2Vec. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/espnet/espnet) (👨‍💻 240 · 🔀 1.5K · 📥 74 · 📦 34 · 📋 1.7K - 18% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/espnet/espnet
	```
- [PyPi](https://pypi.org/project/espnet) (📥 5.2K / month · 📦 1 · ⏱️ 08.02.2022):
	```
	pip install espnet
	```
</details>
<details><summary><b><a href="https://github.com/mozilla/DeepSpeech">DeepSpeech</a></b> (🥇34 ·  ⭐ 19K · 📈) - DeepSpeech is an open source embedded (offline, on-.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/mozilla/DeepSpeech) (👨‍💻 160 · 🔀 3.3K · 📥 800K · 📦 670 · 📋 2.1K - 5% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/mozilla/DeepSpeech
	```
- [PyPi](https://pypi.org/project/deepspeech) (📥 8.5K / month · 📦 35 · ⏱️ 19.12.2020):
	```
	pip install deepspeech
	```
- [Conda](https://anaconda.org/conda-forge/deepspeech) (📥 350 · ⏱️ 29.07.2021):
	```
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 93 · 🔀 790 · 📋 940 - 3% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 570K / month · 📦 1.2K · ⏱️ 15.02.2022):
	```
	pip install librosa
	```
- [Conda](https://anaconda.org/conda-forge/librosa) (📥 430K · ⏱️ 15.02.2022):
	```
...
- [GitHub](https://github.com/pytorch/audio) (👨‍💻 150 · 🔀 380 · 📋 600 - 25% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.5K · 📦 340 · 📋 890 - 36% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/magenta/magenta
	```
- [PyPi](https://pypi.org/project/magenta) (📥 5.9K / month · 📦 36 · ⏱️ 12.11.2020):
	```
	pip install magenta
	```
</details>
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 90 · 🔀 780 · 📦 11K · 📋 460 - 44% open · ⏱️ 08.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pydub) (📥 2.1M / month · 📦 900 · ⏱️ 10.03.2021):
	```
	pip install pydub
	```
...
- [GitHub](https://github.com/speechbrain/speechbrain) (👨‍💻 150 · 🔀 680 · 📦 120 · 📋 590 - 19% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/speechbrain/speechbrain
	```
- [PyPi](https://pypi.org/project/speechbrain) (📥 7.1K / month · 📦 2 · ⏱️ 20.12.2021):
	```
...
<details><summary><b><a href="https://github.com/deezer/spleeter">spleeter</a></b> (🥈29 ·  ⭐ 19K) - Deezer source separation library including pretrained models. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deezer/spleeter) (👨‍💻 19 · 🔀 2K · 📥 1.4M · 📋 640 - 18% open · ⏱️ 11.02.2022):
...
<details><summary><b><a href="https://github.com/coqui-ai/TTS">Coqui TTS</a></b> (🥈29 ·  ⭐ 4K) - - a deep learning toolkit for Text-to-Speech, battle-.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/coqui-ai/TTS) (👨‍💻 82 · 🔀 360 · 📥 74K · 📋 230 - 13% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 21 · 🔀 89 · 📦 7.4K · 📋 77 - 40% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/beetbox/audioread
	```
- [PyPi](https://pypi.org/project/audioread) (📥 530K / month · 📦 320 · ⏱️ 20.10.2020):
	```
...
<details><summary><b><a href="https://github.com/CPJKU/madmom">Madmom</a></b> (🥉27 ·  ⭐ 870) - Python audio and music signal processing library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/CPJKU/madmom) (👨‍💻 20 · 🔀 150 · 📦 180 · 📋 260 - 21% open · ⏱️ 06.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/madmom) (📥 7.3K / month · 📦 27 · ⏱️ 14.11.2018):
	```
	pip install madmom
	```
</details>
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 21 · 🔀 87 · 📦 480 · 📋 88 - 13% open · ⏱️ 17.12.2021):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 30K / month · 📦 67 · ⏱️ 14.12.2021):
	```
	pip install tinytag
	```
</details>
...
- [GitHub](https://github.com/magenta/ddsp) (👨‍💻 29 · 🔀 220 · 📦 19 · 📋 130 - 15% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/magenta/ddsp
	```
- [PyPi](https://pypi.org/project/ddsp) (📥 2.4K / month · 📦 1 · ⏱️ 15.02.2022):
	```
	pip install ddsp
	```
...
<details><summary><b><a href="https://github.com/iver56/audiomentations">audiomentations</a></b> (🥉25 ·  ⭐ 870) - A Python library for audio data augmentation. Inspired by.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/iver56/audiomentations) (👨‍💻 21 · 🔀 110 · 📦 110 · 📋 99 - 27% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/iver56/audiomentations
	```
- [PyPi](https://pypi.org/project/audiomentations) (📥 3K / month · ⏱️ 10.02.2022):
	```
	pip install audiomentations
	```
</details>
<details><summary><b><a href="https://github.com/bastibe/python-soundfile">python-soundfile</a></b> (🥉24 ·  ⭐ 440) - SoundFile is an audio library based on libsndfile, CFFI, and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/bastibe/python-soundfile) (👨‍💻 23 · 🔀 61 · 📥 2.9K · 📋 160 - 38% open · ⏱️ 28.01.2022):

	```
	git clone https://github.com/bastibe/python-soundfile
	```
- [PyPi](https://pypi.org/project/soundfile) (📥 940K / month · 📦 540 · ⏱️ 27.11.2019):
	```
...
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉23 ·  ⭐ 800) - kapre: Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/KinWaiCheuk/nnAudio">nnAudio</a></b> (🥉21 ·  ⭐ 660) - Audio processing by using pytorch 1D convolution network. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/KinWaiCheuk/nnAudio) (👨‍💻 13 · 🔀 63 · 📦 41 · 📋 49 - 24% open · ⏱️ 24.12.2021):

	```
	git clone https://github.com/KinWaiCheuk/nnAudio
	```
- [PyPi](https://pypi.org/project/nnAudio) (📥 1.6K / month · 📦 1 · ⏱️ 24.12.2021):
	```
	pip install nnAudio
	```
</details>
...
<details><summary><b><a href="https://github.com/visgl/deck.gl">pydeck</a></b> (🥇42 ·  ⭐ 9.5K) - WebGL2 powered visualization framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 190 · 🔀 1.7K · 📦 3.6K · 📋 2.4K - 5% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/visgl/deck.gl
	```
- [PyPi](https://pypi.org/project/pydeck) (📥 790K / month · 📦 16 · ⏱️ 25.10.2021):
	```
	pip install pydeck
	```
- [Conda](https://anaconda.org/conda-forge/pydeck) (📥 69K · ⏱️ 26.10.2021):
	```
	conda install -c conda-forge pydeck
	```
- [npm](https://www.npmjs.com/package/deck.gl) (📥 300K / month · 📦 380 · ⏱️ 10.02.2022):
	```
	npm install deck.gl
	```
</details>
...
- [GitHub](https://github.com/shapely/shapely) (👨‍💻 130 · 🔀 440 · 📦 26K · 📋 840 - 17% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/shapely/shapely
	```
- [PyPi](https://pypi.org/project/shapely) (📥 6.6M / month · 📦 3.7K · ⏱️ 16.02.2022):
	```
	pip install shapely
	```
...
- [GitHub](https://github.com/python-visualization/folium) (👨‍💻 130 · 🔀 2K · 📦 14K · 📋 920 - 22% open · ⏱️ 08.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/folium) (📥 730K / month · 📦 630 · ⏱️ 19.11.2021):
	```
	pip install folium
	```
- [Conda](https://anaconda.org/conda-forge/folium) (📥 560K · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/geopandas/geopandas) (👨‍💻 160 · 🔀 670 · 📥 1.4K · 📦 12K · 📋 1.3K - 32% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/rasterio/rasterio) (👨‍💻 120 · 🔀 460 · 📥 740 · 📦 4.4K · 📋 1.5K - 10% open · ⏱️ 04.02.2022):
...
- [GitHub](https://github.com/pyproj4/pyproj) (👨‍💻 46 · 🔀 170 · 📦 13K · 📋 470 - 2% open · ⏱️ 13.02.2022):
...
- [GitHub](https://github.com/Toblerity/Fiona) (👨‍💻 66 · 🔀 180 · 📦 7.8K · 📋 660 - 11% open · ⏱️ 13.02.2022):
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 120 · 🔀 560 · 📦 34K · 📋 250 - 9% open · ⏱️ 26.09.2021):
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 74 · 🔀 320 · 📦 1.5K · 📋 470 - 38% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 60K / month · 📦 100 · ⏱️ 06.12.2021):
	```
...
- [GitHub](https://github.com/Esri/arcgis-python-api) (👨‍💻 77 · 🔀 870 · 📥 1.9K · 📋 430 - 28% open · ⏱️ 01.02.2022):
...
- [PyPi](https://pypi.org/project/arcgis) (📥 48K / month · 📦 22 · ⏱️ 03.02.2022):
	...
	pip install arcgis
	```
- [Docker Hub](https://hub.docker.com/r/esridocker/arcgis-api-python-notebook) (📥 6K · ⭐ 33 · ⏱️ 04.02.2022):
	```
...
- [GitHub](https://github.com/pysal/pysal) (👨‍💻 75 · 🔀 270 · 📋 610 - 1% open · ⏱️ 30.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pysal) (📥 15K / month · 📦 30 · ⏱️ 30.01.2022):
	```
	pip install pysal
	```
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 46 · 🔀 90 · 📦 8.6K · 📋 80 - 27% open · ⏱️ 03.01.2022):

	```
	git clone https://github.com/jazzband/geojson
	```
- [PyPi](https://pypi.org/project/geojson) (📥 770K / month · 📦 1.1K · ⏱️ 09.08.2019):
	```
	pip install geojson
	```
- [Conda](https://anaconda.org/conda-forge/geojson) (📥 480K · ⏱️ 11.08.2019):
	```
...
- [GitHub](https://github.com/holoviz/geoviews) (👨‍💻 26 · 🔀 69 · 📋 300 - 35% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/holoviz/geoviews
	```
- [PyPi](https://pypi.org/project/geoviews) (📥 12K / month · 📦 25 · ⏱️ 25.12.2021):
	```
	pip install geoviews
	```
- [Conda](https://anaconda.org/conda-forge/geoviews) (📥 94K · ⏱️ 13.01.2022):
	```
...
- <b><a href="https://github.com/sentinelsat/sentinelsat">Sentinelsat</a></b> (🥉29 ·  ⭐ 720) - Search and download Copernicus Sentinel satellite images. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
<details><summary><b><a href="https://github.com/ranaroussi/yfinance">yfinance</a></b> (🥇35 ·  ⭐ 6.7K) - Download market data from Yahoo! Finances API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ranaroussi/yfinance) (👨‍💻 53 · 🔀 1.5K · 📦 9.6K · 📋 740 - 55% open · ⏱️ 30.01.2022):

	```
	git clone https://github.com/ranaroussi/yfinance
	```
- [PyPi](https://pypi.org/project/yfinance) (📥 300K / month · 📦 120 · ⏱️ 30.01.2022):
	```
	pip install yfinance
	```
- [Conda](https://anaconda.org/ranaroussi/yfinance) (📥 30K · ⏱️ 10.07.2021):
	```
...
- [GitHub](https://github.com/microsoft/qlib) (👨‍💻 81 · 🔀 1.4K · 📥 270 · 📦 12 · 📋 470 - 32% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/microsoft/qlib
	```
- [PyPi](https://pypi.org/project/pyqlib) (📥 3.3K / month · ⏱️ 19.01.2022):
	```
	pip install pyqlib
	```
</details>
...
- [GitHub](https://github.com/bukosabino/ta) (👨‍💻 26 · 🔀 660 · 📦 990 · 📋 200 - 53% open · ⏱️ 27.01.2022):

	```
	git clone https://github.com/bukosabino/ta
	```
- [PyPi](https://pypi.org/project/ta) (📥 86K / month · 📦 27 · ⏱️ 09.01.2022):
	```
	pip install ta
	```
- [Conda](https://anaconda.org/conda-forge/ta) (📥 2.3K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/erdewit/ib_insync) (👨‍💻 29 · 🔀 470 · 📋 380 - 1% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/erdewit/ib_insync
	```
- [PyPi](https://pypi.org/project/ib_insync) (📥 9.4K / month · 📦 19 · ⏱️ 28.11.2021):
	```
...
<details><summary><b><a href="https://github.com/tensortrade-org/tensortrade">TensorTrade</a></b> (🥈28 ·  ⭐ 3.7K) - An open source reinforcement learning framework for training,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/tensortrade-org/tensortrade) (👨‍💻 61 · 🔀 850 · 📦 30 · 📋 210 - 11% open · ⏱️ 15.02.2022):
...
- [PyPi](https://pypi.org/project/alpha_vantage) (📥 22K / month · 📦 100 · ⏱️ 26.08.2018):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alpha_vantage) (📥 920 · ⏱️ 14.01.2021):
	```
...
- [GitHub](https://github.com/pmorissette/bt) (👨‍💻 25 · 🔀 300 · 📦 94 · 📋 280 - 18% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/pmorissette/bt
	```
- [PyPi](https://pypi.org/project/bt) (📥 5.5K / month · 📦 21 · ⏱️ 21.04.2021):
	```
	pip install bt
	```
- [Conda](https://anaconda.org/conda-forge/bt) (📥 3K · ⏱️ 18.01.2022):
	```
...
- [GitHub](https://github.com/pmorissette/ffn) (👨‍💻 26 · 🔀 200 · 📦 170 · 📋 96 - 16% open · ⏱️ 09.02.2022):
...
- [PyPi](https://pypi.org/project/ffn) (📥 28K / month · 📦 25 · ⏱️ 21.04.2021):
	...
	pip install ffn
	```
- [Conda](https://anaconda.org/conda-forge/ffn) (📥 660 · ⏱️ 22.04.2021):
	```
...
- [GitHub](https://github.com/jealous/stockstats) (👨‍💻 8 · 🔀 250 · 📦 400 · 📋 79 - 3% open · ⏱️ 07.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/stockstats) (📥 8.7K / month · 📦 29 · ⏱️ 07.01.2022):
	```
...
- [GitHub](https://github.com/scrtlabs/catalyst) (👨‍💻 150 · 🔀 680 · 📦 23 · 📋 490 - 27% open · ⏱️ 22.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/enigma-catalyst) (📥 480 / month · 📦 2 · ⏱️ 11.11.2018):
	```
...
- [GitHub](https://github.com/CryptoSignal/Crypto-Signal) (👨‍💻 28 · 🔀 1K · 📋 250 - 21% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 36 · 🔀 400 · 📋 38 - 50% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/tf-quant-finance) (📥 1.1K / month · 📦 2 · ⏱️ 07.01.2022):
	```
...
- <b><a href="https://github.com/kernc/backtesting.py">Backtesting.py</a></b> (🥉20 ·  ⭐ 2.2K) - Backtest trading strategies in Python. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
- <b><a href="https://github.com/fmilthaler/FinQuant">FinQuant</a></b> (🥉18 ·  ⭐ 730 · 💀) - A program for financial portfolio management, analysis and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/alan-turing-institute/sktime">sktime</a></b> (🥇33 ·  ⭐ 5K) - A unified framework for machine learning with time series. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/alan-turing-institute/sktime) (👨‍💻 140 · 🔀 740 · 📥 64 · 📦 350 · 📋 920 - 33% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/facebook/prophet) (👨‍💻 140 · 🔀 4K · 📥 640 · 📋 1.8K - 10% open · ⏱️ 12.02.2022):
...
- [PyPi](https://pypi.org/project/fbprophet) (📥 1.3M / month · 📦 120 · ⏱️ 05.09.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prophet) (📥 29K · ⏱️ 23.08.2021):
	```
...
- [GitHub](https://github.com/blue-yonder/tsfresh) (👨‍💻 82 · 🔀 960 · 📋 480 - 8% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/tsfresh) (📥 410K / month · 📦 55 · ⏱️ 21.12.2021):
	```
	pip install tsfresh
	```
- [Conda](https://anaconda.org/conda-forge/tsfresh) (📥 100K · ⏱️ 21.12.2021):
	```
...
- [GitHub](https://github.com/alkaline-ml/pmdarima) (👨‍💻 19 · 🔀 200 · 📦 1.8K · 📋 270 - 8% open · ⏱️ 04.01.2022):
...
- [PyPi](https://pypi.org/project/pmdarima) (📥 1M / month · 📦 44 · ⏱️ 05.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pmdarima) (📥 30K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/tslearn-team/tslearn) (👨‍💻 36 · 🔀 260 · 📦 410 · 📋 250 - 29% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/tslearn-team/tslearn
	```
- [PyPi](https://pypi.org/project/tslearn) (📥 99K / month · 📦 19 · ⏱️ 16.08.2021):
	```
	pip install tslearn
	```
...
- [GitHub](https://github.com/TDAmeritrade/stumpy) (👨‍💻 28 · 🔀 210 · 📋 300 - 10% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/TDAmeritrade/stumpy
	```
- [PyPi](https://pypi.org/project/stumpy) (📥 310K / month · 📦 4 · ⏱️ 24.12.2021):
	```
	pip install stumpy
	```
...
- [GitHub](https://github.com/jdb78/pytorch-forecasting) (👨‍💻 28 · 🔀 260 · 📋 400 - 40% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/jdb78/pytorch-forecasting
	```
- [PyPi](https://pypi.org/project/pytorch-forecasting) (📥 26K / month · 📦 4 · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/unit8co/darts) (👨‍💻 46 · 🔀 350 · 📦 30 · 📋 350 - 35% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/unit8co/darts
	```
- [PyPi](https://pypi.org/project/u8darts) (📥 5.6K / month · 📦 2 · ⏱️ 17.02.2022):
	```
	pip install u8darts
	```
- [Conda](https://anaconda.org/conda-forge/u8darts-all) (📥 2.1K · ⏱️ 16.02.2022):
	```
	conda install -c conda-forge u8darts-all
	```
- [Docker Hub](https://hub.docker.com/r/unit8/darts) (📥 260 · ⏱️ 17.02.2022):
	```
...
- [GitHub](https://github.com/awslabs/gluon-ts) (👨‍💻 84 · 🔀 500 · 📋 700 - 38% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/awslabs/gluon-ts
	```
- [PyPi](https://pypi.org/project/gluonts) (📥 80K / month · 📦 3 · ⏱️ 11.11.2021):
	```
	pip install gluonts
	```
- [Conda](https://anaconda.org/anaconda/gluonts) (📥 3 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/johannfaouzi/pyts) (👨‍💻 10 · 🔀 120 · 📦 170 · 📋 59 - 57% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/johannfaouzi/pyts
	```
- [PyPi](https://pypi.org/project/pyts) (📥 100K / month · 📦 11 · ⏱️ 31.10.2021):
	```
	pip install pyts
	```
...
- [GitHub](https://github.com/linkedin/greykite) (👨‍💻 7 · 🔀 64 · 📦 8 · 📋 59 - 13% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/linkedin/greykite
	```
- [PyPi](https://pypi.org/project/greykite) (📥 21K / month · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/dmbee/seglearn) (👨‍💻 13 · 🔀 53 · 📦 11 · 📋 28 - 17% open · ⏱️ 12.03.2021):

	```
	git clone https://github.com/dmbee/seglearn
	```
- [PyPi](https://pypi.org/project/seglearn) (📥 1.2K / month · 📦 1 · ⏱️ 13.03.2021):
	```
	pip install seglearn
	```
</details>
<details><summary><b><a href="https://github.com/AutoViML/Auto_TS">Auto TS</a></b> (🥉20 ·  ⭐ 400) - Automatically build ARIMA, SARIMAX, VAR, FB Prophet and XGBoost.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/AutoViML/Auto_TS) (👨‍💻 6 · 🔀 71 · 📋 64 - 10% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/AutoViML/Auto_TS
	```
- [PyPi](https://pypi.org/project/auto-ts) (📥 2.4K / month · ⏱️ 31.01.2022):
	```
	pip install auto-ts
	```
</details>
...
- [GitHub](https://github.com/fraunhoferportugal/tsfel) (👨‍💻 13 · 🔀 56 · 📦 26 · 📋 48 - 10% open · ⏱️ 23.12.2021):
...
- [GitHub](https://github.com/firmai/atspy) (👨‍💻 5 · 🔀 80 · 📦 5 · 📋 20 - 90% open · ⏱️ 18.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/atspy) (📥 930 / month · ⏱️ 24.04.2020):
	```
	pip install atspy
	```
</details>
...
- <b><a href="https://github.com/X-DataInitiative/tick">tick</a></b> (🥉22 ·  ⭐ 370 · 💀) - Module for statistical learning, with a particular emphasis on time-.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/arundo/adtk">ADTK</a></b> (🥉19 ·  ⭐ 780 · 💀) - A Python toolkit for rule-based/unsupervised anomaly detection in time.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code>
...
- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 280 · 🔀 970 · 📦 1.4K · 📋 3.9K - 8% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/mne-tools/mne-python
	```
- [PyPi](https://pypi.org/project/mne) (📥 33K / month · 📦 190 · ⏱️ 01.12.2021):
	```
	pip install mne
	```
- [Conda](https://anaconda.org/conda-forge/mne) (📥 180K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/nilearn/nilearn) (👨‍💻 180 · 🔀 440 · 📥 21 · 📦 1.4K · 📋 1.6K - 17% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/nilearn/nilearn
	```
- [PyPi](https://pypi.org/project/nilearn) (📥 18K / month · 📦 230 · ⏱️ 28.01.2022):
	```
	pip install nilearn
	```
...
<details><summary><b><a href="https://github.com/Project-MONAI/MONAI">MONAI</a></b> (🥈34 ·  ⭐ 2.7K) - AI Toolkit for Healthcare Imaging. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 86 · 🔀 530 · 📦 210 · 📋 1.5K - 10% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/Project-MONAI/MONAI
	```
- [PyPi](https://pypi.org/project/monai) (📥 47K / month · 📦 13 · ⏱️ 16.02.2022):
	```
	pip install monai
	```
- [Conda](https://anaconda.org/conda-forge/monai) (📥 100 · ⏱️ 09.01.2022):
	```
...
- [GitHub](https://github.com/hail-is/hail) (👨‍💻 77 · 🔀 200 · 📦 48 · 📋 2K - 2% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/hail-is/hail
	```
- [PyPi](https://pypi.org/project/hail) (📥 170K / month · 📦 7 · ⏱️ 15.02.2022):
	```
	pip install hail
	```
</details>
...
- [GitHub](https://github.com/nipy/nipype) (👨‍💻 230 · 🔀 480 · 📦 850 · 📋 1.3K - 28% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/nipy/nipype
	```
- [PyPi](https://pypi.org/project/nipype) (📥 42K / month · 📦 150 · ⏱️ 20.10.2021):
	```
	pip install nipype
	```
...
- [GitHub](https://github.com/nipy/nibabel) (👨‍💻 93 · 🔀 230 · 📦 6.3K · 📋 450 - 30% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/nipy/nibabel
	```
- [PyPi](https://pypi.org/project/nibabel) (📥 210K / month · 📦 970 · ⏱️ 07.02.2022):
	```
	pip install nibabel
	```
...
- [GitHub](https://github.com/CamDavidsonPilon/lifelines) (👨‍💻 99 · 🔀 460 · 📦 770 · 📋 850 - 26% open · ⏱️ 19.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/lifelines) (📥 370K / month · 📦 100 · ⏱️ 30.11.2021):
	```
...
<details><summary><b><a href="https://github.com/dipy/dipy">DIPY</a></b> (🥈31 ·  ⭐ 490) - DIPY is the paragon 3D/4D+ imaging library in Python. Contains generic.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dipy/dipy) (👨‍💻 130 · 🔀 330 · 📦 500 · 📋 770 - 16% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/dipy/dipy
	```
- [PyPi](https://pypi.org/project/dipy) (📥 10K / month · 📦 80 · ⏱️ 06.05.2021):
	```
	pip install dipy
	```
...
- [GitHub](https://github.com/google/deepvariant) (👨‍💻 21 · 🔀 580 · 📥 3.8K · 📋 470 - 0% open · ⏱️ 28.01.2022):

	```
	git clone https://github.com/google/deepvariant
	```
- [Conda](https://anaconda.org/bioconda/deepvariant) (📥 38K · ⏱️ 16.12.2021):
	```
...
- [GitHub](https://github.com/nipy/nipy) (👨‍💻 63 · 🔀 130 · 📋 160 - 28% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/nipy) (📥 2.7K / month · 📦 47 · ⏱️ 19.02.2018):
	```
	pip install nipy
	```
...
- [GitHub](https://github.com/perone/medicaltorch) (👨‍💻 8 · 🔀 110 · 📦 11 · 📋 23 - 60% open · ⏱️ 16.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/medicaltorch) (📥 140 / month · ⏱️ 24.11.2018):
	```
...
- <b><a href="https://github.com/brainiak/brainiak">Brainiak</a></b> (🥉20 ·  ⭐ 260 · 💤) - Brain Imaging Analysis Kit. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
<details><summary><b><a href="https://github.com/manujosephv/pytorch_tabular">pytorch_tabular</a></b> (🥇21 ·  ⭐ 540) - A standard framework for modelling Deep Learning Models.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/manujosephv/pytorch_tabular) (👨‍💻 8 · 🔀 53 · 📋 52 - 30% open · ⏱️ 05.02.2022):
...
- [GitHub](https://github.com/carefree0910/carefree-learn) (👨‍💻 1 · 🔀 30 · 📦 2 · ⏱️ 03.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/carefree-learn) (📥 170 / month · ⏱️ 29.10.2021):
	```
...
- [GitHub](https://github.com/firmai/deltapy) (👨‍💻 4 · 🔀 40 · 📦 2 · 📋 3 - 66% open · ⏱️ 18.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/deltapy) (📥 57 / month · ⏱️ 09.04.2020):
	```
	pip install deltapy
	```
</details>
...
- <b><a href="https://github.com/upgini/upgini">upgini</a></b> (🥉15 ·  ⭐ 23 · 🐣) - Automated feature discovery & enrichment library automatically find.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
</details>
<br>
...
- [GitHub](https://github.com/PaddlePaddle/PaddleOCR) (👨‍💻 88 · 🔀 3.9K · 📦 540 · 📋 4K - 25% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 91 · 🔀 1.8K · 📥 1.1M · 📦 890 · 📋 500 - 33% open · ⏱️ 14.01.2022):
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 40 · 🔀 570 · 📋 290 - 4% open · ⏱️ 02.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 500K / month · 📦 920 · ⏱️ 28.06.2021):
	```
...
- [GitHub](https://github.com/ocrmypdf/OCRmyPDF) (👨‍💻 61 · 🔀 540 · 📋 820 - 11% open · ⏱️ 08.02.2022):
...
- [PyPi](https://pypi.org/project/ocrmypdf) (📥 23K / month · 📦 12 · ⏱️ 26.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ocrmypdf) (📥 8.4K · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 26 · 🔀 210 · 📦 610 · 📋 240 - 32% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 53K / month · 📦 61 · ⏱️ 19.06.2021):
	```
...
- [GitHub](https://github.com/Calamari-OCR/calamari) (👨‍💻 19 · 🔀 190 · 📋 230 - 16% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/calamari_ocr) (📥 830 / month · 📦 2 · ⏱️ 13.11.2018):
	```
...
- [GitHub](https://github.com/faustomorales/keras-ocr) (👨‍💻 12 · 🔀 240 · 📥 230K · 📋 160 - 33% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/faustomorales/keras-ocr
	```
- [PyPi](https://pypi.org/project/keras-ocr) (📥 6.4K / month · 📦 2 · ⏱️ 24.11.2021):
	```
...
- [GitHub](https://github.com/pandas-dev/pandas) (👨‍💻 2.9K · 🔀 14K · 📥 140K · 📦 640K · 📋 22K - 15% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/pandas-dev/pandas
	```
- [PyPi](https://pypi.org/project/pandas) (📥 74M / month · 📦 58K · ⏱️ 22.01.2022):
	```
	pip install pandas
	```
- [Conda](https://anaconda.org/conda-forge/pandas) (📥 23M · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/numpy/numpy) (👨‍💻 1.4K · 🔀 6.5K · 📥 460K · 📦 970K · 📋 11K - 22% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/numpy/numpy
	```
- [PyPi](https://pypi.org/project/numpy) (📥 94M / month · 📦 120K · ⏱️ 04.02.2022):
	```
	pip install numpy
	```
- [Conda](https://anaconda.org/conda-forge/numpy) (📥 29M · ⏱️ 04.02.2022):
	```
...
- [GitHub](https://github.com/apache/arrow) (👨‍💻 800 · 🔀 2.2K · 📦 64 · 📋 910 - 23% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/apache/arrow
	```
- [PyPi](https://pypi.org/project/pyarrow) (📥 52M / month · 📦 1.4K · ⏱️ 03.02.2022):
	```
	pip install pyarrow
	```
- [Conda](https://anaconda.org/conda-forge/arrow) (📥 880K · ⏱️ 27.01.2022):
	```
	conda install -c conda-forge arrow
	```
</details>
<details><summary><b><a href="https://github.com/h5py/h5py">h5py</a></b> (🥇39 ·  ⭐ 1.7K · 📉) - HDF5 for Python -- The h5py package is a Pythonic interface to the HDF5.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/h5py/h5py) (👨‍💻 180 · 🔀 430 · 📥 1.7K · 📦 150K · 📋 1.3K - 17% open · ⏱️ 11.02.2022):
...
- [GitHub](https://github.com/pydata/xarray) (👨‍💻 360 · 🔀 760 · 📦 9.1K · 📋 3.2K - 29% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/PyTables/PyTables) (👨‍💻 100 · 🔀 220 · 📥 160 · 📋 680 - 26% open · ⏱️ 28.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/tables) (📥 840K / month · 📦 2.3K · ⏱️ 28.12.2021):
	```
	pip install tables
	```
...
- [GitHub](https://github.com/modin-project/modin) (👨‍💻 88 · 🔀 480 · 📥 200K · 📦 560 · 📋 2.5K - 33% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/modin-project/modin
	```
- [PyPi](https://pypi.org/project/modin) (📥 210K / month · 📦 22 · ⏱️ 10.02.2022):
	```
	pip install modin
	```
- [Conda](https://anaconda.org/conda-forge/modin-core) (📥 20K · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/pydata/numexpr) (👨‍💻 59 · 🔀 170 · 📋 320 - 18% open · ⏱️ 06.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/numexpr) (📥 2.2M / month · 📦 3K · ⏱️ 15.12.2021):
	```
	pip install numexpr
	```
...
<details><summary><b><a href="https://github.com/zarr-developers/zarr-python">zarr</a></b> (🥈32 ·  ⭐ 850) - An implementation of chunked, compressed, N-dimensional arrays for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/zarr-developers/zarr-python) (👨‍💻 55 · 🔀 140 · 📦 1K · 📋 490 - 42% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/zarr) (📥 88K / month · 📦 190 · ⏱️ 07.02.2022):
	```
	pip install zarr
	```
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 75 · 🔀 420 · 📋 280 - 2% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/msiemens/tinydb
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 300K / month · 📦 790 · ⏱️ 18.01.2022):
	```
	pip install tinydb
	```
...
<details><summary><b><a href="https://github.com/pola-rs/polars">polars</a></b> (🥈31 ·  ⭐ 4.6K) - Fast multi-threaded DataFrame library in Rust | Python | Node.js. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pola-rs/polars) (👨‍💻 69 · 🔀 250 · 📦 2 · 📋 1K - 8% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/pola-rs/polars
	```
- [PyPi](https://pypi.org/project/polars) (📥 33K / month · 📦 11 · ⏱️ 16.02.2022):
	```
	pip install polars
	```
</details>
...
- [GitHub](https://github.com/vaexio/vaex) (👨‍💻 63 · 🔀 530 · 📥 230 · 📋 1K - 36% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/vaexio/vaex
	```
- [PyPi](https://pypi.org/project/vaex) (📥 29K / month · 📦 16 · ⏱️ 07.02.2022):
	```
	pip install vaex
	```
...
- [GitHub](https://github.com/man-group/arctic) (👨‍💻 75 · 🔀 520 · 📥 180 · 📦 150 · 📋 540 - 17% open · ⏱️ 10.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/arctic) (📥 8.6K / month · 📦 34 · ⏱️ 24.01.2022):
	```
	pip install arctic
	```
...
- [GitHub](https://github.com/ekzhu/datasketch) (👨‍💻 21 · 🔀 230 · 📥 19 · 📦 350 · 📋 130 - 22% open · ⏱️ 04.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/datasketch) (📥 430K / month · 📦 54 · ⏱️ 04.02.2022):
	```
	pip install datasketch
	```
</details>
<details><summary><b><a href="https://github.com/pydata/bottleneck">Bottleneck</a></b> (🥉30 ·  ⭐ 710) - Fast NumPy array functions written in C. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pydata/bottleneck) (👨‍💻 22 · 🔀 77 · 📦 30K · 📋 220 - 17% open · ⏱️ 07.02.2022):
...
- [GitHub](https://github.com/h2oai/datatable) (👨‍💻 33 · 🔀 130 · 📥 1.2K · 📋 1.4K - 9% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/h2oai/datatable
	```
- [PyPi](https://pypi.org/project/datatable) (📥 83K / month · 📦 12 · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/jmcarpenter2/swifter) (👨‍💻 15 · 🔀 87 · 📦 490 · 📋 110 - 20% open · ⏱️ 07.02.2022):

	```
	git clone https://github.com/jmcarpenter2/swifter
	```
- [PyPi](https://pypi.org/project/swifter) (📥 150K / month · 📦 28 · ⏱️ 07.02.2022):
	```
	pip install swifter
	```
...
<details><summary><b><a href="https://github.com/pandera-dev/pandera">pandera</a></b> (🥉27 ·  ⭐ 1.1K) - A light-weight, flexible, and expressive data validation library for.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pandera-dev/pandera) (👨‍💻 48 · 🔀 83 · 📦 160 · 📋 360 - 22% open · ⏱️ 08.02.2022):

	```
	git clone https://github.com/pandera-dev/pandera
	```
- [PyPi](https://pypi.org/project/pandera) (📥 170K / month · 📦 18 · ⏱️ 09.02.2022):
	```
	pip install pandera
	```
- [Conda](https://anaconda.org/conda-forge/pandera-core) (📥 5.9K · ⏱️ 15.02.2022):
	```
...
- [GitHub](https://github.com/nalepae/pandarallel) (👨‍💻 19 · 🔀 130 · 📦 400 · 📋 150 - 54% open · ⏱️ 06.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pandarallel) (📥 230K / month · 📦 19 · ⏱️ 06.02.2022):
	```
	pip install pandarallel
	```
- [Conda](https://anaconda.org/conda-forge/pandarallel) (📥 1.6K · ⏱️ 06.02.2022):
	```
	conda install -c conda-forge pandarallel
	```
</details>
<details><summary><b><a href="https://github.com/jina-ai/docarray">docarray</a></b> (🥉24 ·  ⭐ 530 · 🐣) - The data structure for unstructured data. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/jina-ai/docarray) (👨‍💻 15 · 🔀 34 · 📦 8 · 📋 32 - 37% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/jina-ai/docarray
	```
- [PyPi](https://pypi.org/project/docarray) (📥 73K / month · ⏱️ 16.02.2022):
	```
	pip install docarray
	```
- [Conda](https://anaconda.org/conda-forge/docarray) (📥 46 · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/polyaxon/datatile) (👨‍💻 8 · 🔀 37 · 📋 15 - 53% open · ⏱️ 12.02.2022):
...
- [GitHub](https://github.com/RaRe-Technologies/bounter) (👨‍💻 8 · 🔀 48 · 📦 25 · 📋 24 - 62% open · ⏱️ 24.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/bounter) (📥 120 / month · 📦 8 · ⏱️ 17.08.2020):
	```
	pip install bounter
	```
</details>
...
- [GitHub](https://github.com/firmai/pandapy) (👨‍💻 3 · 🔀 56 · 📦 1 · 📋 3 - 66% open · ⏱️ 20.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pandapy) (📥 69 / month · ⏱️ 25.01.2020):
	```
	pip install pandapy
	```
</details>
...
- [GitHub](https://github.com/celery/celery) (👨‍💻 1.2K · 🔀 4.2K · 📦 65K · 📋 4.7K - 11% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/celery/celery
	```
- [PyPi](https://pypi.org/project/celery) (📥 5.3M / month · 📦 15K · ⏱️ 29.12.2021):
	```
	pip install celery
	```
...
- [GitHub](https://github.com/apache/airflow) (👨‍💻 2.3K · 🔀 10K · 📥 250K · 📋 5.1K - 18% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/apache/airflow
	```
- [PyPi](https://pypi.org/project/apache-airflow) (📥 4.8M / month · 📦 450 · ⏱️ 21.12.2021):
	```
...
- [Conda](https://anaconda.org/conda-forge/airflow) (📥 540K · ⏱️ 22.12.2021):
	...
	```
- [Docker Hub](https://hub.docker.com/r/apache/airflow) (📥 64M · ⭐ 320 · ⏱️ 25.01.2022):
	```
	docker pull apache/airflow
	```
</details>
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇39 ·  ⭐ 8.1K · 📈) - Simple job queues for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 250 · 🔀 1.3K · 📦 9.6K · 📋 940 - 17% open · ⏱️ 13.02.2022):
...
- [GitHub](https://github.com/apache/beam) (👨‍💻 1.2K · 🔀 3.4K · ⏱️ 17.02.2022):

	```
	git clone https://github.com/apache/beam
	```
- [PyPi](https://pypi.org/project/apache-beam) (📥 4.9M / month · 📦 150 · ⏱️ 07.02.2022):
	```
	pip install apache-beam
	```
- [Conda](https://anaconda.org/conda-forge/apache-beam-with-aws) (📥 4K · ⏱️ 08.02.2022):
	```
...
- [PyPi](https://pypi.org/project/joblib) (📥 23M / month · 📦 4.9K · ⏱️ 07.10.2021):
	...
	pip install joblib
	```
- [Conda](https://anaconda.org/conda-forge/joblib) (📥 7.2M · ⏱️ 07.10.2021):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 300 · 🔀 810 · 📦 600 · 📋 2.1K - 20% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 170K / month · 📦 40 · ⏱️ 16.02.2022):
	```
	pip install prefect
	```
...
- [GitHub](https://github.com/dagster-io/dagster) (👨‍💻 190 · 🔀 530 · 📦 310 · 📋 3.7K - 24% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/dagster-io/dagster
	```
- [PyPi](https://pypi.org/project/dagster) (📥 190K / month · 📦 84 · ⏱️ 11.02.2022):
	```
	pip install dagster
	```
- [Conda](https://anaconda.org/conda-forge/dagster) (📥 450K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/dbt-labs/dbt-core) (👨‍💻 200 · 🔀 770 · 📥 170 · 📦 300 · 📋 2.5K - 11% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/dbt-labs/dbt-core
	```
- [PyPi](https://pypi.org/project/dbt) (📥 600K / month · 📦 29 · ⏱️ 06.12.2021):
	```
	pip install dbt
	```
...
- [GitHub](https://github.com/great-expectations/great_expectations) (👨‍💻 260 · 🔀 830 · 📋 1.2K - 15% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/great-expectations/great_expectations
	```
- [PyPi](https://pypi.org/project/great_expectations) (📥 3.1M / month · 📦 27 · ⏱️ 10.02.2022):
	```
	pip install great_expectations
	```
- [Conda](https://anaconda.org/conda-forge/great-expectations) (📥 360K · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/kedro-org/kedro) (👨‍💻 140 · 🔀 600 · 📦 740 · 📋 610 - 7% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/kedro-org/kedro
	```
- [PyPi](https://pypi.org/project/kedro) (📥 310K / month · 📦 35 · ⏱️ 09.12.2021):
	```
	pip install kedro
	```
</details>
<details><summary><b><a href="https://github.com/petl-developers/petl">petl</a></b> (🥈32 ·  ⭐ 970) - Python Extract Transform and Load Tables of Data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/petl-developers/petl) (👨‍💻 54 · 🔀 170 · 📦 630 · 📋 440 - 16% open · ⏱️ 08.02.2022):

	```
	git clone https://github.com/petl-developers/petl
	```
- [PyPi](https://pypi.org/project/petl) (📥 62K / month · 📦 74 · ⏱️ 08.02.2022):
	```
	pip install petl
	```
- [Conda](https://anaconda.org/conda-forge/petl) (📥 70K · ⏱️ 11.02.2022):
	```
	conda install -c conda-forge petl
	```
</details>
<details><summary><b><a href="https://github.com/activeloopai/Hub">Activeloop</a></b> (🥈31 ·  ⭐ 4.3K) - Dataset format for AI. Build, manage, & visualize datasets for.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/activeloopai/Hub) (👨‍💻 91 · 🔀 350 · 📋 340 - 19% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/activeloopai/Hub
	```
- [PyPi](https://pypi.org/project/hub) (📥 3.1K / month · 📦 52 · ⏱️ 01.02.2022):
	```
	pip install hub
	```
</details>
...
- [GitHub](https://github.com/tensorflow/tfx) (👨‍💻 130 · 🔀 520 · 📋 740 - 33% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/tensorflow/tfx
	```
- [PyPi](https://pypi.org/project/tfx) (📥 290K / month · 📦 7 · ⏱️ 08.02.2022):
	```
	pip install tfx
	```
</details>
<details><summary><b><a href="https://github.com/ploomber/ploomber">ploomber</a></b> (🥉29 ·  ⭐ 1.3K) - The fastest way to build data pipelines. Develop iteratively,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ploomber/ploomber) (👨‍💻 35 · 🔀 95 · 📦 28 · 📋 540 - 26% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/ploomber/ploomber
	```
- [PyPi](https://pypi.org/project/ploomber) (📥 7.8K / month · 📦 4 · ⏱️ 13.02.2022):
	```
	pip install ploomber
	```
- [Conda](https://anaconda.org/conda-forge/ploomber) (📥 4.1K · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 42 · 🔀 220 · 📦 54 · 📋 330 - 21% open · ⏱️ 10.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 2.3K / month · 📦 27 · ⏱️ 10.01.2022):
	```
	pip install streamparse
	```
</details>
<details><summary><b><a href="https://github.com/zenml-io/zenml">zenml</a></b> (🥉27 ·  ⭐ 1.7K) - ZenML : MLOps framework to create reproducible pipelines. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/zenml-io/zenml) (👨‍💻 24 · 🔀 110 · 📋 58 - 17% open · ⏱️ 11.02.2022):
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 25 · 🔀 210 · 📋 230 - 14% open · ⏱️ 07.02.2022):

	```
	git clone https://github.com/hi-primus/optimus
	```
- [PyPi](https://pypi.org/project/optimuspyspark) (📥 27K / month · ⏱️ 30.05.2019):
	```
...
- [GitHub](https://github.com/EntilZha/PyFunctional) (👨‍💻 25 · 🔀 110 · 📦 400 · 📋 130 - 5% open · ⏱️ 05.11.2021):

	```
	git clone https://github.com/EntilZha/PyFunctional
	```
- [PyPi](https://pypi.org/project/pyfunctional) (📥 88K / month · 📦 12 · ⏱️ 12.01.2021):
	```
...
- [PyPi](https://pypi.org/project/arq) (📥 18K / month · 📦 10 · ⏱️ 02.09.2021):
	...
	pip install arq
	```
- [Conda](https://anaconda.org/conda-forge/arq) (📥 1.8K · ⏱️ 03.09.2021):
	```
...
<details><summary><b><a href="https://github.com/whylabs/whylogs">whylogs</a></b> (🥉24 ·  ⭐ 770) - Open standard for end-to-end data and ML monitoring for any scale in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/whylabs/whylogs) (👨‍💻 26 · 🔀 40 · 📥 49 · 📋 110 - 43% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/whylabs/whylogs
	```
- [PyPi](https://pypi.org/project/whylogs) (📥 8.8K / month · 📦 2 · ⏱️ 15.02.2022):
	```
	pip install whylogs
	```
</details>
...
- [PyPi](https://pypi.org/project/pypeln) (📥 12K / month · 📦 9 · ⏱️ 06.01.2022):
	...
	pip install pypeln
	```
- [Conda](https://anaconda.org/conda-forge/pypeln) (📥 4.7K · ⏱️ 06.01.2022):
	```
...
- [GitHub](https://github.com/closeio/tasktiger) (👨‍💻 25 · 🔀 62 · 📦 22 · 📋 68 - 48% open · ⏱️ 07.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/tasktiger) (📥 2.1K / month · 📦 10 · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/pdpipe/pdpipe) (👨‍💻 9 · 🔀 33 · 📦 40 · 📋 41 - 34% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/pdpipe/pdpipe
	```
- [PyPi](https://pypi.org/project/pdpipe) (📥 3.1K / month · 📦 5 · ⏱️ 14.02.2022):
	```
	pip install pdpipe
	```
- [Conda](https://anaconda.org/conda-forge/pdpipe) (📥 3.1K · ⏱️ 26.12.2021):
	```
...
- [GitHub](https://github.com/databricks/spark-deep-learning) (👨‍💻 16 · 🔀 460 · 📦 20 · 📋 100 - 73% open · ⏱️ 19.08.2021):
...
- [GitHub](https://github.com/nerevu/riko) (👨‍💻 18 · 🔀 75 · 📋 30 - 73% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/riko) (📥 110 / month · 📦 1 · ⏱️ 28.12.2021):
	```
	pip install riko
	```
</details>
...
- [GitHub](https://github.com/d6t/d6tflow) (👨‍💻 12 · 🔀 69 · 📦 19 · 📋 23 - 43% open · ⏱️ 28.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/d6tflow) (📥 190 / month · ⏱️ 06.10.2021):
	```
	pip install d6tflow
	```
</details>
<details><summary><b><a href="https://github.com/kubeflow-kale/kale">kale</a></b> (🥉18 ·  ⭐ 490) - Kubeflows superfood for Data Scientists. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
- <b><a href="https://github.com/analysiscenter/batchflow">BatchFlow</a></b> (🥉21 ·  ⭐ 170) - BatchFlow helps you conveniently work with random or sequential.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 630 · 🔀 3.3K · 📦 4K · 📋 9.5K - 24% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/ray-project/ray
	```
- [PyPi](https://pypi.org/project/ray) (📥 900K / month · 📦 230 · ⏱️ 15.02.2022):
	```
	pip install ray
	```
- [Conda](https://anaconda.org/conda-forge/ray-tune) (📥 23K · ⏱️ 07.02.2022):
	```
	conda install -c conda-forge ray-tune
	```
</details>
<details><summary><b><a href="https://github.com/dask/dask">dask</a></b> (🥇43 ·  ⭐ 9.6K) - Parallel computing with task scheduling. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dask/dask) (👨‍💻 510 · 🔀 1.4K · 📦 34K · 📋 4.2K - 18% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 7.7M / month · 📦 2.6K · ⏱️ 11.02.2022):
	```
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 5M · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 260 · 🔀 590 · 📦 22K · 📋 2.6K - 34% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/dask/distributed
	```
- [PyPi](https://pypi.org/project/distributed) (📥 6.7M / month · 📦 1.2K · ⏱️ 11.02.2022):
	```
	pip install distributed
	```
- [Conda](https://anaconda.org/conda-forge/distributed) (📥 6.2M · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/horovod/horovod) (👨‍💻 140 · 🔀 2K · 📦 500 · 📋 2K - 14% open · ⏱️ 04.02.2022):

	```
	git clone https://github.com/horovod/horovod
	```
- [PyPi](https://pypi.org/project/horovod) (📥 51K / month · 📦 29 · ⏱️ 06.10.2021):
	```
	pip install horovod
	```
</details>
...
- [GitHub](https://github.com/ipython/ipyparallel) (👨‍💻 110 · 🔀 860 · 📦 1.8K · 📋 320 - 15% open · ⏱️ 15.02.2022):
...
- [GitHub](https://github.com/intel-analytics/BigDL) (👨‍💻 130 · 🔀 970 · 📦 33 · 📋 1.2K - 30% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/intel-analytics/BigDL
	```
- [PyPi](https://pypi.org/project/bigdl) (📥 15K / month · 📦 1 · ⏱️ 17.02.2022):
	```
	pip install bigdl
	```
...
- [GitHub](https://github.com/microsoft/DeepSpeed) (👨‍💻 90 · 🔀 680 · 📦 170 · 📋 780 - 48% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/microsoft/DeepSpeed
	```
- [PyPi](https://pypi.org/project/deepspeed) (📥 78K / month · 📦 9 · ⏱️ 19.01.2022):
	```
...
<details><summary><b><a href="https://github.com/PyTorchLightning/metrics">metrics</a></b> (🥈31 ·  ⭐ 690) - Machine learning metrics for distributed, scalable PyTorch.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyTorchLightning/metrics) (👨‍💻 120 · 🔀 150 · 📥 450 · 📦 1.9K · 📋 300 - 18% open · ⏱️ 14.02.2022):
...
- [PyPi](https://pypi.org/project/metrics) (📥 2.7K / month · 📦 14 · ⏱️ 28.04.2018):
	...
	pip install metrics
	```
- [Conda](https://anaconda.org/conda-forge/torchmetrics) (📥 280K · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/fairscale) (👨‍💻 55 · 🔀 150 · 📦 170 · 📋 270 - 21% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/facebookresearch/fairscale
	```
- [PyPi](https://pypi.org/project/fairscale) (📥 60K / month · 📦 13 · ⏱️ 14.01.2022):
	```
	pip install fairscale
	```
- [Conda](https://anaconda.org/conda-forge/fairscale) (📥 5K · ⏱️ 05.02.2022):
	```
	conda install -c conda-forge fairscale
	```
</details>
<details><summary><b><a href="https://github.com/dask/dask-ml">dask-ml</a></b> (🥈29 ·  ⭐ 790) - Scalable Machine Learning with Dask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dask/dask-ml) (👨‍💻 71 · 🔀 220 · 📦 550 · 📋 470 - 49% open · ⏱️ 20.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/dask-ml) (📥 63K / month · 📦 55 · ⏱️ 22.01.2022):
	```
	pip install dask-ml
	```
...
- [GitHub](https://github.com/intel-analytics/analytics-zoo) (👨‍💻 100 · 🔀 710 · 📦 3 · 📋 1.4K - 40% open · ⏱️ 10.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/analytics-zoo) (📥 10K / month · 📦 1 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/uber/petastorm) (👨‍💻 43 · 🔀 230 · 📥 310 · 📦 55 · 📋 280 - 50% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/uber/petastorm
	```
- [PyPi](https://pypi.org/project/petastorm) (📥 75K / month · 📦 6 · ⏱️ 15.02.2022):
	```
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 84 · 🔀 640 · 📋 540 - 43% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/mmlspark) (📥 50K / month · ⏱️ 18.03.2020):
	```
...
- [GitHub](https://github.com/mpi4py/mpi4py) (👨‍💻 20 · 🔀 74 · 📥 3.4K · 📋 64 - 20% open · ⏱️ 26.01.2022):
...
- [PyPi](https://pypi.org/project/mpi4py) (📥 170K / month · 📦 580 · ⏱️ 15.12.2021):
	...
	pip install mpi4py
	```
- [Conda](https://anaconda.org/conda-forge/mpi4py) (📥 930K · ⏱️ 25.11.2021):
	```
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 84 · 🔀 640 · 📋 540 - 43% open · ⏱️ 14.02.2022):
	...
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/synapseml) (📥 5.7K / month · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/tensorflow/mesh) (👨‍💻 45 · 🔀 200 · 📦 630 · 📋 100 - 86% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/mesh-tensorflow) (📥 22K / month · 📦 32 · ⏱️ 24.03.2021):
	```
...
- [GitHub](https://github.com/maxpumperla/elephas) (👨‍💻 27 · 🔀 290 · 📦 52 · 📋 160 - 15% open · ⏱️ 17.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/elephas) (📥 32K / month · 📦 3 · ⏱️ 17.08.2021):
	```
	pip install elephas
	```
- [Conda](https://anaconda.org/conda-forge/elephas) (📥 7.8K · ⏱️ 02.06.2021):
	```
	conda install -c conda-forge elephas
	```
</details>
<details><summary><b><a href="https://github.com/learning-at-home/hivemind">Hivemind</a></b> (🥉21 ·  ⭐ 970) - Decentralized deep learning in PyTorch. Built to train models on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 20 · 🔀 59 · 📦 4 · 📋 120 - 36% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/learning-at-home/hivemind
	```
- [PyPi](https://pypi.org/project/hivemind) (📥 280 / month · 📦 1 · ⏱️ 20.12.2021):
	```
	pip install hivemind
	```
</details>
<details><summary><b><a href="https://github.com/facebookincubator/submitit">Submit it</a></b> (🥉21 ·  ⭐ 560) - Python 3.6+ toolbox for submitting jobs to Slurm. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookincubator/submitit) (👨‍💻 17 · 🔀 54 · 📋 58 - 43% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/facebookincubator/submitit
	```
- [PyPi](https://pypi.org/project/submitit) (📥 15K / month · 📦 6 · ⏱️ 30.11.2021):
	```
	pip install submitit
	```
- [Conda](https://anaconda.org/conda-forge/submitit) (📥 5.3K · ⏱️ 10.02.2021):
	```
...
- [GitHub](https://github.com/bytedance/byteps) (👨‍💻 19 · 🔀 430 · 📋 260 - 38% open · ⏱️ 10.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/byteps) (📥 80 / month · ⏱️ 02.08.2021):
	```
	pip install byteps
	```
...
- [GitHub](https://github.com/uber/fiber) (👨‍💻 5 · 🔀 100 · 📦 31 · 📋 28 - 71% open · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fiber) (📥 2.2K / month · 📦 1 · ⏱️ 09.07.2020):
	```
	pip install fiber
	```
</details>
...
- [GitHub](https://github.com/kingoflolz/mesh-transformer-jax) (👨‍💻 23 · 🔀 470 · 📋 150 - 9% open · ⏱️ 28.01.2022):
...
<details><summary><b><a href="https://github.com/optuna/optuna">Optuna</a></b> (🥇38 ·  ⭐ 6K) - A hyperparameter optimization framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/optuna/optuna) (👨‍💻 180 · 🔀 650 · 📦 2.7K · 📋 1.1K - 12% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/optuna/optuna
	```
- [PyPi](https://pypi.org/project/optuna) (📥 860K / month · 📦 180 · ⏱️ 14.02.2022):
	```
	pip install optuna
	```
- [Conda](https://anaconda.org/conda-forge/optuna) (📥 130K · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/microsoft/nni) (👨‍💻 160 · 🔀 1.5K · 📦 190 · 📋 1.5K - 17% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/microsoft/nni
	```
- [PyPi](https://pypi.org/project/nni) (📥 16K / month · 📦 28 · ⏱️ 19.01.2022):
	```
	pip install nni
	```
</details>
...
- [GitHub](https://github.com/alteryx/featuretools) (👨‍💻 59 · 🔀 790 · 📦 930 · 📋 740 - 23% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/alteryx/featuretools
	```
- [PyPi](https://pypi.org/project/featuretools) (📥 580K / month · 📦 62 · ⏱️ 14.02.2022):
	```
	pip install featuretools
	```
- [Conda](https://anaconda.org/conda-forge/featuretools) (📥 78K · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/keras-team/autokeras) (👨‍💻 130 · 🔀 1.3K · 📥 2.7K · 📦 280 · 📋 800 - 8% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/keras-team/autokeras
	```
- [PyPi](https://pypi.org/project/autokeras) (📥 41K / month · 📦 10 · ⏱️ 03.02.2022):
	```
...
- [GitHub](https://github.com/hyperopt/hyperopt) (👨‍💻 93 · 🔀 920 · 📦 5.8K · 📋 590 - 60% open · ⏱️ 29.11.2021):
...
- [PyPi](https://pypi.org/project/hyperopt) (📥 2M / month · 📦 400 · ⏱️ 17.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hyperopt) (📥 350K · ⏱️ 14.10.2020):
	```
...
- [GitHub](https://github.com/automl/auto-sklearn) (👨‍💻 79 · 🔀 1.1K · 📥 14 · 📦 260 · 📋 850 - 13% open · ⏱️ 25.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/auto-sklearn) (📥 29K / month · 📦 30 · ⏱️ 25.01.2022):
	```
	pip install auto-sklearn
	```
- [Conda](https://anaconda.org/conda-forge/auto-sklearn) (📥 3K · ⏱️ 28.01.2022):
	```
...
- [GitHub](https://github.com/keras-team/keras-tuner) (👨‍💻 42 · 🔀 320 · 📦 1.1K · 📋 360 - 44% open · ⏱️ 20.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/keras-tuner) (📥 510K / month · 📦 34 · ⏱️ 05.11.2021):
	```
	pip install keras-tuner
	```
- [Conda](https://anaconda.org/conda-forge/keras-tuner) (📥 5K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/scikit-optimize/scikit-optimize) (👨‍💻 75 · 🔀 420 · 📦 2.4K · 📋 620 - 37% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/scikit-optimize) (📥 900K / month · 📦 170 · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/facebook/Ax) (👨‍💻 110 · 🔀 180 · 📦 240 · 📋 360 - 10% open · ⏱️ 16.02.2022):
...
- [PyPi](https://pypi.org/project/ax-platform) (📥 110K / month · 📦 14 · ⏱️ 16.12.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ax-platform) (📥 710 · ⏱️ 22.06.2021):
	```
...
- [GitHub](https://github.com/pytorch/botorch) (👨‍💻 67 · 🔀 240 · 📦 210 · 📋 240 - 23% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/pytorch/botorch
	```
- [PyPi](https://pypi.org/project/botorch) (📥 140K / month · 📦 12 · ⏱️ 09.12.2021):
	```
	pip install botorch
	```
- [Conda](https://anaconda.org/conda-forge/botorch) (📥 18K · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/awslabs/autogluon) (👨‍💻 65 · 🔀 550 · 📦 99 · 📋 620 - 21% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/awslabs/autogluon
	```
- [PyPi](https://pypi.org/project/autogluon) (📥 48K / month · 📦 4 · ⏱️ 17.02.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/nevergrad) (👨‍💻 47 · 🔀 300 · 📦 290 · 📋 250 - 38% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/facebookresearch/nevergrad
	```
- [PyPi](https://pypi.org/project/nevergrad) (📥 21K / month · 📦 17 · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/mljar/mljar-supervised) (👨‍💻 15 · 🔀 250 · 📦 36 · 📋 460 - 16% open · ⏱️ 17.02.2022):
...
<details><summary><b><a href="https://github.com/autonomio/talos">Talos</a></b> (🥈27 ·  ⭐ 1.5K) - Hyperparameter Optimization for TensorFlow, Keras and PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/autonomio/talos) (👨‍💻 21 · 🔀 250 · 📦 140 · 📋 400 - 8% open · ⏱️ 28.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/talos) (📥 1.3K / month · 📦 6 · ⏱️ 28.01.2022):
	```
	pip install talos
	```
</details>
...
- [GitHub](https://github.com/tensorflow/adanet) (👨‍💻 27 · 🔀 520 · 📦 42 · 📋 110 - 57% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/adanet) (📥 1.4K / month · 📦 2 · ⏱️ 09.07.2020):
	```
	pip install adanet
	```
</details>
<details><summary><b><a href="https://github.com/SimonBlanke/Hyperactive">Hyperactive</a></b> (🥉23 ·  ⭐ 370) - An optimization and data collection toolbox for convenient and fast.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/SimonBlanke/Hyperactive) (👨‍💻 4 · 🔀 32 · 📥 98 · 📦 11 · 📋 43 - 16% open · ⏱️ 18.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/hyperactive) (📥 500 / month · 📦 3 · ⏱️ 05.12.2021):
	```
...
- [GitHub](https://github.com/Neuraxio/Neuraxle) (👨‍💻 7 · 🔀 53 · 📦 26 · 📋 350 - 40% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/Neuraxio/Neuraxle
	```
- [PyPi](https://pypi.org/project/neuraxle) (📥 270 / month · 📦 1 · ⏱️ 17.10.2021):
	```
	pip install neuraxle
	```
</details>
<details><summary><b><a href="https://github.com/ScottfreeLLC/AlphaPy">AlphaPy</a></b> (🥉19 ·  ⭐ 720) - Automated Machine Learning [AutoML] with Python, scikit-learn, Keras,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/ScottfreeLLC/AlphaPy) (👨‍💻 3 · 🔀 150 · 📦 3 · 📋 41 - 29% open · ⏱️ 23.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/alphapy) (📥 110 / month · ⏱️ 29.08.2020):
	```
	pip install alphapy
	```
</details>
...
- [GitHub](https://github.com/rsteca/sklearn-deap) (👨‍💻 22 · 🔀 110 · 📦 31 · 📋 55 - 38% open · ⏱️ 30.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-deap) (📥 700 / month · 📦 2 · ⏱️ 30.07.2021):
	```
	pip install sklearn-deap
	```
</details>
<details><summary><b><a href="https://github.com/AutoViML/Auto_ViML">Auto ViML</a></b> (🥉19 ·  ⭐ 330) - Automatically Build Multiple ML Models with a Single Line of Code... <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/AutoViML/Auto_ViML) (👨‍💻 6 · 🔀 70 · 📦 15 · 📋 18 - 22% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/autoviml) (📥 980 / month · 📦 2 · ⏱️ 06.12.2021):
	```
...
- <b><a href="https://github.com/SheffieldML/GPyOpt">GPyOpt</a></b> (🥉26 ·  ⭐ 800 · 💀) - Gaussian Process Optimization using GPy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/shankarpandala/lazypredict">lazypredict</a></b> (🥉21 ·  ⭐ 290) - Lazy Predict help build a lot of basic models without much code.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 340 · 🔀 7.3K · 📦 26K · 📋 1.5K - 7% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 550K / month · 📦 2.3K · ⏱️ 06.10.2021):
	```
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 90K · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 120 · 🔀 600 · 📦 710 · 📋 530 - 20% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/tensorflow/agents
	```
- [PyPi](https://pypi.org/project/tf-agents) (📥 170K / month · 📦 14 · ⏱️ 15.02.2022):
	```
	pip install tf-agents
	```
</details>
<details><summary><b><a href="https://github.com/google/dopamine">Dopamine</a></b> (🥈29 ·  ⭐ 9.7K) - Dopamine is a research framework for fast prototyping of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/google/dopamine) (👨‍💻 14 · 🔀 1.3K · 📋 160 - 49% open · ⏱️ 14.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/dopamine-rl) (📥 110K / month · 📦 37 · ⏱️ 13.12.2021):
	```
...
- [GitHub](https://github.com/tensorlayer/TensorLayer) (👨‍💻 130 · 🔀 1.5K · 📥 1.4K · 📋 470 - 6% open · ⏱️ 29.10.2021):

	```
	git clone https://github.com/tensorlayer/tensorlayer
	```
- [PyPi](https://pypi.org/project/tensorlayer) (📥 2.6K / month · 📦 40 · ⏱️ 15.02.2022):
	```
	pip install tensorlayer
	```
</details>
<details><summary><b><a href="https://github.com/AI4Finance-Foundation/FinRL">FinRL</a></b> (🥈29 ·  ⭐ 3.4K) - FinRL: Financial Reinforcement Learning Framework. Please star. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/AI4Finance-Foundation/FinRL) (👨‍💻 53 · 🔀 910 · 📦 10 · 📋 330 - 23% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/AI4Finance-Foundation/FinRL
	```
- [PyPi](https://pypi.org/project/finrl) (📥 410 / month · ⏱️ 08.01.2022):
	```
	pip install finrl
	```
</details>
<details><summary><b><a href="https://github.com/mwydmuch/ViZDoom">ViZDoom</a></b> (🥈29 ·  ⭐ 1.3K) - Doom-based AI Research Platform for Reinforcement Learning from Raw.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mwydmuch/ViZDoom) (👨‍💻 46 · 🔀 320 · 📥 11K · 📦 120 · 📋 440 - 20% open · ⏱️ 20.01.2022):

	```
	git clone https://github.com/mwydmuch/ViZDoom
	```
- [PyPi](https://pypi.org/project/vizdoom) (📥 1.2K / month · 📦 14 · ⏱️ 22.11.2021):
	```
	pip install vizdoom
	```
</details>
...
- [GitHub](https://github.com/deepmind/acme) (👨‍💻 59 · 🔀 300 · 📦 57 · 📋 160 - 25% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/deepmind/acme
	```
- [PyPi](https://pypi.org/project/dm-acme) (📥 4.2K / month · 📦 2 · ⏱️ 10.02.2022):
	```
	pip install dm-acme
	```
- [Conda](https://anaconda.org/conda-forge/dm-acme) (📥 1.9K · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PARL) (👨‍💻 29 · 🔀 620 · 📦 87 · 📋 310 - 23% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/PaddlePaddle/PARL
	```
- [PyPi](https://pypi.org/project/parl) (📥 460 / month · ⏱️ 30.12.2021):
	```
	pip install parl
	```
</details>
...
- [GitHub](https://github.com/hill-a/stable-baselines) (👨‍💻 110 · 🔀 670 · 📋 930 - 13% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stable-baselines) (📥 8.4K / month · 📦 34 · ⏱️ 06.04.2021):
	```
...
- [GitHub](https://github.com/chainer/chainerrl) (👨‍💻 29 · 🔀 210 · 📦 110 · 📋 220 - 33% open · ⏱️ 17.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/chainerrl) (📥 620 / month · 📦 8 · ⏱️ 14.02.2020):
	```
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 120 · 🔀 430 · 📋 120 - 35% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/facebookresearch/ReAgent
	```
- [PyPi](https://pypi.org/project/reagent) (📥 15 / month · ⏱️ 27.05.2020):
	```
	pip install reagent
	```
</details>
...
- [GitHub](https://github.com/deepmind/trfl) (👨‍💻 13 · 🔀 370 · 📦 72 · 📋 22 - 27% open · ⏱️ 16.08.2021):

	```
	git clone https://github.com/deepmind/trfl
	```
- [PyPi](https://pypi.org/project/trfl) (📥 4.5K / month · 📦 3 · ⏱️ 16.08.2021):
	```
	pip install trfl
	```
</details>
...
<details><summary><b><a href="https://github.com/pfnet/pfrl">PFRL</a></b> (🥉20 ·  ⭐ 790) - PFRL: a PyTorch-based deep reinforcement learning library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pfnet/pfrl) (👨‍💻 15 · 🔀 110 · 📦 31 · 📋 60 - 45% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/pfnet/pfrl
	```
- [PyPi](https://pypi.org/project/pfrl) (📥 2.7K / month · 📦 1 · ⏱️ 07.07.2021):
	```
	pip install pfrl
	```
</details>
<details><summary><b><a href="https://github.com/deepmind/rlax">RLax</a></b> (🥉20 ·  ⭐ 740) - A library of reinforcement learning building blocks in JAX. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/deepmind/rlax) (👨‍💻 16 · 🔀 57 · 📦 37 · 📋 18 - 50% open · ⏱️ 04.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/rlax) (📥 3.1K / month · ⏱️ 19.11.2021):
	```
	pip install rlax
	```
</details>
...
- <b><a href="https://github.com/SerpentAI/SerpentAI">SerpentAI</a></b> (🥉20 ·  ⭐ 6.2K · 💀) - Game Agent Framework. Helping you create AIs / Bots that learn to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/microsoft/recommenders) (👨‍💻 100 · 🔀 2.1K · 📥 120 · 📦 11 · 📋 660 - 19% open · ⏱️ 13.01.2022):

	```
	git clone https://github.com/microsoft/recommenders
	```
- [PyPi](https://pypi.org/project/recommenders) (📥 6K / month · 📦 2 · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 30 · 🔀 530 · 📦 540 · 📋 380 - 17% open · ⏱️ 29.01.2022):

	```
	git clone https://github.com/benfred/implicit
	```
- [PyPi](https://pypi.org/project/implicit) (📥 170K / month · 📦 31 · ⏱️ 29.01.2022):
	```
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 620 · 📦 640 · 📋 440 - 20% open · ⏱️ 31.12.2021):
...
- [GitHub](https://github.com/tensorflow/recommenders) (👨‍💻 30 · 🔀 160 · 📦 71 · 📋 230 - 54% open · ⏱️ 28.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-recommenders) (📥 280K / month · 📦 1 · ⏱️ 23.08.2021):
	```
	pip install tensorflow-recommenders
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/ranking">TF Ranking</a></b> (🥈26 ·  ⭐ 2.4K) - Learning to Rank in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tensorflow/ranking) (👨‍💻 25 · 🔀 410 · 📋 280 - 17% open · ⏱️ 22.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow_ranking) (📥 42K / month · 📦 11 · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 13 · 🔀 86 · 📦 75 · 📋 86 - 5% open · ⏱️ 30.09.2021):

	```
	git clone https://github.com/PreferredAI/cornac
	```
- [PyPi](https://pypi.org/project/cornac) (📥 11K / month · 📦 14 · ⏱️ 26.09.2021):
	```
	pip install cornac
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 190 · 📥 430 · 📦 94 · 📋 110 - 43% open · ⏱️ 24.03.2021):

	```
	git clone https://github.com/ibayer/fastFM
	```
- [PyPi](https://pypi.org/project/fastfm) (📥 640 / month · 📦 8 · ⏱️ 23.11.2017):
	```
	pip install fastfm
	```
</details>
<details><summary><b><a href="https://github.com/statisticianinstilettos/recmetrics">recmetrics</a></b> (🥉19 ·  ⭐ 340) - A library of metrics for evaluating recommender systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/statisticianinstilettos/recmetrics) (👨‍💻 13 · 🔀 79 · 📦 22 · 📋 17 - 41% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/recmetrics) (📥 1.3K / month · ⏱️ 24.09.2021):
	```
...
- [GitHub](https://github.com/OpenMined/PySyft) (👨‍💻 430 · 🔀 1.8K · 📋 3.1K - 10% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/OpenMined/PySyft
	```
- [PyPi](https://pypi.org/project/syft) (📥 3.6K / month · 📦 5 · ⏱️ 16.02.2022):
	```
	pip install syft
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/privacy">TensorFlow Privacy</a></b> (🥈27 ·  ⭐ 1.6K) - Library for training machine learning models with.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/privacy) (👨‍💻 45 · 🔀 330 · 📥 62 · 📋 150 - 41% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/tensorflow/privacy
	```
- [PyPi](https://pypi.org/project/tensorflow-privacy) (📥 32K / month · 📦 6 · ⏱️ 01.09.2021):
	```
...
- [GitHub](https://github.com/pytorch/opacus) (👨‍💻 43 · 🔀 180 · 📥 42 · 📦 76 · 📋 140 - 19% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/pytorch/opacus
	```
- [PyPi](https://pypi.org/project/opacus) (📥 4.8K / month · 📦 11 · ⏱️ 09.02.2022):
	```
	pip install opacus
	```
- [Conda](https://anaconda.org/conda-forge/opacus) (📥 140 · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/FederatedAI/FATE) (👨‍💻 69 · 🔀 1.2K · 📋 1.1K - 32% open · ⏱️ 27.01.2022):
...
- [GitHub](https://github.com/facebookresearch/CrypTen) (👨‍💻 26 · 🔀 160 · 📦 14 · 📋 130 - 18% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/facebookresearch/CrypTen
	```
- [PyPi](https://pypi.org/project/crypten) (📥 300 / month · ⏱️ 09.09.2021):
	```
	pip install crypten
	```
</details>
...
- <b><a href="https://github.com/tf-encrypted/tf-encrypted">TFEncrypted</a></b> (🥉24 ·  ⭐ 980 · 💀) - A Framework for Encrypted Machine Learning in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 280 · 🔀 1.5K · 📦 95K · 📋 1.6K - 33% open · ⏱️ 15.02.2022):
...
- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 350 · 🔀 2.5K · 📋 2.2K - 45% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/mlflow/mlflow
	```
- [PyPi](https://pypi.org/project/mlflow) (📥 10M / month · 📦 280 · ⏱️ 27.01.2022):
	```
	pip install mlflow
	```
...
<details><summary><b><a href="https://github.com/iterative/dvc">DVC</a></b> (🥇36 ·  ⭐ 9.3K) - Data Version Control | Git for Data & Models | ML Experiments Management. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/iterative/dvc) (👨‍💻 260 · 🔀 900 · 📥 61K · 📋 3.5K - 17% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/iterative/dvc
	```
- [PyPi](https://pypi.org/project/dvc) (📥 330K / month · 📦 46 · ⏱️ 16.02.2022):
	```
	pip install dvc
	```
- [Conda](https://anaconda.org/conda-forge/dvc) (📥 990K · ⏱️ 25.12.2021):
	```
	conda install -c conda-forge dvc
	```
</details>
<details><summary><b><a href="https://github.com/pycaret/pycaret">PyCaret</a></b> (🥇36 ·  ⭐ 5.1K · 📉) - An open-source, low-code machine learning library in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pycaret/pycaret) (👨‍💻 72 · 🔀 1.2K · 📥 520 · 📦 1.8K · 📋 1.3K - 16% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/pycaret/pycaret
	```
- [PyPi](https://pypi.org/project/pycaret) (📥 330K / month · 📦 12 · ⏱️ 12.01.2022):
	```
	pip install pycaret
	```
- [Conda](https://anaconda.org/conda-forge/pycaret) (📥 7.3K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 250 · 🔀 740 · 📦 1.2K · 📋 980 - 33% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/aws/sagemaker-python-sdk
	```
- [PyPi](https://pypi.org/project/sagemaker) (📥 3.1M / month · 📦 44 · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/wandb/client) (👨‍💻 100 · 🔀 290 · 📋 1.7K - 21% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/wandb/client
	```
- [PyPi](https://pypi.org/project/wandb) (📥 720K / month · 📦 200 · ⏱️ 01.02.2022):
	```
	pip install wandb
	```
- [Conda](https://anaconda.org/conda-forge/wandb) (📥 44K · ⏱️ 02.02.2022):
	```
...
- [GitHub](https://github.com/lanpa/tensorboardX) (👨‍💻 70 · 🔀 840 · 📥 340 · 📦 17K · 📋 440 - 16% open · ⏱️ 06.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorboardX) (📥 710K / month · 📦 860 · ⏱️ 21.11.2021):
	```
...
<details><summary><b><a href="https://github.com/Azure/MachineLearningNotebooks">AzureML SDK</a></b> (🥈34 ·  ⭐ 2.9K) - Python notebooks with ML and deep learning examples with Azure.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Azure/MachineLearningNotebooks) (👨‍💻 59 · 🔀 2K · 📥 430 · 📋 1.2K - 17% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/Azure/MachineLearningNotebooks
	```
- [PyPi](https://pypi.org/project/azureml-sdk) (📥 1.7M / month · 📦 45 · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 240 · 🔀 300 · 📦 1K · 📋 840 - 63% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/snakemake/snakemake
	```
- [PyPi](https://pypi.org/project/snakemake) (📥 67K / month · 📦 200 · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/allegroai/clearml) (👨‍💻 46 · 🔀 410 · 📥 400 · 📦 190 · 📋 460 - 36% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/allegroai/clearml
	```
- [PyPi](https://pypi.org/project/clearml) (📥 62K / month · 📦 4 · ⏱️ 16.02.2022):
	```
	pip install clearml
	```
...
- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 47 · 🔀 470 · 📦 250 · 📋 420 - 52% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/Netflix/metaflow
	```
- [PyPi](https://pypi.org/project/metaflow) (📥 44K / month · 📦 6 · ⏱️ 17.02.2022):
	```
	pip install metaflow
	```
- [Conda](https://anaconda.org/conda-forge/metaflow) (📥 32K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 31 · 🔀 580 · 📥 160 · 📦 960 · 📋 390 - 15% open · ⏱️ 30.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/visualdl) (📥 55K / month · 📦 23 · ⏱️ 06.01.2022):
	```
...
- [GitHub](https://github.com/catalyst-team/catalyst) (👨‍💻 100 · 🔀 350 · 📦 480 · 📋 330 - 0% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/catalyst-team/catalyst
	```
- [PyPi](https://pypi.org/project/catalyst) (📥 16K / month · 📦 29 · ⏱️ 13.02.2022):
	```
	pip install catalyst
	```
</details>
<details><summary><b><a href="https://github.com/aimhubio/aim">aim</a></b> (🥈31 ·  ⭐ 2.2K) - Aim an easy-to-use and performant open-source experiment tracker. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/aimhubio/aim) (👨‍💻 27 · 🔀 130 · 📦 52 · 📋 340 - 35% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/aimhubio/aim
	```
- [PyPi](https://pypi.org/project/aim) (📥 13K / month · 📦 2 · ⏱️ 16.02.2022):
	```
	pip install aim
	```
- [Conda](https://anaconda.org/conda-forge/aim) (📥 7.3K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/IDSIA/sacred) (👨‍💻 96 · 🔀 340 · 📦 1.2K · 📋 520 - 18% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/sacred) (📥 27K / month · 📦 100 · ⏱️ 14.12.2020):
	```
	pip install sacred
	```
- [Conda](https://anaconda.org/conda-forge/sacred) (📥 140 · ⏱️ 14.11.2021):
	```
...
<details><summary><b><a href="https://github.com/google/ml-metadata">ml-metadata</a></b> (🥉27 ·  ⭐ 440) - For recording and retrieving metadata associated with ML.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google/ml-metadata) (👨‍💻 13 · 🔀 87 · 📥 1.7K · 📦 190 · 📋 82 - 26% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/google/ml-metadata
	```
- [PyPi](https://pypi.org/project/ml-metadata) (📥 430K / month · 📦 18 · ⏱️ 21.01.2022):
	```
	pip install ml-metadata
	```
</details>
<details><summary><b><a href="https://github.com/guildai/guildai">Guild AI</a></b> (🥉26 ·  ⭐ 660) - Experiment tracking, ML developer tools. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/guildai/guildai) (👨‍💻 18 · 🔀 59 · 📦 43 · 📋 300 - 38% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/guildai/guildai
	```
- [PyPi](https://pypi.org/project/guildai) (📥 3.9K / month · ⏱️ 07.02.2022):
	```
	pip install guildai
	```
</details>
...
- [GitHub](https://github.com/stared/livelossplot) (👨‍💻 17 · 🔀 140 · 📦 730 · 📋 74 - 5% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/labmlai/labml) (👨‍💻 6 · 🔀 71 · 📦 42 · 📋 25 - 52% open · ⏱️ 05.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/labml) (📥 5.5K / month · 📦 6 · ⏱️ 18.01.2022):
	```
	pip install labml
	```
</details>
...
- [GitHub](https://github.com/instacart/lore) (👨‍💻 23 · 🔀 130 · 📦 17 · 📋 44 - 59% open · ⏱️ 02.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/lore) (📥 2.1K / month · 📦 1 · ⏱️ 02.02.2022):
	```
	pip install lore
	```
</details>
...
- [GitHub](https://github.com/studioml/studio) (👨‍💻 21 · 🔀 52 · 📦 5 · 📋 250 - 22% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/studioml) (📥 250 / month · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/replicate/keepsake) (👨‍💻 16 · 🔀 60 · 📋 190 - 65% open · ⏱️ 07.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/keepsake) (📥 750 / month · ⏱️ 11.03.2021):
	```
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 220 · 🔀 2.3K · 📥 17K · 📦 5.6K · 📋 1.9K - 25% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/onnx/onnx
	```
- [PyPi](https://pypi.org/project/onnx) (📥 1.5M / month · 📦 320 · ⏱️ 26.10.2021):
	```
	pip install onnx
	```
...
- [GitHub](https://github.com/apple/coremltools) (👨‍💻 120 · 🔀 390 · 📥 4K · 📦 760 · 📋 870 - 36% open · ⏱️ 21.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/coremltools) (📥 76K / month · 📦 140 · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/pytorch/serve) (👨‍💻 95 · 🔀 460 · 📥 960 · 📋 790 - 15% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/pytorch/serve
	```
- [PyPi](https://pypi.org/project/torchserve) (📥 13K / month · 📦 8 · ⏱️ 29.12.2021):
	```
...
- [Conda](https://anaconda.org/pytorch/torchserve) (📥 19K · ⏱️ 29.12.2021):
	...
	```
- [Docker Hub](https://hub.docker.com/r/pytorch/torchserve) (📥 980K · ⭐ 11 · ⏱️ 29.12.2021):
	```
	docker pull pytorch/torchserve
	```
</details>
<details><summary><b><a href="https://github.com/huggingface/huggingface_hub">huggingface_hub</a></b> (🥈29 ·  ⭐ 340) - All the open source things related to the Hugging Face Hub. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/huggingface_hub) (👨‍💻 56 · 🔀 75 · 📋 210 - 48% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/huggingface/huggingface_hub
	```
- [PyPi](https://pypi.org/project/huggingface_hub) (📥 2.6M / month · 📦 51 · ⏱️ 11.01.2022):
	```
	pip install huggingface_hub
	```
- [Conda](https://anaconda.org/conda-forge/huggingface_hub) (📥 28K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/openai/triton) (👨‍💻 34 · 🔀 260 · 📦 68 · 📋 180 - 33% open · ⏱️ 12.02.2022):

	```
	git clone https://github.com/openai/triton
	```
- [PyPi](https://pypi.org/project/triton) (📥 55K / month · 📦 2 · ⏱️ 13.02.2022):
	```
	pip install triton
	```
</details>
...
- [GitHub](https://github.com/cortexlabs/cortex) (👨‍💻 24 · 🔀 590 · 📋 1.1K - 9% open · ⏱️ 06.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/cortex) (📥 1.3K / month · 📦 1 · ⏱️ 10.01.2022):
	```
	pip install cortex
	```
</details>
...
- [GitHub](https://github.com/bentoml/BentoML) (👨‍💻 99 · 🔀 380 · 📥 930 · 📋 550 - 9% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/bentoml/BentoML
	```
- [PyPi](https://pypi.org/project/bentoml) (📥 13K / month · 📦 2 · ⏱️ 15.02.2022):
	```
	pip install bentoml
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/hummingbird">Hummingbird</a></b> (🥉26 ·  ⭐ 2.7K) - Hummingbird compiles trained ML models into tensor computation for.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/microsoft/hummingbird) (👨‍💻 28 · 🔀 210 · 📥 160 · 📦 20 · 📋 240 - 22% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/hummingbird-ml) (📥 2.3K / month · ⏱️ 14.12.2021):
	```
	pip install hummingbird-ml
	```
- [Conda](https://anaconda.org/conda-forge/hummingbird-ml) (📥 5.3K · ⏱️ 14.12.2021):
	```
...
- [GitHub](https://github.com/BayesWitnesses/m2cgen) (👨‍💻 12 · 🔀 170 · 📦 16 · 📋 100 - 35% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/BayesWitnesses/m2cgen
	```
- [PyPi](https://pypi.org/project/m2cgen) (📥 50K / month · ⏱️ 18.09.2020):
	```
	pip install m2cgen
	```
</details>
<details><summary><b><a href="https://github.com/gmalivenko/pytorch2keras">pytorch2keras</a></b> (🥉18 ·  ⭐ 780) - PyTorch to Keras model convertor. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gmalivenko/pytorch2keras) (👨‍💻 13 · 🔀 130 · 📦 28 · 📋 120 - 44% open · ⏱️ 06.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytorch2keras) (📥 630 / month · 📦 1 · ⏱️ 14.05.2020):
	```
...
- [PyPi](https://pypi.org/project/shap) (📥 4.5M / month · 📦 220 · ⏱️ 20.10.2021):
	...
	pip install shap
	```
- [Conda](https://anaconda.org/conda-forge/shap) (📥 880K · ⏱️ 23.01.2022):
	```
...
- [GitHub](https://github.com/marcotcr/lime) (👨‍💻 61 · 🔀 1.5K · 📦 2K · 📋 550 - 4% open · ⏱️ 29.07.2021):

	```
	git clone https://github.com/marcotcr/lime
	```
- [PyPi](https://pypi.org/project/lime) (📥 730K / month · 📦 110 · ⏱️ 26.06.2020):
	```
	pip install lime
	```
- [Conda](https://anaconda.org/conda-forge/lime) (📥 93K · ⏱️ 28.06.2020):
	```
...
- [GitHub](https://github.com/arviz-devs/arviz) (👨‍💻 110 · 🔀 260 · 📥 110 · 📦 1.9K · 📋 750 - 25% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/arviz-devs/arviz
	```
- [PyPi](https://pypi.org/project/arviz) (📥 310K / month · 📦 71 · ⏱️ 03.10.2021):
	```
	pip install arviz
	```
- [Conda](https://anaconda.org/conda-forge/arviz) (📥 630K · ⏱️ 03.10.2021):
	```
	conda install -c conda-forge arviz
	```
</details>
<details><summary><b><a href="https://github.com/interpretml/interpret">InterpretML</a></b> (🥇32 ·  ⭐ 4.6K) - Fit interpretable models. Explain blackbox machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/interpretml/interpret) (👨‍💻 28 · 🔀 560 · 📦 160 · 📋 270 - 32% open · ⏱️ 12.02.2022):
...
- [GitHub](https://github.com/pytorch/captum) (👨‍💻 79 · 🔀 310 · 📦 400 · 📋 340 - 23% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/pytorch/captum
	```
- [PyPi](https://pypi.org/project/captum) (📥 36K / month · 📦 17 · ⏱️ 02.11.2021):
	```
	pip install captum
	```
- [Conda](https://anaconda.org/conda-forge/captum) (📥 200 · ⏱️ 27.01.2022):
	```
...
- [GitHub](https://github.com/bmabey/pyLDAvis) (👨‍💻 32 · 🔀 320 · 📦 3.1K · 📋 160 - 52% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyldavis) (📥 630K / month · 📦 130 · ⏱️ 24.03.2021):
	```
...
- [GitHub](https://github.com/tensorflow/model-analysis) (👨‍💻 37 · 🔀 240 · 📋 74 - 36% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/tensorflow/model-analysis
	```
- [PyPi](https://pypi.org/project/tensorflow-model-analysis) (📥 1.5M / month · 📦 21 · ⏱️ 24.01.2022):
	```
...
- [GitHub](https://github.com/MAIF/shapash) (👨‍💻 31 · 🔀 210 · 📦 66 · 📋 98 - 12% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/microsoft/dowhy) (👨‍💻 48 · 🔀 560 · 📥 24 · 📦 85 · 📋 180 - 29% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/Microsoft/dowhy
	```
- [PyPi](https://pypi.org/project/dowhy) (📥 110K / month · 📦 4 · ⏱️ 10.01.2022):
	```
	pip install dowhy
	```
- [Conda](https://anaconda.org/conda-forge/dowhy) (📥 4.4K · ⏱️ 22.01.2022):
	```
...
- [GitHub](https://github.com/parrt/dtreeviz) (👨‍💻 17 · 🔀 260 · 📦 300 · 📋 120 - 17% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/parrt/dtreeviz
	```
- [PyPi](https://pypi.org/project/dtreeviz) (📥 79K / month · 📦 14 · ⏱️ 09.02.2022):
	```
	pip install dtreeviz
	```
- [Conda](https://anaconda.org/conda-forge/dtreeviz) (📥 7.4K · ⏱️ 10.02.2022):
	```
	conda install -c conda-forge dtreeviz
	```
</details>
<details><summary><b><a href="https://github.com/SeldonIO/alibi">Alibi</a></b> (🥈28 ·  ⭐ 1.5K) - Algorithms for explaining machine learning models. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/SeldonIO/alibi) (👨‍💻 18 · 🔀 180 · 📦 140 · 📋 270 - 41% open · ⏱️ 04.02.2022):

	```
	git clone https://github.com/SeldonIO/alibi
	```
- [PyPi](https://pypi.org/project/alibi) (📥 41K / month · 📦 22 · ⏱️ 28.01.2022):
	```
	pip install alibi
	```
</details>
...
- [GitHub](https://github.com/tensorflow/lucid) (👨‍💻 40 · 🔀 590 · 📦 600 · 📋 170 - 41% open · ⏱️ 19.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/lucid) (📥 1.7K / month · 📦 6 · ⏱️ 19.03.2021):
	```
	pip install lucid
	```
</details>
...
- [GitHub](https://github.com/DistrictDataLabs/yellowbrick) (👨‍💻 100 · 🔀 500 · 📋 640 - 14% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/yellowbrick) (📥 360K / month · 📦 47 · ⏱️ 13.02.2021):
	```
...
<details><summary><b><a href="https://github.com/Trusted-AI/AIF360">Fairness 360</a></b> (🥈26 ·  ⭐ 1.6K) - A comprehensive set of fairness metrics for datasets and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Trusted-AI/AIF360) (👨‍💻 48 · 🔀 520 · 📦 140 · 📋 120 - 51% open · ⏱️ 21.01.2022):

	```
	git clone https://github.com/Trusted-AI/AIF360
	```
- [PyPi](https://pypi.org/project/aif360) (📥 8.9K / month · 📦 8 · ⏱️ 04.03.2021):
	```
	pip install aif360
	```
- [Conda](https://anaconda.org/conda-forge/aif360) (📥 1.6K · ⏱️ 29.09.2021):
	```
...
- [GitHub](https://github.com/fairlearn/fairlearn) (👨‍💻 63 · 🔀 280 · 📋 330 - 40% open · ⏱️ 31.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/fairlearn) (📥 61K / month · 📦 9 · ⏱️ 07.07.2021):
	```
...
- [GitHub](https://github.com/marcotcr/checklist) (👨‍💻 12 · 🔀 150 · 📦 88 · 📋 92 - 13% open · ⏱️ 28.09.2021):

	```
	git clone https://github.com/marcotcr/checklist
	```
- [PyPi](https://pypi.org/project/checklist) (📥 17K / month · 📦 3 · ⏱️ 24.05.2021):
	```
	pip install checklist
	```
- [Conda](https://anaconda.org/conda-forge/checklist) (📥 2.4K · ⏱️ 15.07.2021):
	```
...
- [GitHub](https://github.com/quantumblacklabs/causalnex) (👨‍💻 22 · 🔀 160 · 📦 38 · 📋 100 - 14% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/causalnex) (📥 1.8K / month · 📦 2 · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 12 · 🔀 140 · 📦 60 · 📋 150 - 8% open · ⏱️ 10.02.2022):

	```
	git clone https://github.com/oegedijk/explainerdashboard
	```
- [PyPi](https://pypi.org/project/explainerdashboard) (📥 17K / month · 📦 2 · ⏱️ 10.02.2022):
	```
...
<details><summary><b><a href="https://github.com/microsoft/responsible-ai-toolbox">responsible-ai-widgets</a></b> (🥈25 ·  ⭐ 430) - This project provides responsible AI user interfaces.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/microsoft/responsible-ai-toolbox) (👨‍💻 24 · 🔀 100 · 📦 20 · 📋 240 - 27% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/microsoft/responsible-ai-toolbox
	```
- [PyPi](https://pypi.org/project/raiwidgets) (📥 6.1K / month · 📦 2 · ⏱️ 14.02.2022):
	```
...
<details><summary><b><a href="https://github.com/csinva/imodels">imodels</a></b> (🥉23 ·  ⭐ 650) - Interpretable ML package for concise, transparent, and accurate predictive.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/csinva/imodels) (👨‍💻 8 · 🔀 57 · 📦 12 · 📋 28 - 25% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/csinva/imodels
	```
- [PyPi](https://pypi.org/project/imodels) (📥 1.5K / month · ⏱️ 11.02.2022):
	```
	pip install imodels
	```
</details>
...
- [GitHub](https://github.com/jalammar/ecco) (👨‍💻 10 · 🔀 83 · 📥 12 · 📦 4 · 📋 34 - 38% open · ⏱️ 18.01.2022):

	```
	git clone https://github.com/jalammar/ecco
	```
- [PyPi](https://pypi.org/project/ecco) (📥 420 / month · 📦 1 · ⏱️ 09.01.2022):
	```
	pip install ecco
	```
- [Conda](https://anaconda.org/conda-forge/ecco) (📥 150 · ⏱️ 10.01.2022):
	```
	conda install -c conda-forge ecco
	```
</details>
<details><summary><b><a href="https://github.com/Trusted-AI/AIX360">Explainability 360</a></b> (🥉22 ·  ⭐ 1.1K) - Interpretability and explainability of data and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Trusted-AI/AIX360) (👨‍💻 29 · 🔀 220 · 📦 38 · 📋 63 - 60% open · ⏱️ 11.02.2022):
...
<details><summary><b><a href="https://github.com/interpretml/DiCE">DiCE</a></b> (🥉22 ·  ⭐ 780) - Generate Diverse Counterfactual Explanations for any machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/interpretml/DiCE) (👨‍💻 12 · 🔀 110 · 📋 100 - 46% open · ⏱️ 08.02.2022):
...
- [GitHub](https://github.com/andosa/treeinterpreter) (👨‍💻 11 · 🔀 130 · 📦 210 · 📋 28 - 85% open · ⏱️ 28.02.2021):
...
- [GitHub](https://github.com/PAIR-code/what-if-tool) (👨‍💻 20 · 🔀 120 · 📋 100 - 54% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/witwidget) (📥 7.3K / month · 📦 3 · ⏱️ 12.10.2021):
	```
...
- [Conda](https://anaconda.org/conda-forge/tensorboard-plugin-wit) (📥 850K · ⏱️ 06.01.2022):
	...
	```
- [npm](https://www.npmjs.com/package/wit-widget) (📥 3.9K / month · ⏱️ 12.10.2021):
	```
	npm install wit-widget
	```
</details>
<details><summary><b><a href="https://github.com/sicara/tf-explain">tf-explain</a></b> (🥉21 ·  ⭐ 900) - Interpretability Methods for tf.keras models with Tensorflow 2.x. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/sicara/tf-explain) (👨‍💻 16 · 🔀 92 · 📦 99 · 📋 90 - 43% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/sicara/tf-explain
	```
- [PyPi](https://pypi.org/project/tf-explain) (📥 2.5K / month · 📦 6 · ⏱️ 18.11.2021):
	```
	pip install tf-explain
	```
</details>
<details><summary><b><a href="https://github.com/albermax/innvestigate">iNNvestigate</a></b> (🥉20 ·  ⭐ 940) - A toolbox to iNNvestigate neural networks predictions!. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/albermax/innvestigate) (👨‍💻 19 · 🔀 210 · 📋 230 - 30% open · ⏱️ 03.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/innvestigate) (📥 490 / month · 📦 1 · ⏱️ 14.11.2020):
	```
...
- [GitHub](https://github.com/kundajelab/deeplift) (👨‍💻 11 · 🔀 140 · 📦 54 · 📋 82 - 41% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/deeplift) (📥 560 / month · 📦 4 · ⏱️ 11.11.2020):
	```
...
- [GitHub](https://github.com/tensorflow/tcav) (👨‍💻 19 · 🔀 120 · 📦 11 · 📋 60 - 11% open · ⏱️ 16.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/tcav) (📥 170 / month · 📦 3 · ⏱️ 23.02.2021):
	```
	pip install tcav
	```
</details>
...
- [GitHub](https://github.com/dssg/aequitas) (👨‍💻 16 · 🔀 85 · 📦 90 · 📋 58 - 63% open · ⏱️ 27.05.2021):

	```
	git clone https://github.com/dssg/aequitas
	```
- [PyPi](https://pypi.org/project/aequitas) (📥 770 / month · 📦 6 · ⏱️ 16.12.2020):
	```
...
- [GitHub](https://github.com/edublancas/sklearn-evaluation) (👨‍💻 7 · 🔀 28 · 📦 40 · 📋 37 - 21% open · ⏱️ 13.02.2022):
...
<details><summary><b><a href="https://github.com/EthicalML/xai">XAI</a></b> (🥉18 ·  ⭐ 780) - XAI - An eXplainability toolbox for machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/aerdem4/lofo-importance) (👨‍💻 3 · 🔀 52 · 📦 7 · 📋 18 - 27% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/lofo-importance) (📥 280 / month · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/marcotcr/anchor) (👨‍💻 10 · 🔀 96 · 📋 69 - 26% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/marcotcr/anchor
	```
- [PyPi](https://pypi.org/project/anchor_exp) (📥 970 / month · ⏱️ 26.06.2020):
	```
...
- [GitHub](https://github.com/MisaOgura/flashtorch) (👨‍💻 2 · 🔀 80 · 📦 9 · 📋 32 - 31% open · ⏱️ 27.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/flashtorch) (📥 540 / month · ⏱️ 29.05.2020):
	```
...
- <b><a href="https://github.com/explainX/explainx">ExplainX.ai</a></b> (🥉16 ·  ⭐ 290 · 💤) - Explainable AI framework for data scientists. Explain & debug any.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/SAP/contextual-ai">contextual-ai</a></b> (🥉12 ·  ⭐ 79) - Contextual AI adds explainability to different stages of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
<details><summary><b><a href="https://github.com/milvus-io/milvus">Milvus</a></b> (🥇39 ·  ⭐ 9.5K) - An open-source vector database for scalable similarity search and AI.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/milvus-io/milvus) (👨‍💻 190 · 🔀 1.3K · 📥 7.5K · 📋 4.5K - 5% open · ⏱️ 17.02.2022):
...
- [PyPi](https://pypi.org/project/pymilvus) (📥 32K / month · 📦 15 · ⏱️ 25.01.2022):
	...
	```
- [Docker Hub](https://hub.docker.com/r/milvusdb/milvus) (📥 820K · ⭐ 18 · ⏱️ 25.01.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/faiss) (👨‍💻 92 · 🔀 2.5K · 📦 560 · 📋 1.7K - 10% open · ⏱️ 14.02.2022):
...
<details><summary><b><a href="https://github.com/spotify/annoy">Annoy</a></b> (🥈32 ·  ⭐ 9.5K) - Approximate Nearest Neighbors in C++/Python optimized for memory usage.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/spotify/annoy) (👨‍💻 80 · 🔀 970 · 📦 1.9K · 📋 340 - 11% open · ⏱️ 03.01.2022):

	```
	git clone https://github.com/spotify/annoy
	```
- [PyPi](https://pypi.org/project/annoy) (📥 780K / month · 📦 240 · ⏱️ 18.09.2020):
	```
	pip install annoy
	```
...
- [GitHub](https://github.com/nmslib/hnswlib) (👨‍💻 56 · 🔀 360 · 📦 190 · 📋 240 - 50% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/nmslib/hnswlib
	```
- [PyPi](https://pypi.org/project/hnswlib) (📥 68K / month · 📦 20 · ⏱️ 14.02.2022):
	```
	pip install hnswlib
	```
...
<details><summary><b><a href="https://github.com/lmcinnes/pynndescent">PyNNDescent</a></b> (🥈29 ·  ⭐ 590) - A Python nearest neighbor descent for approximate nearest neighbors. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/lmcinnes/pynndescent) (👨‍💻 18 · 🔀 77 · 📦 1.2K · 📋 97 - 46% open · ⏱️ 10.02.2022):
...
- [PyPi](https://pypi.org/project/pynndescent) (📥 1.1M / month · 📦 25 · ⏱️ 21.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pynndescent) (📥 470K · ⏱️ 22.01.2022):
	```
	conda install -c conda-forge pynndescent
	```
</details>
<details><summary><b><a href="https://github.com/yahoojapan/NGT">NGT</a></b> (🥉21 ·  ⭐ 860) - Nearest Neighbor Search with Neighborhood Graph and Tree for High-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/yahoojapan/NGT) (👨‍💻 12 · 🔀 84 · 📋 89 - 13% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/yahoojapan/NGT
	```
- [PyPi](https://pypi.org/project/ngt) (📥 18K / month · 📦 8 · ⏱️ 10.02.2022):
	```
	pip install ngt
	```
</details>
...
- [GitHub](https://github.com/kakao/n2) (👨‍💻 18 · 🔀 61 · 📦 22 · 📋 37 - 45% open · ⏱️ 20.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/n2) (📥 700 / month · 📦 3 · ⏱️ 16.10.2020):
	```
	pip install n2
	```
</details>
...
<details><summary><b><a href="https://github.com/pymc-devs/pymc">PyMC3</a></b> (🥇38 ·  ⭐ 6.4K) - Probabilistic Programming in Python: Bayesian Modeling and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 360 · 🔀 1.5K · 📥 1.8K · 📦 590 · 📋 2.6K - 8% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/pymc-devs/pymc
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 300K / month · 📦 230 · ⏱️ 24.08.2021):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 440 · 🔀 970 · 📋 1.2K - 46% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/tensorflow/probability
	```
- [PyPi](https://pypi.org/project/tensorflow-probability) (📥 690K / month · 📦 310 · ⏱️ 14.02.2022):
	```
	pip install tensorflow-probability
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-probability) (📥 50K · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 120 · 🔀 880 · 📦 620 · 📋 920 - 19% open · ⏱️ 27.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyro-ppl) (📥 79K / month · 📦 49 · ⏱️ 14.12.2021):
	```
	pip install pyro-ppl
	```
- [Conda](https://anaconda.org/conda-forge/pyro-ppl) (📥 4.2K · ⏱️ 14.12.2021):
	```
...
- [GitHub](https://github.com/cornellius-gp/gpytorch) (👨‍💻 91 · 🔀 390 · 📦 480 · 📋 1.1K - 23% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/cornellius-gp/gpytorch
	```
- [PyPi](https://pypi.org/project/gpytorch) (📥 160K / month · 📦 30 · ⏱️ 04.12.2021):
	```
...
- [GitHub](https://github.com/hmmlearn/hmmlearn) (👨‍💻 38 · 🔀 690 · 📦 1.2K · 📋 380 - 14% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/hmmlearn) (📥 380K / month · 📦 130 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/GPflow/GPflow) (👨‍💻 76 · 🔀 420 · 📦 330 · 📋 750 - 16% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/GPflow/GPflow
	```
- [PyPi](https://pypi.org/project/gpflow) (📥 8.8K / month · 📦 28 · ⏱️ 20.01.2022):
	```
	pip install gpflow
	```
...
- [GitHub](https://github.com/jmschrei/pomegranate) (👨‍💻 65 · 🔀 510 · 📦 640 · 📋 670 - 8% open · ⏱️ 06.02.2022):

	```
	git clone https://github.com/jmschrei/pomegranate
	```
- [PyPi](https://pypi.org/project/pomegranate) (📥 39K / month · 📦 44 · ⏱️ 19.11.2021):
	```
	pip install pomegranate
	```
- [Conda](https://anaconda.org/conda-forge/pomegranate) (📥 80K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/pydata/patsy) (👨‍💻 16 · 🔀 94 · 📦 47K · 📋 140 - 51% open · ⏱️ 26.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/patsy) (📥 5.7M / month · 📦 2.6K · ⏱️ 26.09.2021):
	```
	pip install patsy
	```
...
<details><summary><b><a href="https://github.com/twopirllc/pandas-ta">pandas-ta</a></b> (🥉28 ·  ⭐ 2.2K) - Technical Analysis Indicators - Pandas TA is an easy to use.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/twopirllc/pandas-ta) (👨‍💻 44 · 🔀 500 · 📦 440 · 📋 360 - 15% open · ⏱️ 31.01.2022):
...
- [PyPi](https://pypi.org/project/pandas-ta) (📥 83K / month · 📦 10 · ⏱️ 28.07.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pandas-ta) (📥 330 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/SALib/SALib) (👨‍💻 35 · 🔀 170 · 📋 270 - 17% open · ⏱️ 06.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/salib) (📥 130K / month · 📦 54 · ⏱️ 06.02.2022):
	```
	pip install salib
	```
- [Conda](https://anaconda.org/conda-forge/salib) (📥 76K · ⏱️ 04.09.2021):
	```
...
- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 22 · 🔀 76 · 📦 21 · 📋 220 - 16% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/bambinos/bambi
	```
- [PyPi](https://pypi.org/project/bambi) (📥 2.3K / month · 📦 3 · ⏱️ 15.01.2022):
	```
	pip install bambi
	```
- [Conda](https://anaconda.org/conda-forge/bambi) (📥 6.4K · ⏱️ 18.01.2022):
	```
...
- [GitHub](https://github.com/uber/orbit) (👨‍💻 16 · 🔀 83 · 📦 6 · 📋 330 - 15% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/uber/orbit
	```
- [PyPi](https://pypi.org/project/orbit-ml) (📥 7K / month · 📦 1 · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/ElementAI/baal) (👨‍💻 11 · 🔀 51 · 📋 64 - 29% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/ElementAI/baal
	```
- [PyPi](https://pypi.org/project/baal) (📥 980 / month · 📦 1 · ⏱️ 17.12.2021):
	```
	pip install baal
	```
...
- <b><a href="https://github.com/raphaelvallat/pingouin">pingouin</a></b> (🥉29 ·  ⭐ 920) - Statistical package in Python based on Pandas. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
<details><summary><b><a href="https://github.com/Trusted-AI/adversarial-robustness-toolbox">ART</a></b> (🥇33 ·  ⭐ 2.8K) - Adversarial Robustness Toolbox (ART) - Python Library for Machine Learning.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (👨‍💻 90 · 🔀 760 · 📦 190 · 📋 640 - 11% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/Trusted-AI/adversarial-robustness-toolbox
	```
- [PyPi](https://pypi.org/project/adversarial-robustness-toolbox) (📥 4.6K / month · 📦 6 · ⏱️ 07.01.2022):
	```
	pip install adversarial-robustness-toolbox
	```
- [Conda](https://anaconda.org/conda-forge/adversarial-robustness-toolbox) (📥 7.8K · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/cleverhans-lab/cleverhans) (👨‍💻 130 · 🔀 1.3K · 📦 300 · 📋 450 - 5% open · ⏱️ 23.09.2021):

	```
	git clone https://github.com/cleverhans-lab/cleverhans
	```
- [PyPi](https://pypi.org/project/cleverhans) (📥 980 / month · 📦 11 · ⏱️ 24.07.2021):
	```
	pip install cleverhans
	```
- [Conda](https://anaconda.org/conda-forge/cleverhans) (📥 2.6K · ⏱️ 29.07.2021):
	```
...
- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 46 · 🔀 220 · 📦 64 · 📋 190 - 20% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/QData/TextAttack
	```
- [PyPi](https://pypi.org/project/textattack) (📥 13K / month · 📦 3 · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/bethgelab/foolbox) (👨‍💻 32 · 🔀 370 · 📦 260 · 📋 360 - 16% open · ⏱️ 12.02.2022):

	```
	git clone https://github.com/bethgelab/foolbox
	```
- [PyPi](https://pypi.org/project/foolbox) (📥 2.1K / month · 📦 13 · ⏱️ 23.02.2021):
	```
	pip install foolbox
	```
- [Conda](https://anaconda.org/conda-forge/foolbox) (📥 5.4K · ⏱️ 30.04.2021):
	```
...
<details><summary><b><a href="https://github.com/MadryLab/robustness">robustness</a></b> (🥉18 ·  ⭐ 660) - A library for experimenting with, training and evaluating neural.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MadryLab/robustness) (👨‍💻 13 · 🔀 130 · 📦 69 · 📋 70 - 21% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/MadryLab/robustness
	```
- [PyPi](https://pypi.org/project/robustness) (📥 430 / month · 📦 2 · ⏱️ 01.12.2020):
	```
...
- [GitHub](https://github.com/cupy/cupy) (👨‍💻 290 · 🔀 560 · 📥 25K · 📦 930 · 📋 1.7K - 22% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/cupy/cupy
	```
- [PyPi](https://pypi.org/project/cupy) (📥 85K / month · 📦 150 · ⏱️ 20.01.2022):
	```
	pip install cupy
	```
...
<details><summary><b><a href="https://github.com/inducer/pycuda">PyCUDA</a></b> (🥇31 ·  ⭐ 1.3K) - CUDA integration for Python, plus shiny features. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/inducer/pycuda) (👨‍💻 74 · 🔀 250 · 📦 1.2K · 📋 220 - 29% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 230 · 🔀 590 · 📋 4.4K - 16% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/rapidsai/cudf
	```
- [PyPi](https://pypi.org/project/cudf) (📥 1.1K / month · 📦 3 · ⏱️ 01.06.2020):
	```
	pip install cudf
	```
</details>
...
- [GitHub](https://github.com/wookayin/gpustat) (👨‍💻 12 · 🔀 210 · 📦 1.6K · 📋 79 - 27% open · ⏱️ 13.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/gpustat) (📥 510K / month · 📦 99 · ⏱️ 02.01.2021):
	```
	pip install gpustat
	```
...
- [GitHub](https://github.com/NVIDIA/apex) (👨‍💻 91 · 🔀 890 · 📦 880 · 📋 930 - 56% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/NVIDIA/apex
	```
- [Conda](https://anaconda.org/conda-forge/nvidia-apex) (📥 74K · ⏱️ 22.04.2021):
	```
...
- [GitHub](https://github.com/arrayfire/arrayfire) (👨‍💻 81 · 🔀 490 · 📥 2K · 📋 1.5K - 15% open · ⏱️ 12.02.2022):

	```
	git clone https://github.com/arrayfire/arrayfire
	```
- [PyPi](https://pypi.org/project/arrayfire) (📥 630 / month · 📦 5 · ⏱️ 05.03.2021):
	```
...
- [GitHub](https://github.com/rapidsai/cuml) (👨‍💻 150 · 🔀 380 · 📋 2K - 33% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/rapidsai/cuml
	```
- [PyPi](https://pypi.org/project/cuml) (📥 560 / month · 📦 1 · ⏱️ 01.06.2020):
	```
	pip install cuml
	```
</details>
...
- [GitHub](https://github.com/NVIDIA/DALI) (👨‍💻 69 · 🔀 470 · 📋 1.1K - 13% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/NVIDIA/DALI
	```
</details>
<details><summary><b><a href="https://github.com/rapidsai/cugraph">cuGraph</a></b> (🥈24 ·  ⭐ 930) - cuGraph - RAPIDS Graph Analytics Library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 76 · 🔀 170 · 📋 760 - 11% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/rapidsai/cugraph
	```
- [PyPi](https://pypi.org/project/cugraph) (📥 190 / month · 📦 1 · ⏱️ 01.06.2020):
	```
	pip install cugraph
	```
...
- [GitHub](https://github.com/lebedov/scikit-cuda) (👨‍💻 45 · 🔀 170 · 📦 160 · 📋 220 - 22% open · ⏱️ 13.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/scikit-cuda) (📥 760 / month · 📦 44 · ⏱️ 27.05.2019):
	```
...
- [GitHub](https://github.com/BlazingDB/blazingsql) (👨‍💻 47 · 🔀 170 · 📋 720 - 18% open · ⏱️ 30.09.2021):
...
<details><summary><b><a href="https://github.com/KomputeProject/kompute">kompute</a></b> (🥉19 ·  ⭐ 750) - General purpose GPU compute framework built on Vulkan to support.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/KomputeProject/kompute) (👨‍💻 16 · 🔀 53 · 📥 130 · 📦 2 · 📋 170 - 33% open · ⏱️ 30.01.2022):

	```
	git clone https://github.com/KomputeProject/kompute
	```
- [PyPi](https://pypi.org/project/kp) (📥 100 / month · ⏱️ 15.09.2021):
	```
	pip install kp
	```
</details>
<details><summary><b><a href="https://github.com/KomputeProject/kompute">Vulkan Kompute</a></b> (🥉19 ·  ⭐ 750) - General purpose GPU compute framework built on Vulkan to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/rapidsai/cusignal) (👨‍💻 37 · 🔀 82 · 📋 130 - 11% open · ⏱️ 16.02.2022):
...
- <b><a href="https://github.com/nicolargo/nvidia-ml-py3">nvidia-ml-py3</a></b> (🥉20 ·  ⭐ 74 · 💀) - Python 3 Bindings for the NVIDIA Management Library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/tensorflow/datasets) (👨‍💻 240 · 🔀 1.2K · 📋 1.1K - 46% open · ⏱️ 16.02.2022):
...
<details><summary><b><a href="https://github.com/tensorflow/addons">TF Addons</a></b> (🥇36 ·  ⭐ 1.4K · 📉) - Useful extra functionality for TensorFlow 2.x maintained.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/addons) (👨‍💻 180 · 🔀 490 · 📦 5.4K · 📋 920 - 23% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/tensorflow/addons
	```
- [PyPi](https://pypi.org/project/tensorflow-addons) (📥 2.7M / month · 📦 160 · ⏱️ 15.02.2022):
	```
	pip install tensorflow-addons
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/hub">tensorflow-hub</a></b> (🥈35 ·  ⭐ 3K · 📈) - A library for transfer learning by reusing parts of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/hub) (👨‍💻 83 · 🔀 1.6K · 📦 10K · 📋 640 - 2% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/tensorflow/hub
	```
- [PyPi](https://pypi.org/project/tensorflow-hub) (📥 3.3M / month · 📦 280 · ⏱️ 14.04.2021):
	```
...
<details><summary><b><a href="https://github.com/tensorflow/tensor2tensor">tensor2tensor</a></b> (🥈33 ·  ⭐ 12K) - Library of deep learning models and datasets designed to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/tensor2tensor) (👨‍💻 240 · 🔀 3K · 📦 1.1K · 📋 1.2K - 45% open · ⏱️ 12.01.2022):

	```
	git clone https://github.com/tensorflow/tensor2tensor
	```
- [PyPi](https://pypi.org/project/tensor2tensor) (📥 19K / month · 📦 93 · ⏱️ 17.06.2020):
	```
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 65 · 🔀 270 · 📦 1.5K · 📋 300 - 50% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/tensorflow/model-optimization
	```
- [PyPi](https://pypi.org/project/tensorflow-model-optimization) (📥 190K / month · 📦 19 · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/tensorflow/transform) (👨‍💻 27 · 🔀 180 · 📦 700 · 📋 180 - 13% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/tensorflow/transform
	```
- [PyPi](https://pypi.org/project/tensorflow-transform) (📥 3.8M / month · 📦 55 · ⏱️ 21.01.2022):
	```
...
- [GitHub](https://github.com/keras-team/keras-preprocessing) (👨‍💻 51 · 🔀 440 · 📋 190 - 48% open · ⏱️ 11.02.2022):
...
- [GitHub](https://github.com/tensorflow/io) (👨‍💻 89 · 🔀 220 · 📋 490 - 33% open · ⏱️ 15.02.2022):
...
- [GitHub](https://github.com/qubvel/efficientnet) (👨‍💻 10 · 🔀 440 · 📥 200K · 📦 890 · 📋 120 - 50% open · ⏱️ 16.07.2021):

	```
	git clone https://github.com/qubvel/efficientnet
	```
- [PyPi](https://pypi.org/project/efficientnet) (📥 82K / month · 📦 7 · ⏱️ 15.09.2020):
	```
...
- [GitHub](https://github.com/tensorflow/neural-structured-learning) (👨‍💻 32 · 🔀 170 · 📦 180 · 📋 61 - 4% open · ⏱️ 10.02.2022):
...
- [GitHub](https://github.com/tensorflow/cloud) (👨‍💻 26 · 🔀 66 · 📦 130 · 📋 81 - 67% open · ⏱️ 04.01.2022):
...
<details><summary><b><a href="https://github.com/tensorflow/compression">TF Compression</a></b> (🥉22 ·  ⭐ 580) - Data compression in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/compression) (👨‍💻 10 · 🔀 210 · 📋 80 - 2% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/tensorflow/compression
	```
- [PyPi](https://pypi.org/project/tensorflow-compression) (📥 1.2K / month · 📦 1 · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/PAIR-code/saliency) (👨‍💻 14 · 🔀 160 · 📦 21 · 📋 40 - 35% open · ⏱️ 28.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/saliency) (📥 750 / month · 📦 3 · ⏱️ 03.05.2021):
	```
...
- <b><a href="https://github.com/patrick-kidger/equinox">equinox</a></b> (🥇18 ·  ⭐ 280) - Callable PyTrees and filtered JIT/grad transformations = neural.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/scikit-learn-contrib/imbalanced-learn) (👨‍💻 62 · 🔀 1.2K · 📦 9.3K · 📋 510 - 12% open · ⏱️ 25.01.2022):
...
- [GitHub](https://github.com/rasbt/mlxtend) (👨‍💻 87 · 🔀 740 · 📦 5.2K · 📋 400 - 24% open · ⏱️ 17.02.2022):
...
<details><summary><b><a href="https://github.com/scikit-learn-contrib/category_encoders">category_encoders</a></b> (🥈32 ·  ⭐ 1.8K) - A library of sklearn compatible categorical variable.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/scikit-learn-contrib/category_encoders) (👨‍💻 49 · 🔀 340 · 📦 3K · 📋 240 - 32% open · ⏱️ 14.02.2022):
...
- [GitHub](https://github.com/iskandr/fancyimpute) (👨‍💻 12 · 🔀 170 · 📦 1.1K · 📋 110 - 0% open · ⏱️ 21.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/fancyimpute) (📥 11K / month · 📦 29 · ⏱️ 21.10.2021):
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/lightning) (👨‍💻 17 · 🔀 200 · 📥 120 · 📦 99 · 📋 92 - 55% open · ⏱️ 30.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-contrib-lightning) (📥 4K / month · 📦 6 · ⏱️ 30.01.2022):
	```
...
<details><summary><b><a href="https://github.com/koaning/scikit-lego">scikit-lego</a></b> (🥈25 ·  ⭐ 740) - Extra blocks for scikit-learn pipelines. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/trent-b/iterative-stratification) (👨‍💻 6 · 🔀 57 · 📦 190 · 📋 19 - 21% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/trent-b/iterative-stratification
	```
- [PyPi](https://pypi.org/project/iterative-stratification) (📥 170K / month · 📦 8 · ⏱️ 03.10.2021):
	```
...
- [GitHub](https://github.com/yzhao062/combo) (👨‍💻 1 · 🔀 95 · 📦 440 · 📋 12 - 75% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/combo) (📥 43K / month · 📦 1 · ⏱️ 23.12.2020):
	```
	pip install combo
	```
</details>
...
- [GitHub](https://github.com/scikit-learn-contrib/DESlib) (👨‍💻 13 · 🔀 73 · 📦 22 · 📋 140 - 9% open · ⏱️ 10.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/deslib) (📥 15K / month · 📦 2 · ⏱️ 08.02.2021):
	```
	pip install deslib
	```
</details>
...
- [GitHub](https://github.com/scikit-tda/scikit-tda) (👨‍💻 3 · 🔀 40 · 📦 25 · 📋 17 - 76% open · ⏱️ 03.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/scikit-tda) (📥 6.2K / month · ⏱️ 03.08.2021):
	```
...
- [GitHub](https://github.com/KevinMusgrave/pytorch-metric-learning) (👨‍💻 23 · 🔀 510 · 📦 200 · 📋 330 - 12% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/KevinMusgrave/pytorch-metric-learning
	```
- [PyPi](https://pypi.org/project/pytorch-metric-learning) (📥 180K / month · 📦 8 · ⏱️ 16.02.2022):
	```
	pip install pytorch-metric-learning
	```
- [Conda](https://anaconda.org/metric-learning/pytorch-metric-learning) (📥 5.9K · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/jettify/pytorch-optimizer) (👨‍💻 25 · 🔀 220 · 📦 470 · 📋 44 - 36% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/jettify/pytorch-optimizer
	```
- [PyPi](https://pypi.org/project/torch_optimizer) (📥 80K / month · 📦 23 · ⏱️ 31.10.2021):
	```
	pip install torch_optimizer
	```
- [Conda](https://anaconda.org/conda-forge/torch-optimizer) (📥 800 · ⏱️ 31.10.2021):
	```
	conda install -c conda-forge torch-optimizer
	```
</details>
<details><summary><b><a href="https://github.com/huggingface/accelerate">accelerate</a></b> (🥇28 ·  ⭐ 2.2K) - A simple way to train and use PyTorch models with multi-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/huggingface/accelerate) (👨‍💻 33 · 🔀 140 · 📦 320 · 📋 170 - 36% open · ⏱️ 10.02.2022):

	```
	git clone https://github.com/huggingface/accelerate
	```
- [PyPi](https://pypi.org/project/accelerate) (📥 56K / month · 📦 4 · ⏱️ 27.09.2021):
	```
	pip install accelerate
	```
- [Conda](https://anaconda.org/conda-forge/accelerate) (📥 810 · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/PyTorchLightning/lightning-flash) (👨‍💻 61 · 🔀 140 · 📦 50 · 📋 410 - 8% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/PyTorchLightning/lightning-flash
	```
- [PyPi](https://pypi.org/project/lightning-flash) (📥 2.6K / month · 📦 2 · ⏱️ 15.02.2022):
	```
	pip install lightning-flash
	```
- [Conda](https://anaconda.org/conda-forge/lightning-flash) (📥 720 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/lukemelas/EfficientNet-PyTorch) (👨‍💻 24 · 🔀 1.4K · 📥 1.2M · 📋 270 - 49% open · ⏱️ 15.04.2021):
...
- [GitHub](https://github.com/sksq96/pytorch-summary) (👨‍💻 11 · 🔀 380 · 📦 4.3K · 📋 160 - 75% open · ⏱️ 10.05.2021):

	```
	git clone https://github.com/sksq96/pytorch-summary
	```
- [PyPi](https://pypi.org/project/torchsummary) (📥 69K / month · 📦 71 · ⏱️ 26.09.2018):
	```
...
- [GitHub](https://github.com/rtqichen/torchdiffeq) (👨‍💻 20 · 🔀 680 · 📦 200 · 📋 160 - 19% open · ⏱️ 17.01.2022):

	```
	git clone https://github.com/rtqichen/torchdiffeq
	```
- [PyPi](https://pypi.org/project/torchdiffeq) (📥 10K / month · 📦 6 · ⏱️ 02.06.2021):
	```
...
<details><summary><b><a href="https://github.com/tristandeleu/pytorch-meta">Torchmeta</a></b> (🥈25 ·  ⭐ 1.6K) - A collection of extensions and data-loaders for few-shot learning.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/asappresearch/sru) (👨‍💻 21 · 🔀 300 · 📦 17 · 📋 120 - 44% open · ⏱️ 19.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/sru) (📥 4.4K / month · 📦 3 · ⏱️ 17.06.2021):
	```
	pip install sru
	```
</details>
...
- [GitHub](https://github.com/dreamquark-ai/tabnet) (👨‍💻 19 · 🔀 320 · 📋 210 - 18% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-tabnet) (📥 22K / month · 📦 7 · ⏱️ 02.02.2021):
	```
	pip install pytorch-tabnet
	```
- [Conda](https://anaconda.org/conda-forge/pytorch-tabnet) (📥 140 · ⏱️ 30.12.2021):
	```
...
- [GitHub](https://github.com/rwightman/gen-efficientnet-pytorch) (👨‍💻 5 · 🔀 190 · 📦 93 · 📋 51 - 1% open · ⏱️ 08.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/geffnet) (📥 9.9K / month · 📦 1 · ⏱️ 08.07.2021):
	```
	pip install geffnet
	```
</details>
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_sparse">PyTorch Sparse</a></b> (🥈23 ·  ⭐ 570) - PyTorch Extension Library of Optimized Autograd Sparse.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_sparse) (👨‍💻 21 · 🔀 79 · 📋 200 - 30% open · ⏱️ 09.02.2022):
...
- [GitHub](https://github.com/BloodAxe/pytorch-toolbelt) (👨‍💻 7 · 🔀 87 · 📋 23 - 21% open · ⏱️ 10.02.2022):

	```
	git clone https://github.com/BloodAxe/pytorch-toolbelt
	```
- [PyPi](https://pypi.org/project/pytorch_toolbelt) (📥 18K / month · 📦 6 · ⏱️ 12.08.2021):
	```
...
- [GitHub](https://github.com/rusty1s/pytorch_scatter) (👨‍💻 19 · 🔀 99 · 📋 240 - 9% open · ⏱️ 03.02.2022):

	```
	git clone https://github.com/rusty1s/pytorch_scatter
	```
- [PyPi](https://pypi.org/project/torch-scatter) (📥 30K / month · 📦 40 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/lucidrains/reformer-pytorch) (👨‍💻 10 · 🔀 220 · 📋 120 - 11% open · ⏱️ 06.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/reformer-pytorch) (📥 5.1K / month · ⏱️ 06.11.2021):
	```
	pip install reformer-pytorch
	```
</details>
<details><summary><b><a href="https://github.com/google-research/torchsde">torchsde</a></b> (🥉20 ·  ⭐ 920 · 💤) - Differentiable SDE solvers with GPU support and efficient.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/google-research/torchsde) (👨‍💻 5 · 🔀 100 · 📦 11 · 📋 45 - 15% open · ⏱️ 26.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/torchsde) (📥 4.9K / month · ⏱️ 20.07.2021):
	```
...
<details><summary><b><a href="https://github.com/parrt/tensor-sensor">Tensor Sensor</a></b> (🥉19 ·  ⭐ 630) - The goal of this library is to generate more helpful.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/szagoruyko/pytorchviz) (👨‍💻 6 · 🔀 220 · 📦 580 · 📋 52 - 36% open · ⏱️ 15.06.2021):

	```
	git clone https://github.com/szagoruyko/pytorchviz
	```
</details>
<details><summary><b><a href="https://github.com/harvardnlp/pytorch-struct">Torch-Struct</a></b> (🥉18 ·  ⭐ 1K) - Fast, general, and tested differentiable structured prediction.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/harvardnlp/pytorch-struct) (👨‍💻 16 · 🔀 80 · 📋 54 - 44% open · ⏱️ 30.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/torch-struct) (📥 8K / month · ⏱️ 14.02.2021):
	```
	pip install torch-struct
	```
</details>
<details><summary><b><a href="https://github.com/abhishekkrthakur/tez">Tez</a></b> (🥉17 ·  ⭐ 790) - Tez is a super-simple and lightweight Trainer for PyTorch. It also.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/abhishekkrthakur/tez) (👨‍💻 1 · 🔀 110 · 📦 19 · 📋 28 - 64% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/tez) (📥 2.9K / month · 📦 2 · ⏱️ 28.12.2021):
	```
	pip install tez
	```
</details>
...
- [GitHub](https://github.com/achaiah/pywick) (👨‍💻 4 · 🔀 38 · 📦 5 · 📋 14 - 14% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pywick) (📥 56 / month · ⏱️ 22.10.2021):
	```
	pip install pywick
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/madgrad) (👨‍💻 1 · 🔀 53 · 📦 23 · 📋 8 - 25% open · ⏱️ 16.02.2022):
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.2K · 🔀 4.1K · 📥 340K · 📦 460K · 📋 8.3K - 22% open · ⏱️ 17.02.2022):
...
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥇45 ·  ⭐ 8.9K · 📈) - A computer algebra system written in pure Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.5K · 📥 440K · 📦 39K · 📋 12K - 35% open · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/streamlit/streamlit) (👨‍💻 130 · 🔀 1.6K · 📦 230 · 📋 2.3K - 24% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/streamlit/streamlit
	```
- [PyPi](https://pypi.org/project/streamlit) (📥 810K / month · 📦 300 · ⏱️ 09.02.2022):
	```
	pip install streamlit
	```
</details>
<details><summary><b><a href="https://github.com/yzhao062/pyod">PyOD</a></b> (🥇34 ·  ⭐ 5.3K) - (JMLR 19) A Python Toolbox for Scalable Outlier Detection (Anomaly.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 33 · 🔀 1K · 📦 1.1K · 📋 240 - 50% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyod) (📥 480K / month · 📦 28 · ⏱️ 04.01.2022):
	```
	pip install pyod
	```
...
<details><summary><b><a href="https://github.com/gradio-app/gradio">Gradio</a></b> (🥇34 ·  ⭐ 5.2K) - Wrap UIs around any model, share with anyone. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 52 · 🔀 330 · 📦 550 · 📋 350 - 19% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/gradio-app/gradio
	```
- [PyPi](https://pypi.org/project/gradio) (📥 83K / month · 📦 16 · ⏱️ 08.02.2022):
	```
	pip install gradio
	```
</details>
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 180 · 🔀 1.3K · 📦 72 · 📋 1.4K - 31% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 8.6K / month · 📦 4 · ⏱️ 11.02.2022):
	```
	pip install deepchem
	```
- [Conda](https://anaconda.org/conda-forge/deepchem) (📥 8.2K · ⏱️ 19.01.2022):
	```
...
- [GitHub](https://github.com/simonw/datasette) (👨‍💻 61 · 🔀 390 · 📥 34 · 📦 590 · 📋 1.3K - 27% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/simonw/datasette
	```
- [PyPi](https://pypi.org/project/datasette) (📥 270K / month · 📦 140 · ⏱️ 07.02.2022):
	```
	pip install datasette
	```
- [Conda](https://anaconda.org/conda-forge/datasette) (📥 2.8K · ⏱️ 08.02.2022):
	```
	conda install -c conda-forge datasette
	```
</details>
<details><summary><b><a href="https://github.com/PaddlePaddle/PaddleHub">PaddleHub</a></b> (🥈32 ·  ⭐ 7.6K) - Awesome pre-trained models toolkit based on.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PaddlePaddle/PaddleHub) (👨‍💻 54 · 🔀 1.5K · 📥 560 · 📦 700 · 📋 1K - 38% open · ⏱️ 21.01.2022):

	```
	git clone https://github.com/PaddlePaddle/PaddleHub
	```
- [PyPi](https://pypi.org/project/paddlehub) (📥 10K / month · 📦 4 · ⏱️ 28.12.2021):
	```
...
- [GitHub](https://github.com/HIPS/autograd) (👨‍💻 51 · 🔀 780 · 📦 3K · 📋 390 - 42% open · ⏱️ 03.03.2021):
...
<details><summary><b><a href="https://github.com/carla-simulator/carla">carla</a></b> (🥈31 ·  ⭐ 7.3K) - Open-source simulator for autonomous driving research. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/carla-simulator/carla) (👨‍💻 140 · 🔀 2.1K · 📦 120 · 📋 3.7K - 13% open · ⏱️ 19.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/carla) (📥 3.1K / month · 📦 3 · ⏱️ 17.11.2021):
	```
	pip install carla
	```
</details>
...
- [GitHub](https://github.com/scikit-learn-contrib/hdbscan) (👨‍💻 76 · 🔀 400 · 📦 1.2K · 📋 420 - 63% open · ⏱️ 08.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/hdbscan) (📥 370K / month · 📦 150 · ⏱️ 08.02.2022):
	```
	pip install hdbscan
	```
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 64 · 🔀 170 · 📦 110 · 📋 740 - 15% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/serge-sans-paille/pythran
	```
- [PyPi](https://pypi.org/project/pythran) (📥 370K / month · 📦 14 · ⏱️ 14.12.2021):
	```
	pip install pythran
	```
...
- [GitHub](https://github.com/tensorly/tensorly) (👨‍💻 50 · 🔀 220 · 📦 220 · 📋 180 - 25% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/tensorly/tensorly
	```
- [PyPi](https://pypi.org/project/tensorly) (📥 5.7K / month · 📦 30 · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 72 · 🔀 340 · 📦 74 · 📋 340 - 1% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/online-ml/river
	```
- [PyPi](https://pypi.org/project/river) (📥 5.7K / month · 📦 6 · ⏱️ 04.02.2022):
	```
	pip install river
	```
- [Conda](https://anaconda.org/conda-forge/river) (📥 6.7K · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/PennyLaneAI/pennylane) (👨‍💻 89 · 🔀 340 · 📥 60 · 📋 620 - 24% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/PennyLaneAI/PennyLane
	```
- [PyPi](https://pypi.org/project/pennylane) (📥 12K / month · 📦 28 · ⏱️ 08.02.2022):
	```
	pip install pennylane
	```
- [Conda](https://anaconda.org/conda-forge/pennylane) (📥 380 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/wireservice/agate) (👨‍💻 49 · 🔀 130 · 📦 770 · 📋 680 - 7% open · ⏱️ 15.07.2021):
...
- [PyPi](https://pypi.org/project/agate) (📥 1.1M / month · 📦 130 · ⏱️ 15.07.2021):
	...
	pip install agate
	```
- [Conda](https://anaconda.org/conda-forge/agate) (📥 77K · ⏱️ 16.07.2021):
	```
...
- [GitHub](https://github.com/inducer/pyopencl) (👨‍💻 90 · 🔀 220 · 📦 630 · 📋 300 - 22% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/inducer/pyopencl
	```
- [PyPi](https://pypi.org/project/pyopencl) (📥 26K / month · 📦 180 · ⏱️ 10.02.2022):
	```
	pip install pyopencl
	```
- [Conda](https://anaconda.org/conda-forge/pyopencl) (📥 560K · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/uber/causalml) (👨‍💻 37 · 🔀 420 · 📦 37 · 📋 250 - 17% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/uber/causalml
	```
- [PyPi](https://pypi.org/project/causalml) (📥 42K / month · 📦 1 · ⏱️ 05.02.2022):
	```
...
<details><summary><b><a href="https://github.com/google/trax">Trax</a></b> (🥈28 ·  ⭐ 6.8K) - Trax Deep Learning with Clear Code and Speed. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google/trax) (👨‍💻 75 · 🔀 680 · 📦 43 · 📋 200 - 40% open · ⏱️ 02.02.2022):
...
- [GitHub](https://github.com/sepandhaghighi/pycm) (👨‍💻 17 · 🔀 100 · 📦 130 · 📋 180 - 6% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pycm) (📥 34K / month · 📦 12 · ⏱️ 26.01.2022):
	```
	pip install pycm
	```
</details>
...
- [GitHub](https://github.com/pyjanitor-devs/pyjanitor) (👨‍💻 96 · 🔀 140 · 📦 150 · 📋 450 - 21% open · ⏱️ 12.02.2022):

	```
	git clone https://github.com/pyjanitor-devs/pyjanitor
	```
- [PyPi](https://pypi.org/project/pyjanitor) (📥 20K / month · 📦 10 · ⏱️ 21.11.2021):
	```
...
<details><summary><b><a href="https://github.com/Adapter-Hub/adapter-transformers">adapter-transformers</a></b> (🥈28 ·  ⭐ 680) - Huggingface Transformers + Adapters =. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>huggingface</code></summary>

- [GitHub](https://github.com/Adapter-Hub/adapter-transformers) (👨‍💻 1.1K · 🔀 110 · 📦 44 · 📋 140 - 26% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/Adapter-Hub/adapter-transformers
	```
- [PyPi](https://pypi.org/project/adapter-transformers) (📥 51K / month · 📦 4 · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/nicodv/kmodes) (👨‍💻 20 · 🔀 360 · 📦 1K · 📋 140 - 11% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/nicodv/kmodes
	```
- [PyPi](https://pypi.org/project/kmodes) (📥 320K / month · 📦 26 · ⏱️ 08.10.2021):
	```
	pip install kmodes
	```
- [Conda](https://anaconda.org/conda-forge/kmodes) (📥 6K · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/annoviko/pyclustering) (👨‍💻 26 · 🔀 220 · 📥 390 · 📦 270 · 📋 650 - 8% open · ⏱️ 12.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyclustering) (📥 44K / month · 📦 28 · ⏱️ 25.11.2020):
	```
...
- [GitHub](https://github.com/facebookresearch/AugLy) (👨‍💻 15 · 🔀 220 · 📦 26 · 📋 56 - 25% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/facebookresearch/AugLy
	```
- [PyPi](https://pypi.org/project/augly) (📥 2K / month · 📦 3 · ⏱️ 17.12.2021):
	```
	pip install augly
	```
</details>
<details><summary><b><a href="https://github.com/mars-project/mars">Mars</a></b> (🥉26 ·  ⭐ 2.4K) - Mars is a tensor-based unified framework for large-scale data.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/mars-project/mars) (👨‍💻 41 · 🔀 300 · 📋 970 - 15% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/mars-project/mars
	```
- [PyPi](https://pypi.org/project/pymars) (📥 3K / month · 📦 1 · ⏱️ 03.02.2022):
	```
	pip install pymars
	```
</details>
<details><summary><b><a href="https://github.com/SeldonIO/alibi-detect">alibi-detect</a></b> (🥉26 ·  ⭐ 1.2K) - Algorithms for outlier, adversarial and drift detection. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/SeldonIO/alibi-detect) (👨‍💻 15 · 🔀 120 · 📦 60 · 📋 220 - 38% open · ⏱️ 04.02.2022):

	```
	git clone https://github.com/SeldonIO/alibi-detect
	```
- [PyPi](https://pypi.org/project/alibi-detect) (📥 12K / month · 📦 5 · ⏱️ 18.01.2022):
	```
...
- [GitHub](https://github.com/minrk/findspark) (👨‍💻 15 · 🔀 67 · 📦 2.2K · 📋 22 - 54% open · ⏱️ 11.02.2022):
...
- [PyPi](https://pypi.org/project/findspark) (📥 2.2M / month · 📦 140 · ⏱️ 11.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/findspark) (📥 610K · ⏱️ 11.02.2022):
	```
	conda install -c conda-forge findspark
	```
</details>
<details><summary><b><a href="https://github.com/ContinualAI/avalanche">avalanche</a></b> (🥉24 ·  ⭐ 740) - Avalanche: an End-to-End Library for Continual Learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ContinualAI/avalanche) (👨‍💻 49 · 🔀 110 · 📋 470 - 15% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/ContinualAI/avalanche
	```
- [PyPi](https://pypi.org/project/avalanche-lib) (📥 230 / month · ⏱️ 16.12.2021):
	```
...
- [GitHub](https://github.com/astroML/astroML) (👨‍💻 30 · 🔀 280 · 📋 140 - 40% open · ⏱️ 25.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/astroML) (📥 2.6K / month · 📦 33 · ⏱️ 25.01.2022):
	```
	pip install astroML
	```
...
- [GitHub](https://github.com/MaxHalford/prince) (👨‍💻 12 · 🔀 140 · 📦 180 · 📋 100 - 33% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/MaxHalford/prince
	```
- [PyPi](https://pypi.org/project/prince) (📥 19K / month · 📦 5 · ⏱️ 06.10.2020):
	```
	pip install prince
	```
...
- [GitHub](https://github.com/ml-tooling/opyrator) (👨‍💻 4 · 🔀 110 · 📦 31 · 📋 24 - 8% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/opyrator) (📥 130 / month · ⏱️ 04.05.2021):
	```
	pip install opyrator
	```
- [Conda](https://anaconda.org/conda-forge/opyrator) (📥 39 · ⏱️ 08.01.2022):
	```
...
- [GitHub](https://github.com/EpistasisLab/scikit-rebate) (👨‍💻 13 · 🔀 63 · 📋 32 - 40% open · ⏱️ 15.02.2021):
...
- [GitHub](https://github.com/eltonlaw/impyute) (👨‍💻 11 · 🔀 43 · 📦 130 · 📋 64 - 42% open · ⏱️ 06.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/impyute) (📥 2.2K / month · 📦 3 · ⏱️ 29.04.2019):
	```
	pip install impyute
	```
</details>
...
- [GitHub](https://github.com/yzhao062/SUOD) (👨‍💻 1 · 🔀 40 · 📦 410 · 📋 8 - 75% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/suod) (📥 34K / month · ⏱️ 01.10.2021):
	```
	pip install suod
	```
</details>
...
- [GitHub](https://github.com/pykale/pykale) (👨‍💻 16 · 🔀 39 · 📋 80 - 12% open · ⏱️ 20.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pykale) (📥 40 / month · ⏱️ 13.10.2021):
	```
	pip install pykale
	```
</details>
...
- [PyPi](https://pypi.org/project/baikal) (📥 460 / month · 📦 1 · ⏱️ 15.11.2020):
	...
	pip install baikal
	```
- [Conda](https://anaconda.org/conda-forge/cython-blis) (📥 1.2M · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/rasbt/biopandas) (👨‍💻 8 · 🔀 91 · 📋 39 - 38% open · ⏱️ 04.01.2022):

	```
	git clone https://github.com/rasbt/biopandas
	```
- [PyPi](https://pypi.org/project/biopandas) (📥 2.7K / month · 📦 9 · ⏱️ 24.09.2021):
	```
...
<details><summary><b><a href="https://github.com/jmschrei/apricot">apricot</a></b> (🥉17 ·  ⭐ 400) - apricot implements submodular optimization for the purpose of selecting.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jmschrei/apricot) (👨‍💻 4 · 🔀 40 · 📥 10 · 📦 22 · 📋 24 - 25% open · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/apricot-select) (📥 290 / month · 📦 3 · ⏱️ 28.09.2020):
	```
...
- <b><a href="https://github.com/cleanlab/cleanlab">cleanlab</a></b> (🥉22 ·  ⭐ 2.7K) - The standard package for machine learning with label errors,.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
- <b><a href="https://github.com/solegalli/feature_engine">Feature Engine</a></b> (🥉18 ·  ⭐ 13) - Feature engineering package with sklearn like functionality. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
